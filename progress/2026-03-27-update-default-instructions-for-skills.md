...
2. **Updated `.github/copilot-instructions.md`** with three targeted changes:
   ...
   - Added a new **Development Loop** section under Working Methodology explaining when and how each skill is applied in sequence
