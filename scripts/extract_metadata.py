...
STOPWORDS: frozenset[str] = frozenset(
    [
        ...
        "other", "some", "such", "than", "then", "too", "very", "just",
        "into", "through", "during", "before", "after", "above", "below",
        "between", "out", "off", "over", "under", "again", "further",
        "once", "any", "all", "also", "only", "own", "same", "while",
        "about", "across", "within", "without", "up", "down", "if", "else",
        "their", "they", "them", "we", "our", "you", "your", "my", "me",
        "he", "she", "his", "her", "our", "us", "i", "ii", "iii", "iv",
        # Research-specific stop words
        "research", "inference", "fact", "assumption", "high", "medium",
        "low", "source", "evidence", "item", "items", "note", "notes",
        "section", "key", "finding", "findings", "result", "results",
        "approach", "method", "methods", "data", "use", "used", "using",
        "based", "new", "given", "shows", "show", "used", "well", "also",
        "approach", "provide", "provides", "provided", "include", "includes",
        "including", "support", "supports", "allow", "allows", "enable",
        "enables", "ensure", "ensures", "require", "requires", "provide",
        "make", "makes", "made", "take", "takes", "taken", "get", "gets",
        "set", "sets", "see", "seen", "need", "needs", "work", "works",
        "working", "like", "likely", "across", "between", "within",
        "however", "therefore", "thus", "hence", "although", "though",
        "since", "because", "while", "whereas", "rather", "often",
        "typically", "generally", "specifically", "particularly",
        "effectively", "efficiently", "significantly", "substantially",
        "potentially", "approximately", "relatively", "currently",
        "multiple", "various", "different", "similar", "specific",
        "particular", "overall", "primary", "secondary", "main",
        "major", "minor", "large", "small", "long", "short",
    ]
)
...
def extract_key_claims(findings_text: str) -> list[str]:
    ...
    for line in kf_text.split("\n"):
        ...
        text = re.sub(r"\[(fact|inference|assumption|high|medium|low)\]", "", text, flags=re.IGNORECASE)
        text = text.strip()
...
def main() -> None:
    ...
    output = {
        "extracted_at": datetime.now(tz=timezone.utc).strftime("%Y-%m-%dT%H:%M:%SZ"),
        "items": items_out,
    }
    ...
    print(f"{len(items_out)} items processed, {total_concepts} concepts extracted, {total_urls} source URLs found")
