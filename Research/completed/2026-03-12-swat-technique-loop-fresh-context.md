...
added: 2026-03-14T23:57:17+00:00
status: completed
priority: medium
blocks: []
...
output: [knowledge]
themes: [agentic-ai, rag-retrieval, memory-context, tools-infrastructure]
...
- The sycophancy rates from SycEval (2025) are measured in educational and clinical domains (AMPS (a mathematics benchmark dataset used in SycEval) mathematics, MedQuad medical advice). SWAT analysis of organisational or technical subjects may exhibit different sycophancy profiles.
