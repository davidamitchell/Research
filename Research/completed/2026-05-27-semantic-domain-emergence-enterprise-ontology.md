...
- [x] [Blondel et al. (2008) "Fast unfolding of communities in large networks", Journal of Statistical Mechanics](https://iopscience.iop.org/article/10.1088/1742-5468/2008/10/P10008): original Louvain method paper; empirical performance and non-determinism at cluster boundaries
- [x] [Hutchins (1995) "Cognition in the Wild", MIT Press](https://mitpress.mit.edu/9780262082310/cognition-in-the-wild/): distributed cognition theory; cognitive phenomena realized across networks of people and artifacts
...
2. Concept duplication: synonymous terms appear in disjoint subgraphs with no owl:sameAs (Web Ontology Language (OWL) identity assertion, W3C standard https://www.w3.org/TR/owl2-overview/) or skos:exactMatch (Simple Knowledge Organization System (SKOS) equivalence property, W3C standard https://www.w3.org/TR/skos-reference/) relationship recorded, indicating that two teams developed parallel vocabularies without coordination. [inference; source: https://doi.org/10.1287/orsc.1040.0094; https://www.melconway.com/Home/Conways_Law.html]
...
Community detection algorithms (Louvain, Leiden, Infomap) applied to enterprise knowledge graphs of schema relationships, API dependency clusters, and workflow participation matrices can produce an empirical Q score for each candidate domain. [inference; source: https://www.pnas.org/doi/10.1073/pnas.0601602103; https://iopscience.iop.org/article/10.1088/1742-5468/2008/10/P10008] Louvain is the most widely deployed method due to its O(n log n) complexity, but it is non-deterministic at cluster boundaries, making consensus clustering (running Louvain multiple times and taking the intersection of stable core assignments) advisable for governance-sensitive domain definitions. [inference; source: https://iopscience.iop.org/article/10.1088/1742-5468/2008/10/P10008]

A prior completed item on data product ontology established that domain ownership in data mesh architectures is a first-class design principle: domains produce data products with explicit interfaces, and the ontology is explicitly bounded by domain responsibility. [inference; source: https://davidamitchell.github.io/Research/research/2026-05-12-data-product-ontology.html] Data mesh practitioners have operationalized governance alignment as a design requirement, confirming that the mechanism described here is not merely theoretical. [inference; source: https://davidamitchell.github.io/Research/research/2026-05-12-data-product-ontology.html]
...
Three independent research traditions converge on the same structural prediction: stable domains form where internal coupling is high and external coupling is low, whether measured by graph modularity, cognitive co-activation depth, or organizational coordination-cost differentials. [inference; source: https://www.pnas.org/doi/10.1073/pnas.0601602103; https://www.nature.com/articles/nrn2787; https://www.jstor.org/stable/2778934] This cross-tradition convergence supports the integrated model, though it does not substitute for direct empirical measurement of all three mechanisms in a single enterprise context. [inference; source: https://www.pnas.org/doi/10.1073/pnas.0601602103; https://www.nature.com/articles/nrn2787; https://www.jstor.org/stable/2778934]

Governance alignment is the most directly actionable mechanism of the three: graph topology and cognitive stabilization are measurable outcomes that cannot be directly controlled, whereas governance alignment (assigning ownership, reducing approval depth, consolidating team charters) is a direct management lever. [inference; source: https://www.jstor.org/stable/2778934; https://doi.org/10.1287/orsc.1040.0094; https://www.melconway.com/Home/Conways_Law.html] The economic framing (Coase, Williamson) is better suited to predicting where natural boundaries should form, while the Conway framing is better suited to diagnosing why existing boundaries have degraded. [inference; source: https://www.jstor.org/stable/2778934; https://www.melconway.com/Home/Conways_Law.html]

The FEP framing contributes a falsifiability dimension: if a domain is in good health, cross-domain interactions should have measurably higher prediction error (more exceptions, more reconciliation, more escalation) than same-domain interactions. [inference; source: https://www.nature.com/articles/nrn2787] This prediction could be operationalized from change-management incident data. [inference; source: https://www.nature.com/articles/nrn2787]

The three failure signatures are not independent: concept duplication follows from fragmentation, and translation-layer growth is a governance response to duplication. [inference; source: https://doi.org/10.1287/orsc.1040.0094; https://www.pnas.org/doi/10.1073/pnas.0601602103] If the cascade hypothesis (H4) holds, reducing fragmentation at the earliest detectable stage should prevent downstream duplication and translation overhead, making early Q monitoring the highest-leverage governance intervention point. [inference; source: https://www.pnas.org/doi/10.1073/pnas.0601602103; https://doi.org/10.1287/orsc.1040.0094]

Rival explanation: an alternative account holds that domain boundaries are purely the product of deliberate design, not emergence. Under this account, the graph topology, cognitive, and economic patterns described here are consequences of design decisions rather than generative causes. This item does not refute this account but notes that it predicts stable domains wherever design intent is strong, which is undermined by the widespread observation of domain decay in well-governed enterprises that applied top-down ontology design without governance alignment. [inference; source: https://www.melconway.com/Home/Conways_Law.html; https://doi.org/10.1287/orsc.1040.0094]
...
acronym_audit: passed
  ...
  - skos/owl: expanded at first use in §2.D ("Web Ontology Language (OWL)" and "Simple Knowledge Organization System (SKOS)")
claim_label_audit: all claims in §2-§6 carry [fact], [inference], or [assumption] labels; §6 Analysis unlabeled evaluative claims fixed in v2
