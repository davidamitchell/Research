---
review_count: 2
title: "State Space Explosion and Deterministic Chaos: How Concurrent System Fragility and ML Model Sensitivity to Perturbation Mirror Each Other"
...
- [inference] The concurrent-systems evidence establishes exponential growth in reachable states and schedule-sensitive failures, while the Lorenz and adversarial-learning evidence supports distinguishing two different perturbation-sensitivity mechanisms. [source: https://www.cs.vsb.cz/kot/down/Texts/StateSpace.pdf; https://docs.oracle.com/javase/tutorial/essential/concurrency/interfere.html; https://doi.org/10.1175/1520-0469(1963)020%3C0130:DNF%3E2.0.CO;2; https://arxiv.org/abs/1412.6572]
