...
- [Context Mode: Model Context Protocol (MCP) tool output compression and the large language model (LLM) context window management problem](https://davidamitchell.github.io/Research/research/2026-03-01-context-mode-llm-context-compression.html)
...
- [x] [Context Mode: Model Context Protocol (MCP) tool output compression and the large language model (LLM) context window management problem](https://davidamitchell.github.io/Research/research/2026-03-01-context-mode-llm-context-compression.html): prior repository item on working-set and context-window constraints
...
- [x] [Jones, Laird (2022) An Analysis and Comparison of Adaptive Control of Thought-Rational (ACT-R) and Soar (arXiv:2201.09305)](https://arxiv.org/abs/2201.09305): procedural memory, buffer-based working memory, and chunking/utility-based adaptation in the two dominant symbolic cognitive architectures
...
- [x] [Chen, M. et al. (2021) Evaluating Large Language Models Trained on Code (arXiv:2107.03374)](https://arxiv.org/abs/2107.03374): defines the HumanEval benchmark and its pass@k evaluation metric, used as the accuracy measure in the Reflexion feedback-loop result
...
- [x] [DevOps Research and Assessment (DORA) (2025) DORA Metrics](https://dora.dev/guides/dora-metrics/): failed-change recovery time as a validated throughput/stability indicator transferable to harness error-recovery measurement
