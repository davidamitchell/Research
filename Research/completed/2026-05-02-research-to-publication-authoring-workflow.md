...
themes: [agentic-ai, llm-reasoning, knowledge-management, ai-architecture, tools-infrastructure, benchmarks-eval]
...
**In scope:**
- Academic writing structure: standard paper templates, including Introduction, Methods, Results, and Discussion (IMRaD), argument essay, policy brief, decision framework, and capability maturity model, plus when each output type is appropriate
