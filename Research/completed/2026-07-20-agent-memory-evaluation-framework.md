...
**Historical/methodological lens:** LoCoMo's first public release (per its repository's own release notes) contained fifty conversations and was later reduced to a curated ten-conversation subset for cost-effective evaluation of closed-source LLMs. [fact; source: https://github.com/snap-research/LoCoMo] This illustrates a recurring trade-off in this benchmark class between dataset scale and evaluation cost, a trade-off that a synthesised framework should treat as an explicit design parameter rather than an incidental detail. [inference; source: https://github.com/snap-research/LoCoMo]
