...
- [x] Existing conventions in `davidamitchell/Latest-developments-`
- [x] `BACKLOG.md` in this repo
- [x] `Research/README.md` in this repo
- [x] `AGENTS.md` Non-Negotiable Constraints section
