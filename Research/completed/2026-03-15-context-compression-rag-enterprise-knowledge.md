...
**[fact]** RAPTOR (Recursive Abstractive Processing for Tree-Organized Retrieval), published at ICLR 2024 (arXiv:2401.18059), builds a hierarchical tree of text summaries by recursively embedding, clustering, and summarising chunks. The tree has multiple levels of abstraction. Retrieval queries the tree at the appropriate level of granularity. (Source: RAPTOR paper, ICLR 2024; Semantic Scholar)
