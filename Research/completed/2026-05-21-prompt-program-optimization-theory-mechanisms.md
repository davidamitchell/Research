...
3. **Supervision and information flow**
   ...
   - 3.2 What role does retrieval play in DSP, Infer-Retrieve-Rank, and Synthesis of Topic Outlines through Retrieval and Multi-perspective Question Asking (STORM)?
...
- [fact] MIPRO operationalizes update search in three stages: bootstrapping candidate demonstrations from traces, generating program-aware and data-aware instruction proposals, and using stochastic mini-batch evaluation plus a learned scoring model to search over instruction and demonstration combinations. [source: https://arxiv.org/abs/2406.11695; https://dspy.ai/learn/optimization/optimizers/]
- [fact] DSPy documents Multi-Stage Instruction Prompt Optimization version 2 (MIPROv2) as an optimizer that first collects traces, then drafts grounded instruction proposals, then runs discrete search with mini-batch evaluation and learned-scoring-model updates over prompt configurations. [source: https://dspy.ai/learn/optimization/optimizers/]
...
- [assumption] Current DSPy documentation is a valid source for present optimizer names and interfaces, even though the underlying papers and docs span 2023 through 2026, because the documentation explicitly maps Multi-Stage Instruction Prompt Optimization version 2 (MIPROv2), GEPA, BootstrapFewShot, and BetterTogether back to their paper families. [source: https://dspy.ai/learn/optimization/optimizers/; https://arxiv.org/abs/2406.11695; https://arxiv.org/abs/2507.19457; https://arxiv.org/abs/2407.10930]

### §4 Consistency Check

- [fact] GEPA and MIPRO describe different search procedures, reflection-guided prompt revision versus learned-scoring-model-guided instruction and demonstration search, but both remain consistent with the same higher-level idea of metric-guided search over interpretable prompt-program variables. [source: https://arxiv.org/abs/2507.19457; https://arxiv.org/abs/2406.11695]
...
- [fact] The current item file now contains first-use acronym expansions, inline epistemic labels, URL-backed citations, and mirrored §6 and Findings content. [source: https://github.com/davidamitchell/Research/blob/main/Research/in-progress/2026-05-21-prompt-program-optimization-theory-mechanisms.md]
- [inference] No unresolved contradiction remains after this pass because the remaining synthesis judgments are explicitly labeled as inferences and the remaining evidence limits are stated in Risks, Gaps, and Uncertainties. [source: https://github.com/davidamitchell/Research/blob/main/Research/in-progress/2026-05-21-prompt-program-optimization-theory-mechanisms.md]
