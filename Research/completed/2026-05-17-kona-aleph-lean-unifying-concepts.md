...
- Access note: no authoritative public Kona source validated in the discovery pass recorded above.
- Scope note: characterize Lean and Aleph directly; keep Kona open as an unresolved naming input rather than forcing an unsupported system match.
...
- Access note: no evidence-backed Kona architecture, workflow, intended-user, or Lean-integration claims included in this item.
- Scope note: Kona remains an open follow-up question rather than a characterized system in the present synthesis.
...
- Consistency note: Kona remains an unresolved naming input, so the item leaves that branch open rather than forcing an unsupported system match.
...
- Type: knowledge
- Description: This item establishes a conceptual map in which Lean is the verified substrate, Aleph is a hosted automation layer above that substrate, and the comparison is best explained through proof search, workflow orchestration, and kernel-checked verification. [inference; source: https://lean-lang.org/; https://github.com/apps/aleph-prover; https://pypi.org/project/alephprover/; https://lean-lang.org/theorem_proving_in_lean4/]
- Links:
- https://lean-lang.org/
- https://github.com/apps/aleph-prover
