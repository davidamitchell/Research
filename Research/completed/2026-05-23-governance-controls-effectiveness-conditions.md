...
- Constraints: full-mode research; Uniform Resource Locator (URL)-backed citations only; first-use expansion for abbreviations; direct separation of facts, inferences, and assumptions
- output: knowledge
