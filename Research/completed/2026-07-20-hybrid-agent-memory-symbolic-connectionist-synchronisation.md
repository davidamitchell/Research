...
- [x] [Edge et al. (2024) From Local to Global: A Graph RAG Approach to Query-Focused Summarization](https://arxiv.org/abs/2404.16130) - the original GraphRAG extraction and [Leiden community-summary](https://www.nature.com/articles/s41598-019-41695-z) pipeline
- [x] [Traag et al. (2019) From Louvain to Leiden: guaranteeing well-connected communities](https://www.nature.com/articles/s41598-019-41695-z) - authoritative definition of the Leiden community-detection algorithm
- [x] [Robertson and Zaragoza (2009) The Probabilistic Relevance Framework: BM25 and Beyond](https://doi.org/10.1561/1500000019) - authoritative definition of the Best-Matching-25 (BM25) ranking function
