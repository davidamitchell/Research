...
- [assumption; source: https://www.domainlanguage.com/wp-content/uploads/2016/05/DDD_Reference_2015-03.pdf; https://martinfowler.com/bliki/UbiquitousLanguage.html; https://openpracticelibrary.com/practice/ubiquitous-language/] Access note: the seeded O'Reilly landing pages for Evans and Vernon were not used as retained evidence, and the accessible Evans reference PDF, Martin Fowler summary, and Open Practice Library guide were used instead. Justification: those replacement sources expose the relevant Ubiquitous Language definitions and maintenance mechanics in readable form.
- [assumption; source: https://github.com/mattpocock/skills/blob/main/skills/deprecated/ubiquitous-language/SKILL.md; https://github.com/mattpocock/skills/blob/main/skills/deprecated/README.md; https://www.aihero.dev/5-agent-skills-i-use-every-day] Access note: current first-party Matt Pocock sources were substituted for the older seeded Total TypeScript page. Justification: the retained sources are first-party and directly describe the glossary mechanic or the surrounding rationale for strict reusable skills.
- [assumption; source: https://arxiv.org/abs/2112.00114; https://arxiv.org/abs/2406.19783; https://arxiv.org/abs/2506.10204] Access note: the seeded arXiv identifier `https://arxiv.org/abs/2112.00114` was treated as a mismatched seed and replaced with directly relevant prompt-robustness studies on code generation. Justification: the retained replacement sources measure wording sensitivity on code-generation tasks rather than unrelated reasoning behavior.
- [assumption; source: https://arxiv.org/abs/2307.10680; https://arxiv.org/abs/2406.19783; https://arxiv.org/abs/2506.10204] Access note: the seeded arXiv identifier `https://arxiv.org/abs/2307.10680` was treated as a mismatched seed and replaced with accessible prompt-variability and workflow-consistency sources. Justification: the retained replacement sources are on-topic for code-generation consistency and session-level guidance.
- [assumption; source: https://arxiv.org/abs/2406.19783; https://arxiv.org/abs/2506.10204; https://arxiv.org/abs/2310.10996; https://openreview.net/forum?id=s566pj5E5M] Failed primary-source search note: searches including `"Trebing consistency code generation"`, `"naming drift llm code generation repository study"`, and `"synonym proliferation AI-generated codebase"` did not surface an accessible longitudinal study that directly measures naming-drift rates in AI-generated repositories. Justification: the accessible literature clusters around prompt robustness, clarification, and workflow guidance rather than repository-level glossary experiments.
...
- Metadata: claim-label audit completed.
- Metadata: confidence outcome = medium.
- Metadata: seed-source mismatch, acronym expansion, and synthesis-to-findings parity audits completed.
...
- Type: knowledge
- Description: Living Ubiquitous Language appears to be a plausible high-leverage alignment artifact for AI-assisted software work, with strongest support for better precision and naming consistency rather than directly measured verbosity reduction or long-run drift prevention. [inference; source: https://martinfowler.com/bliki/UbiquitousLanguage.html; https://arxiv.org/abs/2406.19783; https://github.com/mattpocock/skills/blob/main/skills/deprecated/ubiquitous-language/SKILL.md]
- Links:
