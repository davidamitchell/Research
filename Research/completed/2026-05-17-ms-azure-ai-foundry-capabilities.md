...
- [x] [Hu et al. (2021) LoRA: Low-Rank Adaptation of Large Language Models](https://arxiv.org/abs/2106.09685) - original definition of the Low-Rank Adaptation method
...
- [x] [Model Context Protocol Introduction](https://modelcontextprotocol.io/introduction) - authoritative definition of Model Context Protocol (MCP)
- [x] [A2A Protocol Specification](https://a2aprotocol.org/docs/specification) - authoritative definition of the Agent-to-Agent (A2A) protocol
...
- [x] [OpenTelemetry What is OpenTelemetry?](https://opentelemetry.io/docs/what-is-opentelemetry/) - authoritative definition of OpenTelemetry tracing and telemetry concepts
...
- [fact; source: https://modelcontextprotocol.io/introduction; https://a2aprotocol.org/docs/specification; https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/tool-catalog; https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/memory-usage; https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/what-is-foundry-iq] The development surface includes built-in tools such as web search, file search, code interpreter, and function calling, custom tools such as Model Context Protocol (MCP), Agent-to-Agent (A2A), and OpenAPI Specification based tools, managed memory stores, and Foundry IQ, Microsoft's managed knowledge layer, with multi-source retrieval over indexed and remote sources.
...
- [fact; source: https://opentelemetry.io/docs/what-is-opentelemetry/; https://learn.microsoft.com/en-us/azure/foundry/observability/concepts/trace-agent-concept; https://learn.microsoft.com/en-us/azure/foundry/observability/how-to/how-to-monitor-agents-dashboard] Tracing and monitoring are built on Azure Monitor Application Insights and OpenTelemetry, and the dashboard surfaces token usage, latency, run success rate, evaluation metrics, and red-teaming results.
