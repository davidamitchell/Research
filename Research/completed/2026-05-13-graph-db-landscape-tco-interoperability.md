...
- [inference] Neo4j AuraDB is a property-graph platform with Cypher as its core query surface, an official Python driver, and a managed importer that reaches common relational and cloud-object sources, and the consulted current materials do not establish RDF or OWL support. [source: https://neo4j.com/docs/python-manual/current/; https://neo4j.com/docs/aura/classic/auradb/importing-data/]
