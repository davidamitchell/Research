...
- [inference] The DORA preview and report together support a productivity-paradox interpretation: individual gains arrive before organizational reliability gains, and adoption can create a temporary performance dip that must be managed deliberately. Source: https://dora.dev/research/2024/ai-preview/; https://dora.dev/research/2024/dora-report/; https://cloud.google.com/resources/content/dora-roi-of-ai-assisted-software-development. Source class: inference from primary sources.
...
- [fact] Peng et al. report that developers in a controlled GitHub Copilot experiment completed a Hypertext Transfer Protocol (HTTP) server task 55.8% faster than the control group. Source: https://arxiv.org/abs/2302.06590. Source class: primary.
