...
- Query: `Jensen Meckling 1976 PDF agency costs ownership structure`
  - Results inspected: ScienceDirect, SSRN, OA.mg landing pages
  - Accessible primary text: none retrieved in-session
- Query: `Weill Ross 2004 IT Governance HBS`
  - Results inspected: Harvard Business School item page
  - Accessible primary text: none retrieved in-session
- Query: `Kaplan Norton 1996 Balanced Scorecard HBS`
  - Results inspected: Harvard Business School item page
  - Accessible primary text: none retrieved in-session
- Seeded URL replacement:
  - Original URL: `https://www.nao.org.uk/reports/managing-the-costs-of-it/`
  - Outcome: 404
  - Replacement evidence family: accessible National Audit Office shared-services and programme-governance reports
