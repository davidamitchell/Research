...
- [fact] The sources align on the core asymmetry between observational success and mechanistic adequacy: Quine and the underdetermination literature emphasise evidential plurality, Raue quantifies parameter-level plurality, and Pearl and Peters et al. explain why interventions expose the difference. [source: https://www.theologie.uzh.ch/dam/jcr:ffffffff-fbd6-1538-0000-000070cf64bc/Quine51.pdf; https://plato.stanford.edu/entries/scientific-underdetermination/; https://opus.bibliothek.uni-augsburg.de/opus4/files/113236/113236.pdf; https://arxiv.org/abs/1801.04016; https://arxiv.org/abs/1501.01332]
...
4. [fact] Raue et al. supply the clearest quantitative test by defining structural non-identifiability as unchanged observables under redundant parameterisations and practical non-identifiability as unbounded likelihood-based confidence regions caused by insufficient data. [source: https://opus.bibliothek.uni-augsburg.de/opus4/files/113236/113236.pdf]
...
| [fact] Interpolation uniqueness is restricted to a chosen low-degree polynomial class. | https://maxjensen.github.io/Computational_Methods_lecture_notes/4.1_interpolation.html | high | Class-restricted uniqueness. |
...
| [fact] Structural and practical identifiability provide quantitative non-equivalence tests. | https://opus.bibliothek.uni-augsburg.de/opus4/files/113236/113236.pdf | high | Definitions plus criteria. |
...
2. **Polynomial interpolation is unique only inside a restricted hypothesis class, degree at most `n` polynomials for `n+1` nodes, which shows that uniqueness comes from model-class assumptions rather than from the observations alone.** ([fact]; high confidence; source: https://maxjensen.github.io/Computational_Methods_lecture_notes/4.1_interpolation.html)
...
4. **Raue et al. supply the clearest quantitative test by defining structural non-identifiability as unchanged observables under redundant parameterisations and practical non-identifiability as unbounded likelihood-based confidence regions caused by insufficient data.** ([fact]; high confidence; source: https://opus.bibliothek.uni-augsburg.de/opus4/files/113236/113236.pdf)
