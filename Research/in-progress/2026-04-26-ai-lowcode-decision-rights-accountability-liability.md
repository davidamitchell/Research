...
- [fact; source: https://davidamitchell.github.io/Research/research/2026-04-24-business-led-low-code-agent-governance.html; https://davidamitchell.github.io/Research/research/2026-04-22-enterprise-ai-platform-operating-models.html] Prior repository work found that business-led low-code value is durable only when intake is bounded, central governance exists, and the central platform hub retains control over shared policies and promotion rails.
...
|---|---|---|---|
| [inference] Tiered approval rights are required. | NIST AI RMF Core; prior low-code governance item; APRA CPS 230; DORA | high | Risk tolerance, bounded intake, and senior approval duties converge on three approval tiers. |
| [inference] Accountability must be split by lifecycle decision. | AI Act Articles 26 and 72; APRA CPS 230; DORA | high | Deployer, provider, business, and technology duties are distinct. |
| [inference] Production ownership means continuous operational duty. | AI Act Article 26; APRA CPS 230; DORA | high | Monitoring, logs, incidents, changes, and remediation define ownership. |
| [inference] Separation of duties requires independent challenge. | APRA CPS 230; DORA; Federal Reserve SR 26-2 | high | Builders should not self-approve high-impact systems. |
| [inference] Escalation needs explicit stop and override rights. | AI Act Articles 14 and 26; APRA CPS 230; DORA | high | Anomalies, serious incidents, and control failures must trigger escalation. |
| [fact] Current law keeps external liability outside internal RACI charts. | Commission 2025 Work Programme Annexes; Product Liability Directive; AI Act | high | The AI Liability Directive proposal is historical only, while software product liability is current law. |
| [fact] Boards or management bodies retain ultimate framework accountability. | APRA CPS 230; DORA | high | Delegation of operations does not remove top-level accountability. |
| [inference] Lifecycle matrices are stronger than static RACI labels. | NIST AI RMF Core; prior control-plane item; prior operating-model item | medium | AI governance spans intake, runtime, and oversight surfaces. |
