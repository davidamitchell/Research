...
- [fact; source: https://docs.aws.amazon.com/bedrock/latest/userguide/data-encryption.html] Bedrock documents Transport Layer Security (TLS) 1.2 for data in transit and AWS KMS-backed encryption for custom models, agents, data-source ingestion jobs, vector stores in OpenSearch, and evaluation jobs.
- [fact; source: https://aws.amazon.com/bedrock/security-compliance/; https://docs.aws.amazon.com/bedrock/latest/userguide/compliance-validation.html] AWS states that Bedrock is in scope for ISO, SOC, CSA STAR Level 2, General Data Protection Regulation (GDPR) use, Health Insurance Portability and Accountability Act (HIPAA) eligibility, and FedRAMP High in AWS GovCloud, and points customers to AWS Artifact and the services-in-scope list for program-specific verification.
...
The platform is also unusually explicit about cost and performance levers such as inference profiles, Provisioned Throughput, batch inference, prompt caching, and per-feature pricing, which gives enterprises more tuning options than a simple model endpoint catalog. [fact; source: https://docs.aws.amazon.com/bedrock/latest/userguide/inference-profiles.html; https://docs.aws.amazon.com/bedrock/latest/userguide/prov-throughput.html; https://docs.aws.amazon.com/bedrock/latest/userguide/batch-inference.html; https://docs.aws.amazon.com/bedrock/latest/userguide/prompt-caching.html; https://aws.amazon.com/bedrock/pricing/]

For a regulated environment, Bedrock's controls work best as powerful primitives that still require customer policy choices around IAM scope, Virtual Private Cloud networking, key management, data residency, and unified audit evidence. [inference; source: https://docs.aws.amazon.com/bedrock/latest/userguide/security.html; https://docs.aws.amazon.com/bedrock/latest/userguide/vpc-interface-endpoints.html; https://docs.aws.amazon.com/bedrock/latest/userguide/data-encryption.html; https://docs.aws.amazon.com/bedrock/latest/userguide/cross-region-inference.html; https://davidamitchell.github.io/Research/research/2026-04-26-multi-ai-provider-control-planes.html]

**Key findings:**

1. **Amazon Bedrock documents a broad model-access layer with 100+ foundation models from Amazon and many third-party providers, plus separate on-demand, cross-region, provisioned, and batch serving paths that let enterprises tune throughput, routing, and commitment levels for different workloads.** ([fact]; medium confidence; source: https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html; https://docs.aws.amazon.com/bedrock/latest/userguide/model-cards.html; https://docs.aws.amazon.com/bedrock/latest/userguide/inference-profiles.html; https://docs.aws.amazon.com/bedrock/latest/userguide/prov-throughput.html; https://docs.aws.amazon.com/bedrock/latest/userguide/batch-inference.html)
2. **Bedrock Agents provide a managed orchestration surface with action groups, knowledge-base integration, prompt customization, traces, aliases, and hierarchical multi-agent collaboration, which makes Bedrock stronger on native runtime composition than a plain model-hosting service.** ([fact]; medium confidence; source: https://docs.aws.amazon.com/bedrock/latest/userguide/agents.html; https://docs.aws.amazon.com/bedrock/latest/userguide/agents-multi-agent-collaboration.html)
3. **Knowledge Bases combine retrieval, citation, structured-data access, vector-store options, chunking strategies, reranking, query decomposition, and metadata-aware search, which gives Bedrock a materially complete managed RAG surface for enterprise information retrieval.** ([fact]; medium confidence; source: https://docs.aws.amazon.com/bedrock/latest/userguide/knowledge-base.html; https://docs.aws.amazon.com/bedrock/latest/userguide/knowledge-base-setup.html; https://docs.aws.amazon.com/bedrock/latest/userguide/kb-chunking.html; https://docs.aws.amazon.com/bedrock/latest/userguide/kb-test-config.html; https://docs.aws.amazon.com/bedrock/latest/userguide/rerank-use.html)
...
6. **Flows and Bedrock Data Automation extend Bedrock beyond model invocation by adding native workflow logic, service integrations, and multimodal extraction for documents, images, audio, and video, which reduces the amount of custom orchestration code enterprises need to write around core AI tasks.** ([fact]; medium confidence; source: https://docs.aws.amazon.com/bedrock/latest/userguide/flows.html; https://docs.aws.amazon.com/bedrock/latest/userguide/flows-nodes.html; https://docs.aws.amazon.com/bedrock/latest/userguide/bda-how-it-works.html)
...
|---|---|---|---|
| [fact] Bedrock exposes broad provider choice plus multiple serving modes. | https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html; https://docs.aws.amazon.com/bedrock/latest/userguide/model-cards.html; https://docs.aws.amazon.com/bedrock/latest/userguide/inference-profiles.html; https://docs.aws.amazon.com/bedrock/latest/userguide/prov-throughput.html; https://docs.aws.amazon.com/bedrock/latest/userguide/batch-inference.html | medium | Core platform and serving docs agree. |
| [fact] Bedrock Agents provide managed orchestration, traces, aliases, and multi-agent collaboration. | https://docs.aws.amazon.com/bedrock/latest/userguide/agents.html; https://docs.aws.amazon.com/bedrock/latest/userguide/agents-multi-agent-collaboration.html | medium | Primary agent docs are explicit. |
| [fact] Knowledge Bases provide a broadly complete managed RAG surface. | https://docs.aws.amazon.com/bedrock/latest/userguide/knowledge-base.html; https://docs.aws.amazon.com/bedrock/latest/userguide/knowledge-base-setup.html; https://docs.aws.amazon.com/bedrock/latest/userguide/kb-chunking.html; https://docs.aws.amazon.com/bedrock/latest/userguide/kb-test-config.html; https://docs.aws.amazon.com/bedrock/latest/userguide/rerank-use.html | medium | Retrieval, filtering, and tuning surfaces are all documented. |
...
| [fact] Flows and Bedrock Data Automation add workflow and multimodal extraction primitives. | https://docs.aws.amazon.com/bedrock/latest/userguide/flows.html; https://docs.aws.amazon.com/bedrock/latest/userguide/flows-nodes.html; https://docs.aws.amazon.com/bedrock/latest/userguide/bda-how-it-works.html | medium | Strong primary docs across both features. |
