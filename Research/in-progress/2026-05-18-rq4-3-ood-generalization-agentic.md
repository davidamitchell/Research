---
title: "RQ 4.3: Formal bounds on generalisation outside the training distribution for tool-using Large Language Model systems under non-deterministic tool outputs"
...
# RQ 4.3: Formal bounds on generalisation outside the training distribution for tool-using Large Language Model systems under non-deterministic tool outputs
...
1. Distinguish epistemic uncertainty, meaning reducible model uncertainty, from aleatoric uncertainty, meaning irreducible randomness in observations or outcomes.
...
- [fact] Kendall and Gal distinguish epistemic uncertainty, which reflects uncertainty in the model and can be reduced with more data, from aleatoric uncertainty, which captures noise inherent in the observations. [source: https://arxiv.org/abs/1703.04977]
...
- [fact] Angelopoulos and Bates describe conformal prediction as providing explicit finite-sample coverage guarantees without distributional or model assumptions when the calibration and test points are exchangeable. [source: https://arxiv.org/abs/2107.07511]
...
- [fact] Tool-output randomness belongs mainly to the aleatoric uncertainty term, so it creates an irreducible error floor that cannot be removed by collecting more planner training data alone. [source: https://arxiv.org/abs/1703.04977]
...
- [fact] Tool-output randomness is aleatoric, so it creates an irreducible uncertainty floor. | source: https://arxiv.org/abs/1703.04977 | confidence: high | notes: irreducible observation noise
...
2. **Non-deterministic tool outputs belong mainly to the aleatoric uncertainty term, so they create an irreducible error floor that additional planner training data or model scaling cannot remove on their own.** ([fact]; medium confidence; source: https://arxiv.org/abs/1703.04977)
...
| [fact] Tool-output randomness is aleatoric, so it creates an irreducible uncertainty floor. | https://arxiv.org/abs/1703.04977 | medium | irreducible observation noise |
