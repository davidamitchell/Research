...
- **[fact]** AgentDojo reports that state-of-the-art LLMs fail at many realistic tasks even in the absence of attacks, across domains including email, e-banking, and travel booking, and that prompt-injection attacks further weaken security properties. Source: https://arxiv.org/abs/2406.13352. Source class: primary.
...
- **[fact]** OWASP's Large Language Model (LLM) 08 guidance says excessive functionality, excessive permissions, or excessive autonomy can cause damaging actions, and it recommends least privilege, granular tools, downstream authorization, human approval for actions, and rate limiting. Source: https://genai.owasp.org/llm08-excessive-agency/. Source class: primary.
...
Public evidence does not currently provide a task-complexity-normalised head-to-head failure distribution, but the strongest available proxies show that AI-assisted code that clears a standard gated delivery pipeline fails less often in the outside world, and is far more detectable before impact, than AI agents executing business processes directly. [inference; source: https://dora.dev/guides/dora-metrics-four-keys/; https://dora.dev/research/2024/dora-report/; https://arxiv.org/abs/2307.13854; https://arxiv.org/abs/2406.12045]
...
2. **Build-mode failure is publicly observable mainly as failure that escaped release gates, because software-delivery metrics measure deployments that require intervention after release while Site Reliability Engineering guidance shows that tests can block many equivalent failures before production.** ([fact]; high confidence; source: https://dora.dev/guides/dora-metrics-four-keys/; https://sre.google/sre-book/testing-reliability/)
...
4. **The 2024 DORA evidence indicates that AI adoption improves several local development activities while still reducing delivery stability and throughput, which implies that AI assistance does not remove the need for small batches, robust tests, and disciplined review if teams want low escaped-failure rates.** ([fact]; high confidence; source: https://cloud.google.com/blog/products/devops-sre/announcing-the-2024-dora-report; https://dora.dev/research/2024/dora-report/)
5. **Realistic do-mode benchmarks show much lower baseline reliability than gated build mode proxies, because WebArena reports 14.41% GPT-4 success, tau-bench reports fewer than 50% successful tasks and less than 25% reliability across repeated retail trials, and AgentDojo still reports many failures even without attacks.** ([fact]; high confidence; source: https://arxiv.org/abs/2307.13854; https://arxiv.org/abs/2406.12045; https://arxiv.org/abs/2406.13352)
...
7. **The strongest public legal and regulatory material treats autonomous process execution as a lifecycle risk-management and operational-resilience problem, not merely as a software-quality problem, because high-risk systems must be tested, monitored, and controlled during live use as well as before release.** ([fact]; high confidence; source: https://artificialintelligenceact.eu/article/9/; https://www.bis.org/bcbs/publ/d516.htm; https://doi.org/10.6028/NIST.AI.100-1)
...
| [fact] Build-mode external failure is publicly measured as post-release intervention, while tests can block equivalent failures before production. | https://dora.dev/guides/dora-metrics-four-keys/ ; https://sre.google/sre-book/testing-reliability/ | high | Escaped-failure framing |
...
| [fact] AI adoption improves local development metrics while reducing delivery stability and throughput at the system level. | https://cloud.google.com/blog/products/devops-sre/announcing-the-2024-dora-report ; https://dora.dev/research/2024/dora-report/ | high | Local versus system-level distinction |
| [fact] Realistic do-mode benchmarks report low baseline success on multi-step tasks and poor repeatability. | https://arxiv.org/abs/2307.13854 ; https://arxiv.org/abs/2406.12045 ; https://arxiv.org/abs/2406.13352 | high | Runtime task-execution evidence |
...
| [fact] Regulatory and resilience frameworks require lifecycle testing, monitoring, mitigation, and incident learning for high-risk or critical operations. | https://artificialintelligenceact.eu/article/9/ ; https://www.bis.org/bcbs/publ/d516.htm ; https://doi.org/10.6028/NIST.AI.100-1 | high | Regulated-operations lens |
