...
- [fact] Variance-based sensitivity analysis decomposes model-output variance into contributions from individual input factors and from their interactions, and practitioners often compute first-order effects together with total effects for this purpose. [source: https://publications.jrc.ec.europa.eu/repository/handle/JRC52955; https://www.wiley.com/en-us/Global+Sensitivity+Analysis%3A+The+Primer-p-9780470059975]
...
- [fact] Gutenkunst et al. report that sloppy models have parameter-sensitivity spectra whose eigenvalues span many decades, so behavior depends strongly on a few stiff parameter combinations and weakly on many sloppy directions. [source: https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.0030189]
...
- [fact] Jagadeesan et al. also state that checking structural identifiability before parameter estimation is imperative, because structural unidentifiability yields multiple solutions to the estimation problem. [source: https://pmc.ncbi.nlm.nih.gov/articles/PMC9994762/]
...
2. **Parascandolo et al. provide the closest direct operationalisation of Deutsch's idea by defining consistency for minima across environments and by treating low-consistency minima as patchwork solutions that are likely to memorise rather than capture invariant mechanisms.** ([fact]; high confidence; source: https://arxiv.org/abs/2009.00329)
...
4. **Sloppiness and identifiability research show that easy variation appears as broad regions of parameter space that preserve nearly identical predictions, whereas hard-to-vary explanations occupy comparatively small, stiff, explanation-preserving regions.** ([inference]; medium confidence; source: https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.0030189; https://pmc.ncbi.nlm.nih.gov/articles/PMC9994762/; https://arxiv.org/abs/1608.05679)
...
7. **Flexible deep neural networks trained only for prediction should usually score lower on this criterion than compact mechanistic models, but hybrid scientific machine learning systems can raise their score when architecture and training explicitly enforce governing structure or cross-environment invariance.** ([inference]; medium confidence; source: https://pmc.ncbi.nlm.nih.gov/articles/PMC12341957/; https://arxiv.org/abs/2009.00329)
...
| [fact] Parascandolo operationalises hard-to-vary explanations through consistency across environments and treats low-consistency minima as patchwork solutions. | https://arxiv.org/abs/2009.00329 | high | Directly stated by the paper |
...
| [inference] Unconstrained deep neural networks usually score lower than mechanistic or strongly structured hybrid models on this criterion. | https://pmc.ncbi.nlm.nih.gov/articles/PMC12341957/; https://arxiv.org/abs/2009.00329 | medium | Comparative synthesis with an explicit caveat for hybrids |
