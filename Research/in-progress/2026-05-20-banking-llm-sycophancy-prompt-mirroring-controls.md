...
- [fact; source: https://www.nist.gov/publications/artificial-intelligence-risk-management-framework-generative-artificial-intelligence] The National Institute of Standards and Technology (NIST) Generative Artificial Intelligence Profile presents itself as a companion resource to Artificial Intelligence Risk Management Framework (AI RMF) 1.0 for generative Artificial Intelligence, which makes it a useful governance supplement but not a banking-specific supervisory rule.
- [fact; source: https://www.bis.org/bcbs/basel3.htm] The Bank for International Settlements describes Basel III as internationally agreed measures intended to strengthen the regulation, supervision, and risk management of banks, which makes weakly controlled prompt-driven decision support a prudential governance problem rather than only a user-experience problem.
...
The strongest direct prompt mitigations in the reviewed evidence are converting analyst statements into questions and restating case context in neutral or third-person form before generation, because those changes reduce the framing features most associated with sycophancy. [fact; source: https://arxiv.org/abs/2508.02087; https://aclanthology.org/2025.findings-emnlp.121/; https://arxiv.org/abs/2602.23971]
...
3. **Statement-to-question conversion and third-person restatement are the most defensible first-line prompt controls, because reviewed primary studies show both interventions reduce sycophancy more reliably than a simple instruction telling the model not to agree.** ([fact]; high confidence; source: https://arxiv.org/abs/2508.02087; https://aclanthology.org/2025.findings-emnlp.121/; https://arxiv.org/abs/2602.23971)
...
5. **For credit underwriting in the European Union, the safest governance posture is to keep the LLM in an advisory role rather than a final justification role, because credit scoring is treated as a high-risk use case and Article 14 requires real human oversight, override, and stop capability.** ([inference]; high confidence; source: https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai; https://ai-act-service-desk.ec.europa.eu/en/ai-act/article-14)
...
| [fact] Statement-to-question conversion and third-person restatement are the strongest reviewed first-line prompt mitigations. | https://arxiv.org/abs/2508.02087; https://aclanthology.org/2025.findings-emnlp.121/; https://arxiv.org/abs/2602.23971 | high | Direct primary mitigation evidence. |
...
| [inference] Credit-underwriting uses should keep the LLM in an advisory role rather than a final justification role. | https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai; https://ai-act-service-desk.ec.europa.eu/en/ai-act/article-14 | high | High-risk credit scoring and oversight duties. |
