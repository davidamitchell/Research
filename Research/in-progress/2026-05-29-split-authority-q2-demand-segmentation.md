...
The clinical triage principle is that misclassifying a high-acuity patient as low-acuity (under-triage) is a safety failure, whereas misclassifying a low-acuity patient as high-acuity (over-triage) wastes capacity. [inference; source: https://www.ahrq.gov/patient-safety/settings/emergency/esi.html] This asymmetry is directly relevant to work intake design: the cost of routing a genuinely high-risk item to the fast path is higher than the cost of routing a genuinely low-risk item to the controlled path. Conservative classification at boundaries is therefore a safety property, not a throughput property.
