...
- [fact; source: https://davidamitchell.github.io/Research/research/2026-05-23-governance-failure-mechanisms-bureaucracy-circumvention.html] The adjacent governance-failure item shows that control systems become bureaucratic overhead when control intensity no longer matches transaction hazard and when proxy compliance displaces the underlying objective.
...
- [inference; source: https://docs.cloud.google.com/architecture/devops; https://sre.google/sre-book/service-level-objectives/; https://www.finops.org/framework/personas/] The durable mitigation is not less governance, but better-located governance: routine technical, cost, and service decisions should sit with the accountable delivery team, while central functions should enable shared metrics, guardrails, and rapid exception handling.
...
4. [inference; source: https://tmf.cio.gov/; https://tmf.cio.gov/board/; https://www.nao.org.uk/insights/six-reasons-why-digital-transformation-is-still-a-problem-for-government/] Milestone-based and outcome-aware funding releases preserve delivery capability better than one-off project approvals, because they fund learning incrementally while still giving the central authority visible control over investment pacing.
...
| [inference] Milestone-based funding releases outperform one-off approvals for split-authority delivery. | https://tmf.cio.gov/; https://tmf.cio.gov/board/; https://www.nao.org.uk/insights/six-reasons-why-digital-transformation-is-still-a-problem-for-government/ | medium | incremental release, monitored progress |
...
The evidence does not support abolishing central governance. [fact; source: https://www.nao.org.uk/insights/six-reasons-why-digital-transformation-is-still-a-problem-for-government/; https://tmf.cio.gov/; https://ussm.gsa.gov/governance/] It supports relocating governance so that central actors own guardrails, portfolio pacing, and escalation, while delivery-capable teams own routine engineering, service, and cost decisions inside those guardrails. [inference; source: https://docs.cloud.google.com/architecture/devops; https://www.finops.org/framework/personas/; https://davidamitchell.github.io/Research/research/2026-05-17-integrator-rights-vs-risk-cost-benefit-colocation-governance.html]
...
4. **Milestone-based and outcome-aware funding releases preserve delivery capability better than one-off project approvals because they let central funders keep investment control while allowing delivery-capable teams to learn, adapt scope, and draw money as measurable progress is demonstrated.** ([inference]; medium confidence; source: https://tmf.cio.gov/; https://tmf.cio.gov/board/; https://www.nao.org.uk/insights/six-reasons-why-digital-transformation-is-still-a-problem-for-government/)
...
6. **Commercial arrangements work better when they budget for both build and run costs and permit changing scope, because rigid capital-heavy or specification-heavy models systematically underfund the ongoing maintenance, resilience, and integration work that determines long-run service performance.** ([inference]; medium confidence; source: https://www.nao.org.uk/insights/six-reasons-why-digital-transformation-is-still-a-problem-for-government/; https://www.gov.uk/government/publications/state-of-digital-government-review/state-of-digital-government-review)
7. **Split-authority governance becomes counterproductive when control intensity exceeds transaction hazard, because the result is queueing, proxy compliance, and escalation traffic rather than materially better risk reduction or faster learning.** ([inference]; medium confidence; source: https://davidamitchell.github.io/Research/research/2026-05-23-governance-controls-effectiveness-conditions.html; https://davidamitchell.github.io/Research/research/2026-05-23-governance-failure-mechanisms-bureaucracy-circumvention.html; https://davidamitchell.github.io/Research/research/2026-05-19-how-do-formal-governance-structures-distort-cross-department-knowledge-flows.html)
8. **The best-supported operating pattern is therefore delegated delivery authority with central guardrails, shared outcome metrics, and approval-by-exception, rather than a standing separation in which the funder routinely re-decides local technical and operational choices.** ([inference]; medium confidence; source: https://www.finops.org/framework/principles/; https://docs.cloud.google.com/architecture/devops; https://sre.google/sre-book/service-level-objectives/)
