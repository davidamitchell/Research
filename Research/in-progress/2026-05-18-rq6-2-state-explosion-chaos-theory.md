...
- [assumption] Because the direct Lorenz and Lamport DOI landing pages were inaccessible in this session and the seeded model-checking book page was bibliographic only, the accessible Lorenz DOI record plus American Mathematical Society article, Lamport PDF mirror, and Kot survey note are treated as the operative sources for the claims below. [source: https://doi.org/10.1175/1520-0469(1963)020%3C0130:DNF%3E2.0.CO;2; https://www.ams.org/publicoutreach/feature-column/fcarc-lorenz; https://lamport.azurewebsites.net/pubs/time-clocks.pdf; https://www.cs.vsb.cz/kot/down/Texts/StateSpace.pdf; https://mitpress.mit.edu/9780262038553/model-checking/]
...
4. [fact] Adversarial examples show a comparable sensitivity class in machine learning, because small worst-case perturbations can force high-confidence misclassification and the cited paper attributes much of that vulnerability to linear behavior in high-dimensional spaces. [source: https://arxiv.org/abs/1412.6572] **Confidence:** Medium.
...
4. **Adversarial examples show a comparable sensitivity class in machine learning, because small worst-case perturbations can force high-confidence misclassification and the cited paper attributes much of that vulnerability to linear behavior in high-dimensional spaces.** ([fact]; medium confidence; source: https://arxiv.org/abs/1412.6572)
