...
- [inference] Production operations already treat Large Language Model and agent systems as needing additional observability because conventional incident detection is not enough to reconstruct or safely automate recovery once semantic or model-specific failure mechanisms are involved. [source: https://cloudintelligenceworkshop.org/papers/aiops26-Ranganathan.pdf; https://arxiv.org/abs/2411.05285; https://arxiv.org/abs/2503.00563]
...
- [fact] No reviewed source contradicts the claim that deterministic systems retain stronger local replayability while still becoming globally opaque at scale. [source: https://sre.google/sre-book/monitoring-distributed-systems/; https://davidamitchell.github.io/Research/research/2026-05-18-agentic-explainability-vs-traditional.html]
- [fact] No reviewed source shows that current Large Language Model agents reliably reject misleading or attacker-shaped external content at the boundary where it enters the context window. [source: https://arxiv.org/abs/2302.12173; https://arxiv.org/abs/2312.14197; https://www.microsoft.com/en-us/msrc/blog/2025/07/how-microsoft-defends-against-indirect-prompt-injection-attacks]
...
3. **Repeated-run evidence shows that supposedly deterministic Large Language Model settings still produce materially different outputs and assessment paths on identical prompts, so a single unvalidated input can induce a distribution of possible failure trajectories rather than one reproducible trajectory.** ([fact]; high confidence; source: https://arxiv.org/abs/2408.04667; https://arxiv.org/abs/2502.20747; https://davidamitchell.github.io/Research/research/2026-05-09-llm-determinism-limits-temperature-zero.html)
...
5. **Production operations already treat Large Language Model and agent systems as needing extra observability because incident detection can be highly automated while mitigation remains manual, and dedicated observability taxonomies have emerged to trace lifecycle artifacts that conventional service monitoring does not capture.** ([fact]; medium confidence; source: https://cloudintelligenceworkshop.org/papers/aiops26-Ranganathan.pdf; https://arxiv.org/abs/2411.05285)
...
| [fact] Identical prompts still produce materially different outputs under supposedly deterministic Large Language Model settings. | https://arxiv.org/abs/2408.04667 ; https://arxiv.org/abs/2502.20747 ; https://davidamitchell.github.io/Research/research/2026-05-09-llm-determinism-limits-temperature-zero.html | High | repeated-run evidence |
...
| [fact] Large Language Model serving incidents are often detected automatically while mitigation remains manual, and observability taxonomies have emerged for agent lifecycle tracing. | https://cloudintelligenceworkshop.org/papers/aiops26-Ranganathan.pdf ; https://arxiv.org/abs/2411.05285 | Medium | operational evidence |
...
The evidence is strongest on three narrow points: Large Language Models remain non-deterministic under repeated identical prompts, prompt-injection and indirect prompt-injection attacks can convert untrusted data into actionable instructions, and conventional software operations literature expects bogus-input failures to surface through explicit monitoring and root-cause repair. [fact; source: https://arxiv.org/abs/2408.04667; https://arxiv.org/abs/2502.20747; https://arxiv.org/abs/2302.12173; https://arxiv.org/abs/2312.14197; https://sre.google/sre-book/monitoring-distributed-systems/]
