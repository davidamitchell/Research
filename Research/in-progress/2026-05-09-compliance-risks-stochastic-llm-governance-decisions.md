...
1. **European Union and United Kingdom data-protection guidance restricts solely automated decisions with legal or similarly significant effects and requires meaningful safeguards, so stochastic Large Language Model outputs are a poor fit as the only authority for privacy or governance decisions.** ([fact]; high confidence; source: https://commission.europa.eu/law/law-topic/data-protection/rules-business-and-organisations/dealing-citizens/are-there-restrictions-use-automated-decision-making_en; https://ec.europa.eu/newsroom/article29/items/612053; https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/artificial-intelligence/guidance-on-ai-and-data-protection/)
2. **Meaningful human intervention must be able to understand, challenge, and change an automated outcome, which means nominal review layered on top of a stochastic model does not remove the underlying compliance risk if the reviewer is only rubber-stamping.** ([fact]; high confidence; source: https://commission.europa.eu/law/law-topic/data-protection/rules-business-and-organisations/dealing-citizens/are-there-restrictions-use-automated-decision-making_en; https://ec.europa.eu/newsroom/article29/items/612053)
...
4. **Current United States banking model-risk guidance does not supply a safe harbor for stochastic compliance decisioning because it excludes generative and agentic Artificial Intelligence from scope while still preserving expectations for governance, validation, monitoring, and third-party oversight.** ([fact]; high confidence; source: https://www.occ.gov/news-issuances/bulletins/2026/bulletin-2026-13.html)
5. **Federal Trade Commission enforcement against DoNotPay shows that regulators will treat unsupported claims that a chatbot can substitute for professional legal or compliance expertise as a deceptive-practices problem when testing and evidence are missing.** ([fact]; high confidence; source: https://www.ftc.gov/news-events/news/press-releases/2024/09/ftc-announces-crackdown-deceptive-ai-claims-schemes)
...
| [fact] Current United States banking model-risk guidance excludes generative and agentic Artificial Intelligence from scope while preserving governance and validation expectations for in-scope models. | https://www.occ.gov/news-issuances/bulletins/2026/bulletin-2026-13.html | high | no safe harbor |
| [fact] Regulators will challenge unsupported claims that a chatbot can replace professional judgment in legal and compliance contexts. | https://www.ftc.gov/news-events/news/press-releases/2024/09/ftc-announces-crackdown-deceptive-ai-claims-schemes | high | DoNotPay signal |
