...
- [fact; source: https://www.iso.org/standard/74393.html; https://www.opengroup.org/architecture/togaf7-doc/arch/p4/views/vus_intro.htm] There is no contradiction between ISO/IEC/IEEE 42010 and TOGAF on structure: ISO/IEC/IEEE 42010 defines how architecture descriptions should be expressed, while TOGAF adds reusable enterprise architecture guidance on views, viewpoints, and reference models.
...
A practical reference architecture should define a reusable logical architecture, not an implementation blueprint: it needs stakeholder concerns, viewpoints, core components, major flows, constraints, and bounded technology options, while leaving environment-specific commitments to a later design artifact. [inference; source: https://www.iso.org/standard/74393.html; https://www.opengroup.org/architecture/togaf7-doc/arch/p4/views/vus_intro.htm; https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/app-service-web-app/basic-web-app]
ISO/IEC/IEEE 42010 and TOGAF provide the structural answer, architecture description, views, viewpoints, and reference material, while Azure, AWS, and Google Cloud provide the practical answer, diagrams, numbered workflows, named components, and explicit review considerations. [fact; source: https://www.iso.org/standard/74393.html; https://www.opengroup.org/architecture/0210can/togaf8/doc-review/togaf8cr/c/p2/ta/ta_views.htm; https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/app-service-web-app/basic-web-app; https://docs.aws.amazon.com/prescriptive-guidance/latest/security-reference-architecture/introduction.html; https://cloud.google.com/architecture/framework]
...
When stakeholders ask for a reference architecture, they usually need either a common vocabulary, a reusable solution pattern, or a bounded standard for implementation; naming which of those is wanted is the key scoping move. [inference; source: https://www.opengroup.org/togaf; https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/; https://aws.amazon.com/architecture/; https://cloud.google.com/architecture/framework]

**Key findings:**

1. **A practical reference architecture should be treated as a reusable architecture description that addresses stakeholder concerns through named views, components, relationships, and design principles, rather than as a single diagram or a list of products.** ([inference]; high confidence; source: https://www.iso.org/standard/74393.html; https://www.opengroup.org/architecture/togaf7-doc/arch/p4/views/vus_intro.htm)
2. **ISO/IEC/IEEE 42010 provides the structural grammar for architecture descriptions, but TOGAF contributes the more operational guidance on selecting viewpoints, reference models, and concrete views that make a reusable architecture artifact usable in practice.** ([fact]; high confidence; source: https://www.iso.org/standard/74393.html; https://www.opengroup.org/architecture/0210can/togaf8/doc-review/togaf8cr/c/p2/ta/ta_views.htm; https://www.opengroup.org/togaf)
3. **Official cloud reference architectures consistently include a canonical diagram, a flow or workflow description, named components, and explicit quality or control considerations, which shows that a reference architecture must be reviewable from multiple angles, not only visually understandable.** ([fact]; high confidence; source: https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/app-service-web-app/basic-web-app; https://docs.aws.amazon.com/architecture-diagrams/latest/modern-data-analytics-on-aws/modern-data-analytics-on-aws.html; https://docs.aws.amazon.com/prescriptive-guidance/latest/security-reference-architecture/introduction.html)
...
8. **The phrase "we need a reference architecture" usually hides three different requests, common vocabulary, reusable pattern, or implementation baseline, and architects should force that distinction early to avoid mixing conceptual and deployment decisions into one artifact.** ([inference]; medium confidence; source: https://www.opengroup.org/togaf; https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/; https://aws.amazon.com/architecture/; https://cloud.google.com/architecture/framework)

**Evidence map:**

| Claim | Source | Confidence | Notes |
|---|---|---|---|
| [inference] A practical reference architecture is a reusable architecture description rather than a single diagram or product list. | https://www.iso.org/standard/74393.html; https://www.opengroup.org/architecture/togaf7-doc/arch/p4/views/vus_intro.htm | high | Standards structure |
| [fact] ISO/IEC/IEEE 42010 and TOGAF play complementary roles, one structural, one operational. | https://www.iso.org/standard/74393.html; https://www.opengroup.org/architecture/0210can/togaf8/doc-review/togaf8cr/c/p2/ta/ta_views.htm; https://www.opengroup.org/togaf | high | Complementary frameworks |
| [fact] Official cloud reference architectures package diagrams, flows, components, and considerations together. | https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/app-service-web-app/basic-web-app; https://docs.aws.amazon.com/architecture-diagrams/latest/modern-data-analytics-on-aws/modern-data-analytics-on-aws.html; https://docs.aws.amazon.com/prescriptive-guidance/latest/security-reference-architecture/introduction.html | high | Practical artifact shape |
...
| [inference] Stakeholder requests for a reference architecture usually hide three different deliverable types. | https://www.opengroup.org/togaf; https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/; https://aws.amazon.com/architecture/; https://cloud.google.com/architecture/framework | medium | Scoping heuristic |
...
The strongest evidence comes from combining standards-level structure with official working examples. ISO/IEC/IEEE 42010 explains how an architecture description should be organized, but not what a reusable enterprise reference artifact looks like on its own. [inference; source: https://www.iso.org/standard/74393.html]
...
- Review result: pass
- Acronym audit: ISO, IEC, IEEE, TOGAF, AWS, and DNS expanded on first use in document prose; no unresolved acronym first-use violations found.
- Claim audit: all visible factual and inferential claims in Research Skill Output are labeled and source-bound; §0 and this section are metadata fragments.
- Source audit: every listed source includes a direct link and every Findings citation uses links that appear in `## Sources`.
- Consistency audit: §6 Synthesis and `## Findings` are aligned in substance, confidence levels, and source set.
