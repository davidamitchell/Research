...
1. **A practical reference architecture should be treated as a reusable architecture description, a structured expression of architecture through stakeholder-oriented views and viewpoints, that addresses concerns through named components, relationships, and design principles rather than as a single diagram or a list of products.** ([inference]; high confidence; source: https://www.iso.org/standard/74393.html; https://www.opengroup.org/architecture/togaf7-doc/arch/p4/views/vus_intro.htm)
