...
- Access note: the Joint Money Laundering Steering Group (JMLSG) current-guidance page and direct Part I PDF endpoints returned 403 responses in this runtime.
...
7. [inference] Basel guidance pushes firms beyond one-time deterministic scoring because it expects customer risk profiles to incorporate intended relationship purpose, expected activity, behavior over time, and ongoing monitoring, all of which reward dynamic rather than static models. (high confidence; source: https://www.bis.org/bcbs/publ/d353.pdf)
...
- Claim 7: [inference] Basel expectations make static one-time scoring insufficient on their own. | Source: https://www.bis.org/bcbs/publ/d353.pdf | Confidence: high | Notes: dynamic-profile expectation
...
7. **Basel guidance pushes firms beyond one-time deterministic scoring because it expects customer risk profiles to incorporate intended relationship purpose, expected activity, behavior over time, and ongoing monitoring, all of which reward dynamic rather than static models.** ([inference]; high confidence; source: https://www.bis.org/bcbs/publ/d353.pdf)
...
| [inference] Basel expectations make static one-time scoring insufficient on their own. | https://www.bis.org/bcbs/publ/d353.pdf | high | dynamic-profile expectation |
