...
3. Assess data-quality, governance, and survivorship bias, meaning distortion caused when only records that remain visible later are counted, that affect comparability across organisations.
...
- [x] [Mitchell (2026) Control deficiencies from bypassing designated workforce record platforms](https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-09-system-of-record-bypass-control-deficiencies.md) - prior completed item on derivative-record and provenance failures
...
- **B4. ServiceNow central-demand datasets**
  ...
  - [inference; source: https://www.servicenow.com/community/spm-blog/quick-start-guide-for-demand-management/ba-p/2722545] A ServiceNow Demand Management dataset is therefore a strong central-backlog target dataset when implemented, because it supplies the governed intake queue against which workaround-origin signals can be matched.
...
- **D. Bias and data-quality risks**
  ...
  - [inference; source: https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issues/; https://docs.github.com/en/rest/issues/timeline; https://learn.microsoft.com/en-us/power-platform/admin/power-platform-inventory] Month-over-month conversion measurement requires retained history or periodic snapshots, because current-state tables alone create survivorship bias by hiding closed, deleted, or reclassified records.
  ...
  - [inference; source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-09-system-of-record-bypass-control-deficiencies.md; https://learn.microsoft.com/en-us/power-platform/guidance/coe/governance-components; https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issue-fields/] The largest false-positive risk is weak provenance, because records can be linked after the fact or by loose text matching instead of durable origin IDs, which inflates apparent conversion without proving a true source-to-backlog pathway.
...
- [inference; source: https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issues/; https://docs.github.com/en/rest/issues/timeline; https://learn.microsoft.com/en-us/power-platform/admin/power-platform-inventory] There is no internal contradiction between recommending current-state inventory tables and warning about survivorship bias, because the recommendation is to use those tables only when paired with history or periodic snapshots.
...
- [inference; source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-09-system-of-record-bypass-control-deficiencies.md; https://learn.microsoft.com/en-us/power-platform/guidance/coe/governance-components] Governance lens: origin provenance is a control surface as well as an analytics requirement, because weak linkage between workaround artifacts and formal backlog items prevents audit, prioritization, and accountability.
...
No consulted public benchmark dataset directly measures the rate at which enterprise manual workaround demand becomes formal central Information Technology backlog work, so valid measurement depends on joining internal workaround-signal datasets to governed backlog datasets with durable provenance links. [inference; source: https://dora.dev/guides/dora-metrics/; https://learn.microsoft.com/en-us/power-platform/admin/power-platform-inventory; https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issue-search/; https://docs.github.com/en/rest/issues/issues]
...
The strongest governed-backlog dataset in scope is a centralized demand or backlog system such as ServiceNow Demand Management, or equivalent Jira or GitHub work-item datasets when organisations enforce explicit origin fields and lifecycle conventions. [inference; source: https://www.servicenow.com/community/spm-blog/quick-start-guide-for-demand-management/ba-p/2722545; https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issue-search/; https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issues/; https://docs.github.com/en/rest/issues/issues; https://docs.github.com/en/rest/issues/timeline]
...
4. **Power Platform governance datasets are strong demand-side inputs because inventory records expose owners, environments, and timestamps, audit-log flows add launches and unique-user telemetry, and governance components capture business justification, impact, dependencies, and mitigation details for locally built solutions.** ([fact]; high confidence; source: https://learn.microsoft.com/en-us/power-platform/guidance/coe/setup-core-components; https://learn.microsoft.com/en-us/power-platform/guidance/coe/setup-auditlog-http-graphapi; https://learn.microsoft.com/en-us/power-platform/guidance/coe/governance-components; https://learn.microsoft.com/en-us/power-platform/admin/inventory-schema)
5. **A centralized demand-intake dataset such as ServiceNow Demand Management is the strongest target-side dataset in scope because it is explicitly designed to capture, centralize, assess, and prioritize business and operational demands before promotion into formal delivery work.** ([fact]; medium confidence; source: https://www.servicenow.com/community/spm-blog/quick-start-guide-for-demand-management/ba-p/2722545)
...
| [fact] Power Platform governance datasets expose ownership, usage, justification, and dependency fields for local solutions. | https://learn.microsoft.com/en-us/power-platform/guidance/coe/setup-core-components ; https://learn.microsoft.com/en-us/power-platform/guidance/coe/setup-auditlog-http-graphapi ; https://learn.microsoft.com/en-us/power-platform/guidance/coe/governance-components ; https://learn.microsoft.com/en-us/power-platform/admin/inventory-schema | high | Strong workaround-demand side coverage |
| [fact] ServiceNow Demand Management provides a centralized intake and assessment surface for strategic and operational demand. | https://www.servicenow.com/community/spm-blog/quick-start-guide-for-demand-management/ba-p/2722545 | medium | One consulted readable source, but it is authoritative ServiceNow community guidance |
...
| [inference] Retained history or periodic snapshots are necessary to avoid survivorship bias. | https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issues/ ; https://docs.github.com/en/rest/issues/timeline ; https://learn.microsoft.com/en-us/power-platform/admin/power-platform-inventory ; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-09-system-of-record-bypass-control-deficiencies.md | high | Current-state tables alone are insufficient |
| [inference] Weak provenance between source artifacts and backlog items is the main failure mode for the metric. | https://learn.microsoft.com/en-us/power-platform/guidance/coe/governance-components ; https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issue-fields/ ; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-09-system-of-record-bypass-control-deficiencies.md | medium | Link-table discipline is required |
...
- Cross-item integration audit: prior completed items on persistent demand, provenance failure, citizen-development governance, and denominator design are integrated where they materially sharpen the measurement design
