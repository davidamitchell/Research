...
3. **Public-framing extraction:** Use Brown University host material, the Brown lecture video metadata and transcript-like extraction, the April 2025 interview summaries published by the official host, and the Pioneer Works host page to identify what LeCun repeats or sharpens later.
...
- [fact; source: https://www.youtube.com/watch?v=ZbrfvMLZZK4; https://livestream.brown.edu/lemley] The accessible Brown lecture video output checked in this session contains a transcript-like segment in which LeCun contrasts simple feedforward token-level inference with "inference by optimization," says many important tasks are intrinsically serial, and uses theorem proving as an example of a System 2 task requiring planned multi-step reasoning.
...
- [fact; source: https://www.youtube.com/watch?v=ZbrfvMLZZK4; https://openreview.net/pdf?id=BZ5a1r-kVsf] The accessible Brown lecture material also supports a narrower positive boundary for constrained optimization-heavy reasoning tasks, because LeCun uses theorem proving as an example of System 2 reasoning and ties such reasoning to optimization over latent variables rather than to one-pass token generation.
- [inference; source: https://www.youtube.com/watch?v=ZbrfvMLZZK4; https://openreview.net/pdf?id=BZ5a1r-kVsf] The accessible sources therefore support a weaker positive claim than the item's original wording implied: LeCun appears to allow that constrained symbolic reasoning tasks fit optimization-and-search machinery better than open-ended world action, but the exact "formal systems with external verifiers" formula was not directly recoverable from accessible primary text in this runtime.
...
- [inference; source: https://openreview.net/pdf?id=BZ5a1r-kVsf; https://www.youtube.com/watch?v=ZbrfvMLZZK4] The only place where the evidence remains asymmetric is the positive boundary around formal or verifiable reasoning, which is suggested by the Brown lecture material but not stated as explicitly as the negative boundary around consequential world action.
...
- [inference; source: https://www.youtube.com/watch?v=ZbrfvMLZZK4; https://openreview.net/pdf?id=BZ5a1r-kVsf] **Reasoning lens:** The Brown theorem-proving example suggests that LeCun treats reasoning as search or optimization over latent possibilities, not as single-pass token continuation, which clarifies why he is more open to constrained formal reasoning than to unguided world action.
...
- [inference; source: https://www.youtube.com/watch?v=ZbrfvMLZZK4; https://pioneerworks.org/broadcast/video/ai-yann-lecun-adam-brown; https://podcasts.apple.com/us/podcast/why-cant-ai-make-its-own-discoveries-with-yann-lecun/id1522960417?i=1000699824574] Across the accessible 2025 to 2026 record, LeCun's stance appears consistent and rhetorically sharper, but the exact positive boundary around "formal systems with external verifiers" remains only partially recoverable here because the needed transcripts were not fully accessible in this runtime.

**Key findings:**

1. [fact; source: https://openreview.net/pdf?id=BZ5a1r-kVsf] **High confidence:** In the 2022 paper, LeCun argues that common sense, planning, and safe action all depend on learning predictive world models that encode what states of the world are likely, plausible, or impossible and that let an agent evaluate imagined action sequences before acting.
2. [fact; source: https://openreview.net/pdf?id=BZ5a1r-kVsf] **High confidence:** LeCun gives two explicit technical reasons that scaling token-based generative models is insufficient, namely that they are ill-suited to representing uncertainty in continuous high-dimensional domains and that their lack of abstract latent variables limits multi-interpretation reasoning and goal-directed search.
3. [fact; source: https://openreview.net/pdf?id=BZ5a1r-kVsf] **High confidence:** The paper does not claim that LLMs know nothing; instead, it says they extract substantial background knowledge from text while still exhibiting shallow common sense because text alone omits much of the physical and causal structure humans learn through worldly interaction.
4. [fact; source: https://www.brown.edu/news/2026-04-01/yann-lecun-artificial-intelligence-pioneer] **High confidence:** By the Brown lecture, LeCun is publicly applying the same mechanism to agentic systems, arguing that systems which can produce actions in the world but cannot predict the outcomes of those actions are dangerous foundations for autonomous behaviour.
5. [fact; source: https://www.youtube.com/watch?v=ZbrfvMLZZK4; https://openreview.net/pdf?id=BZ5a1r-kVsf] **Medium confidence:** The accessible Brown lecture material suggests that LeCun treats constrained reasoning tasks such as theorem proving as search-and-optimization problems that fit a System 2 style architecture better than one-pass token generation, which implies a narrower positive boundary than the broad negative boundary he draws around real-world action.
...
|---|---|---|---|
| [fact] Autonomous intelligence requires predictive world models for plausible-state judgement, consequence prediction, and planning. | https://openreview.net/pdf?id=BZ5a1r-kVsf | high | Core mechanism stated directly in the paper. |
| [fact] Scaling LLM-style models is insufficient because tokenized generative training handles continuous uncertainty poorly and lacks latent-variable reasoning machinery. | https://openreview.net/pdf?id=BZ5a1r-kVsf | high | Section 8.3.1 provides the two explicit reasons. |
| [fact] LLMs extract background knowledge from text but exhibit shallow common sense because they lack direct experience with underlying reality. | https://openreview.net/pdf?id=BZ5a1r-kVsf | high | Directly stated in the paper. |
| [fact] Agentic systems that cannot predict action outcomes are dangerous. | https://www.brown.edu/news/2026-04-01/yann-lecun-artificial-intelligence-pioneer | high | Direct Brown quotation. |
| [fact] The Brown lecture material places theorem proving on the optimization-heavy System 2 side of the reasoning boundary. | https://www.youtube.com/watch?v=ZbrfvMLZZK4 ; https://livestream.brown.edu/lemley | medium | Supported by transcript-like extraction from the official lecture video checked in this session. |
...
- [assumption; source: https://www.youtube.com/watch?v=ZbrfvMLZZK4; https://openreview.net/pdf?id=BZ5a1r-kVsf] **Assumption:** The theorem-proving example is a signal of a broader positive boundary around constrained, optimizable, or verifiable reasoning tasks. **Justification:** the Brown lecture supports the narrower claim directly, but the broader external-verifier framing remains inferential.
...
- [inference; source: https://www.youtube.com/watch?v=ZbrfvMLZZK4; https://www.youtube.com/watch?v=ykfQD1_WPBQ] The positive boundary around formal or externally verifiable tasks remains medium-to-low confidence because the best direct support in this runtime is the Brown theorem-proving example rather than an explicit transcript passage drawing the full boundary.

**Open questions:**

- [inference; source: https://www.youtube.com/watch?v=8sS9UJzb_t4; https://www.youtube.com/watch?v=ykfQD1_WPBQ] Do the inaccessible 2025 transcripts contain a more explicit statement that LLMs are acceptable in code, theorem-proving, or other externally checkable domains while remaining unfit for consequential world action?
- [inference; source: https://openreview.net/pdf?id=BZ5a1r-kVsf; https://www.youtube.com/watch?v=ZbrfvMLZZK4] How far does LeCun think optimization-based System 2 reasoning can go without a richer world model when the task is symbolic rather than physical?
