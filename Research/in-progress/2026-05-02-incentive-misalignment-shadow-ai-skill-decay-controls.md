...
- **A. Failure mode taxonomy and interaction**
  ...
  - [fact; source: https://www.ibm.com/think/insights/rising-ai-adoption-creating-shadow-risks; https://www.cyberhaven.com/blog/shadow-ai-how-employees-are-leading-the-charge-in-ai-adoption-and-putting-company-data-at-risk] Shadow AI is the use of AI tools outside sanctioned enterprise channels, often through personal or otherwise unmanaged accounts, which separates actual use from enterprise security, audit, and policy controls.
...
- **B. Evidence on causes and prevalence**
  ...
  - [fact; source: https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://sloanreview.mit.edu/article/agentic-ai-at-scale-redefining-management-for-a-superhuman-workforce/] DORA and MIT Sloan both argue that AI amplifies existing organisational weaknesses, and MIT Sloan adds that human-era management models break when autonomous systems operate with superhuman speed and scale unless explicit rules, thresholds, tracing, and intervention paths are defined.
...
2. **Shadow AI is now a concrete enterprise control problem rather than a speculative edge case, because public survey and telemetry evidence shows widespread use of non-corporate AI accounts and material flows of sensitive company data into those tools.** ([fact]; high confidence; source: https://www.ibm.com/think/insights/rising-ai-adoption-creating-shadow-risks; https://www.ibm.com/reports/data-breach; https://www.cyberhaven.com/blog/shadow-ai-how-employees-are-leading-the-charge-in-ai-adoption-and-putting-company-data-at-risk)
3. **Rail bypass cannot be mitigated by policy text or prompt wording alone, because prompt injection and related attack paths can still induce data exfiltration, unintended actions, or persistent memory poisoning unless tool access, content boundaries, and exfiltration paths are constrained.** ([fact]; high confidence; source: https://genai.owasp.org/llmrisk/llm01-prompt-injection/; https://www.microsoft.com/en-us/msrc/blog/2025/07/how-microsoft-defends-against-indirect-prompt-injection-attacks; https://unit42.paloaltonetworks.com/indirect-prompt-injection-poisons-ai-longterm-memory/; https://davidamitchell.github.io/Research/research/2026-04-26-implicit-rate-limiting-controls-agentic-ai-removal.html)
...
6. **The most effective deterrent is a governed fast lane, not a blanket prohibition, because approved tools, preconfigured low-risk patterns, and clear exception ownership reduce the payoff from moving into unofficial channels.** ([inference]; medium confidence; source: https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://www.ibm.com/think/insights/rising-ai-adoption-creating-shadow-risks; https://learn.microsoft.com/en-us/microsoft-copilot-studio/admin-data-loss-prevention)
...
| [fact] Shadow AI is widespread and carries sensitive enterprise data into unmanaged tools and accounts. | https://www.ibm.com/think/insights/rising-ai-adoption-creating-shadow-risks; https://www.ibm.com/reports/data-breach; https://www.cyberhaven.com/blog/shadow-ai-how-employees-are-leading-the-charge-in-ai-adoption-and-putting-company-data-at-risk | high | survey plus telemetry |
| [fact] Prompt injection and related bypass paths can trigger disclosure, unsafe tool use, and persistent manipulation. | https://genai.owasp.org/llmrisk/llm01-prompt-injection/; https://www.microsoft.com/en-us/msrc/blog/2025/07/how-microsoft-defends-against-indirect-prompt-injection-attacks; https://unit42.paloaltonetworks.com/indirect-prompt-injection-poisons-ai-longterm-memory/; https://davidamitchell.github.io/Research/research/2026-04-26-implicit-rate-limiting-controls-agentic-ai-removal.html | high | runtime safety |
...
| [inference] Governed fast lanes deter bypass better than bans alone. | https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://www.ibm.com/think/insights/rising-ai-adoption-creating-shadow-risks; https://learn.microsoft.com/en-us/microsoft-copilot-studio/admin-data-loss-prevention | medium | enablement plus controls |
...
The strongest evidence in this item concerns shadow-AI prevalence and rail-bypass reality, because both areas have current public measurements or official guidance that directly describe the failure surface. [fact; source: https://www.ibm.com/reports/data-breach; https://www.cyberhaven.com/blog/shadow-ai-how-employees-are-leading-the-charge-in-ai-adoption-and-putting-company-data-at-risk; https://genai.owasp.org/llmrisk/llm01-prompt-injection/]
