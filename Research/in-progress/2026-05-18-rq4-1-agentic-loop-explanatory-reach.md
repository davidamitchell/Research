...
- [inference] The right classification is therefore layered: local loop performance can improve materially, yet the composite system can still remain mostly a Level 1 controller whose apparent higher-level competence depends on external modules and task structure. [source: https://arxiv.org/abs/2210.03629; https://arxiv.org/abs/2206.10498; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-4-causal-hierarchy-formal-limits.md]
...
- [fact] ReAct, Reflexion, and Tree of Thoughts show that loop structure can materially improve performance by adding external observations, episodic feedback, or branching search. [source: https://arxiv.org/abs/2210.03629; https://arxiv.org/abs/2303.11366; https://openreview.net/forum?id=5Xc1ecxO1h]
...
- [inference] The best-supported classification is that the composite system remains mostly a Level 1 controller whose apparent higher-level reach comes from external tools or environments that already encode the needed semantics. [source: https://arxiv.org/abs/2302.07842; https://arxiv.org/abs/2206.10498; https://opencausalab.github.io/CaLM; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-4-causal-hierarchy-formal-limits.md]
...
4. [fact] Branching search methods such as Tree of Thoughts outperform one linear chain on planning-heavy tasks, which is direct evidence that naive sequential looping is not enough for robust search under novelty. [source: https://openreview.net/forum?id=5Xc1ecxO1h]
5. [fact] Planning and causal benchmarks still show major weakness on structurally demanding tasks, including plan generation and higher-complexity causal reasoning, even after agentic wrapping or prompting adaptation. [source: https://arxiv.org/abs/2206.10498; https://opencausalab.github.io/CaLM; https://aclanthology.org/2024.sighan-1.17/]
...
7. [inference] The composite system can answer some intervention-like or counterfactual-like questions only when an external tool, simulator, or environment already embodies those semantics, so the extra reach is imported and distributed rather than intrinsic to the language model. [source: https://arxiv.org/abs/2302.07842; https://arxiv.org/abs/2210.03629; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-4-causal-hierarchy-formal-limits.md]
...
- [fact] Branching search materially outperforms one-path chains on planning-heavy tasks. | source: https://openreview.net/forum?id=5Xc1ecxO1h | confidence: high | notes: reported Game of 24 result
- [fact] Planning and causal benchmarks still report major weakness on higher-complexity tasks. | source: https://arxiv.org/abs/2206.10498 ; https://opencausalab.github.io/CaLM ; https://aclanthology.org/2024.sighan-1.17/ | confidence: high | notes: planning plus causal complexity
...
- [inference] Apparent higher-level reach is imported from external tools or environments. | source: https://arxiv.org/abs/2302.07842 ; https://arxiv.org/abs/2210.03629 ; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-4-causal-hierarchy-formal-limits.md | confidence: medium | notes: semantics live in the wider stack
...
- Review result: pass
- Acronym audit: Large Language Model (LLM), chain-of-thought (CoT), Application Programming Interface (API), and Causal Evaluation of Language Models (CaLM) expanded on first use
- Claim audit: all visible claims in Research Skill Output labeled as fact, inference, or assumption
- Parity audit: Findings drafted from Section 6 only
- Citation audit: URL-backed sources only
...
ReAct, Reflexion, and Tree of Thoughts show that loop structure can materially improve outcomes when the task rewards retrieving missing information, persisting feedback, or branching away from an early bad path. [fact; source: https://arxiv.org/abs/2210.03629; https://arxiv.org/abs/2303.11366; https://openreview.net/forum?id=5Xc1ecxO1h]
...
The best-supported classification is that the composite system remains mostly a Level 1 controller whose occasional higher-level reach is imported from external tools or environments that already encode the needed semantics. [inference; source: https://arxiv.org/abs/2302.07842; https://arxiv.org/abs/2210.03629; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-4-causal-hierarchy-formal-limits.md]
...
4. **Branching search methods such as Tree of Thoughts outperform one linear chain on planning-heavy tasks, which is direct evidence that naive sequential looping is not enough for robust search under novelty.** ([fact]; high confidence; source: https://openreview.net/forum?id=5Xc1ecxO1h)
5. **Planning and causal benchmarks still show major weakness on structurally demanding tasks, including plan generation and higher-complexity causal reasoning, even after agentic wrapping or prompting adaptation.** ([fact]; high confidence; source: https://arxiv.org/abs/2206.10498; https://opencausalab.github.io/CaLM; https://aclanthology.org/2024.sighan-1.17/)
...
7. **The composite system can answer some intervention-like or counterfactual-like questions only when an external tool, simulator, or environment already embodies those semantics, so the extra reach is imported and distributed rather than intrinsic to the language model.** ([inference]; medium confidence; source: https://arxiv.org/abs/2302.07842; https://arxiv.org/abs/2210.03629; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-4-causal-hierarchy-formal-limits.md)
...
| [fact] Branching search materially outperforms one-path chains on planning-heavy tasks. | https://openreview.net/forum?id=5Xc1ecxO1h | high | reported Game of 24 result |
| [fact] Planning and causal benchmarks still report major weakness on higher-complexity tasks. | https://arxiv.org/abs/2206.10498 ; https://opencausalab.github.io/CaLM ; https://aclanthology.org/2024.sighan-1.17/ | high | planning plus causal complexity |
...
| [inference] Apparent higher-level reach is imported from external tools or environments. | https://arxiv.org/abs/2302.07842 ; https://arxiv.org/abs/2210.03629 ; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-4-causal-hierarchy-formal-limits.md | medium | semantics live in the wider stack |
