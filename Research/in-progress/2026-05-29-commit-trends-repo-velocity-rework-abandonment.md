...
claim_audit: all factual and inferential claims carry labels; all [assumption] entries carry URL-backed justifications; §2 D2 gitnux claim downgraded to [inference]; §2 G3 VentureBeat claim downgraded to [inference]
evidence_map_check: all Key Findings have rows in Evidence Map; KF2/KF5/KF11 confidence updated to medium
inline_citation_check: all claims in §2 carry suffix source bindings; Exec Summary governance-tension inference split from [fact]
