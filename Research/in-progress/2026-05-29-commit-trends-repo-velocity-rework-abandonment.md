...
[fact] Approximately 40% of GitHub repositories have only the repository owner as a contributor, making them single-maintainer projects with elevated abandonment risk. Source: https://gitnux.org/git-repository-statistics/
...
F1. [fact] "Useless tests" (tests that pass without validating intended behaviour) are operationalised via mutation testing: a test suite with low mutation score has tests that do not catch injected faults. Line coverage is the commonly reported metric but does not measure test effectiveness. Source: https://tianpan.co/blog/2026-05-04-ai-generated-tests-coverage-illusion
...
G2. [fact] The Standish Group CHAOS 2020 report, a longitudinal study of software project outcomes, found approximately 31% of projects were completed successfully (on time, on budget, with required features), approximately 50% were "challenged" (late, over budget, or missing features), and approximately 19% were cancelled before delivery. These rates have remained broadly stable across the 2020-2023 window in available secondary summaries. Source: https://thestory.is/en/journal/chaos-report/

G3. [fact] A 2019 VentureBeat analysis (republished and cited in 2024 industry commentary) estimated that 87-90% of machine learning (ML) models never reach production, with deployment barriers rather than development failures as the primary cause. Source: https://teaminnovatics.com/blogs/machine-learning-deployment-why-fail/

[fact] An IDC/Lenovo 2025 report found that for every 33 AI proof-of-concept (POC) projects, only four were deployed to production, implying an approximately 88% non-deployment rate for AI POCs. Source: https://www.cio.com/article/3850763/88-of-ai-pilots-fail-to-reach-production-but-thats-not-all-on-it.html
...
**Regulatory/governance lens:** [inference] The DORA 2024 finding that AI adoption reduces delivery stability by 7.2% per 25% adoption increase creates a governance tension: organisations mandating AI tool adoption for productivity gains may inadvertently degrade the delivery reliability metrics that underpin SLA commitments and regulatory audit trails. Prior repository work in 2026-05-08-productivity-incentive-metrics-quality-review-agentic-ai addresses this tension in detail. Source: https://dora.dev/research/2024/dora-report/

### §6 Synthesis

**Summary:** Across all seven metric areas, the 2019-2026 window shows a consistent directional pattern: raw volume indicators (repository creation, commit count, LOC generated) rose sharply while quality-composition indicators (rework share, duplication, delivery stability) degraded, and project-to-production conversion rates remained low or worsened for AI/ML workloads. The inflection point for quality composition metrics aligns with AI coding assistant adoption beginning in 2022-2023, though causal attribution requires care because developer community growth also accelerated in the same period.
...
| AI/ML POC non-deployment | N/A pre-AI era | 87-90% (2024-2025) | High and stable | [fact] medium |
| General project cancellation | ~19% (Standish 2020) | ~19-31% (stable) | Stable | [fact] medium |
...
```text
review_result: pass
acronym_audit: passed; LOC expanded on first use in Research Question; AI expanded on first use in Research Question; DORA expanded in Sources and §0; PR expanded in §1; LLM/SDK/YoY/DRY/ML/POC all expanded on first use in prose
claim_audit: all factual and inferential claims carry labels; all [assumption] entries carry URL-backed justifications
evidence_map_check: all Key Findings have rows in Evidence Map
inline_citation_check: all claims in §2 carry suffix source bindings
...
2. **Annual commit volume on GitHub reached nearly 1 billion in 2024, a 25% year-over-year increase, with a record of nearly 100 million commits in a single month.** ([fact]; high confidence; source: https://github.blog/news-insights/octoverse/octoverse-a-new-developer-joins-github-every-second-as-ai-leads-typescript-to-1/)
...
5. **The DORA 2024 report found that every 25% increase in AI adoption on a software team is associated with a 7.2% decrease in delivery stability and a 1.5% decrease in delivery throughput, despite a 2.1% individual productivity increase.** ([fact]; high confidence; source: https://dora.dev/research/2024/dora-report/)
...
8. **The Standish Group CHAOS 2020 report found software project cancellation rates stable at approximately 19%, with 50% of projects challenged and 31% successful, a distribution that has not materially changed in the years following based on available secondary summaries.** ([fact]; medium confidence; source: https://thestory.is/en/journal/chaos-report/)

9. **AI and ML projects face a structurally higher non-deployment rate of 87-90%, with IDC/Lenovo finding that of every 33 AI proof-of-concept projects only four reached production, reflecting an operationalisation gap that is distinct from project cancellation.** ([fact]; medium confidence; source: https://www.cio.com/article/3850763/88-of-ai-pilots-fail-to-reach-production-but-thats-not-all-on-it.html; https://teaminnovatics.com/blogs/machine-learning-deployment-why-fail/)
...
11. **Baltes et al. (2026) characterise AI slop in software development as a tragedy of the commons: individual productivity gains from AI-generated code externalise review and maintenance costs onto the broader team, with Quality Degradation, Review Friction, and Forces and Consequences as the three empirically identified impact clusters.** ([fact]; high confidence; source: https://arxiv.org/abs/2603.27249)
...
| [fact] Commit volume near 1 billion in 2024, +25% YoY | https://github.blog/news-insights/octoverse/octoverse-a-new-developer-joins-github-every-second-as-ai-leads-typescript-to-1/ | High | Primary industry report |
...
| [fact] DORA 2024: AI adoption correlates with 7.2% stability drop per 25% adoption increase | https://dora.dev/research/2024/dora-report/ | High | Primary Google/DORA research; self-reported survey data with large N |
...
| [fact] Standish CHAOS 2020: 19% cancelled, 50% challenged, 31% successful | https://thestory.is/en/journal/chaos-report/ | Medium | Standish report is behind a paywall; figure from secondary summary; consistent across multiple references |
| [fact] AI/ML POC non-deployment: 87-90%; IDC: 4 of 33 POCs reach production | https://www.cio.com/article/3850763/88-of-ai-pilots-fail-to-reach-production-but-thats-not-all-on-it.html; https://teaminnovatics.com/blogs/machine-learning-deployment-why-fail/ | Medium | IDC is primary; VentureBeat 2019 figure widely cited but pre-dates current AI era |
...
| [fact] Baltes et al. 2026: AI slop as tragedy of commons with three impact clusters | https://arxiv.org/abs/2603.27249 | High | Peer-reviewed arXiv preprint; qualitative methodology on 1,154 posts |
...
The second group (rework, refactor share, AI slop indicators, delivery stability) shows degradation in the 2020-2024 period. The GitClear and DORA data converge in direction: AI coding assistant adoption appears to accelerate code production at the cost of code composition quality. The competing interpretation is that the GitClear dataset is enterprise-skewed and the DORA signal represents teams that have not yet adapted review processes to AI-generated volume. Both interpretations are consistent with available evidence. [inference; source: https://www.gitclear.com/ai_assistant_code_quality_2025_research; https://dora.dev/research/2024/dora-report/]

Project non-delivery (abandonment, cancellation, non-deployment) has two distinct regimes. General software cancellation rates (Standish CHAOS at approximately 19%) have been stable for decades, implying a structural organisational constraint rather than a technology-driven trend. AI/ML non-deployment rates (87-90%) reflect an additional barrier: the gap between building an AI model or POC and operating it reliably as a production service. [fact; source: https://thestory.is/en/journal/chaos-report/; https://www.cio.com/article/3850763/88-of-ai-pilots-fail-to-reach-production-but-thats-not-all-on-it.html]
