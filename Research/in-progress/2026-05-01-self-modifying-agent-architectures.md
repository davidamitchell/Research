...
6. [inference] For practical coding agents, the safest design pattern is a small stable kernel plus explicit extension points, external permissions, and inspectable mutation boundaries, rather than unconstrained in-session self-rewrite that relies on the agent to police itself. Confidence: high. Source: https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/extensions.md; https://docs.anthropic.com/en/docs/claude-code/hooks; https://opencode.ai/docs/config; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-26-access-control-amplification-agentic-operations.md; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-01-extension-systems-ai-coding-agents.md
...
8. [inference] Self-modifying harnesses are therefore most justified as expert-mode infrastructure for local customization, research, and rapid harness experimentation, while team-default deployments should favor bounded extensibility with human and policy control. Confidence: medium. Source: https://mariozechner.at/posts/2025-11-30-pi-coding-agent/; https://www.anthropic.com/engineering/claude-code-best-practices; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-01-sustainable-ai-software-development-synthesis.md
...
| [inference] Practical safety favors a stable kernel plus external permissions and visible mutation boundaries. | https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/extensions.md; https://docs.anthropic.com/en/docs/claude-code/hooks; https://opencode.ai/docs/config; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-26-access-control-amplification-agentic-operations.md; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-01-extension-systems-ai-coding-agents.md | high | control-surface synthesis |
...
| [inference] Self-modifying harnesses fit expert-mode use better than default team-wide deployment. | https://mariozechner.at/posts/2025-11-30-pi-coding-agent/; https://www.anthropic.com/engineering/claude-code-best-practices; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-01-sustainable-ai-software-development-synthesis.md | medium | deployment recommendation |

**Assumptions:**

- [assumption] The retrieved public manuals describe the dominant control surfaces accurately enough to compare architecture classes, even though unpublished internal implementation details or incidents may exist. Justification: the question is about design tradeoffs, and those are exposed most clearly in the documented runtime surfaces.
- [assumption] The absence of a documented live in-session extension API in the retrieved aider pages is enough to classify aider as the most bounded harness in this comparison, even though other pages not retrieved could expose additional customization features. Justification: the retrieved official docs emphasize explicit user-level context and command control rather than harness mutation.

**Analysis:**

The practical distinction is not whether a harness can ever be extended, because every inspected system has some customization path, but whether new capability can be authored and activated inside the running session by the agent itself. [inference; source: https://aider.chat/docs/usage/commands.html; https://docs.anthropic.com/en/docs/claude-code/plugins; https://opencode.ai/docs/plugins; https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/extensions.md]
...
Pi documents the strongest live mutation model in the retrieved set, while aider is the most bounded and user-steered, and Claude Code plus OpenCode occupy a plugin and hook middle layer. [fact; source: https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/extensions.md; https://aider.chat/docs/usage/commands.html; https://docs.anthropic.com/en/docs/claude-code/plugins; https://opencode.ai/docs/plugins]
...
2. **Pi's self-modifying architecture is operationally real, because its public documentation shows that the agent can write and hot-reload TypeScript extensions that register tools, commands, providers, state, and compaction behavior inside the active runtime.** ([fact]; high confidence; source: https://github.com/The-Focus-AI/youtube-feed/blob/main/ai-engineer/videos/RjfbvDXpFls.json; https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/extensions.md; https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/compaction.md; https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/custom-provider.md)
...
6. **For practical coding agents, the safest design pattern is a small stable kernel plus explicit extension points, external permissions, and inspectable mutation boundaries, rather than unconstrained in-session self-rewrite that relies on the agent to police itself.** ([inference]; high confidence; source: https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/extensions.md; https://docs.anthropic.com/en/docs/claude-code/hooks; https://opencode.ai/docs/config; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-26-access-control-amplification-agentic-operations.md; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-01-extension-systems-ai-coding-agents.md)
...
8. **Self-modifying harnesses are therefore most justified as expert-mode infrastructure for local customization, research, and rapid harness experimentation, while team-default deployments should favor bounded extensibility with human and policy control.** ([inference]; medium confidence; source: https://mariozechner.at/posts/2025-11-30-pi-coding-agent/; https://www.anthropic.com/engineering/claude-code-best-practices; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-01-sustainable-ai-software-development-synthesis.md)
