...
9. [inference] **Academic programmes** confirm the formal methods + LLM intersection as an active research frontier: the 2025 FormaliSE workshop and FM 2026 conference both feature work on using formal methods to constrain LLM outputs and using LLMs to generate formal specifications.
