...
| [fact] Typed schema is the authoritative interchange contract. | https://json-schema.org/overview/what-is-jsonschema; https://developers.openai.com/api/docs/guides/structured-outputs | High | External validators and structured outputs make malformed boundary states detectable. |
