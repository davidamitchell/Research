...
- [ ] **Williamson, O.E. (1985).** *The Economic Institutions of Capitalism.* Free Press. — definitive book-length TCE treatment; asset specificity and governance choice elaborated
...
**[fact]** Douglass North (Nobel, 1993) defines institutions as "the rules of the game in a society — the humanly devised constraints that shape human interaction." Institutions reduce transaction costs by making expectations predictable. *Source: Wikipedia, "Douglass North," https://en.wikipedia.org/wiki/Douglass_North (tertiary, for context); `2026-03-02-transaction-costs.md` KF3.*

**[fact]** North distinguishes formal institutions (constitutions, property law, regulations) from informal institutions (norms, conventions, culture, religion). Informal institutions do the same transaction-cost-reduction work at lower codification cost but are harder to change deliberately. *Source: `2026-03-02-transaction-costs.md` KF3; Wikipedia, "Douglass North," https://en.wikipedia.org/wiki/Douglass_North (tertiary, for context).*

**[fact]** North's four factors comprising transaction costs: measurement (calculating value of goods/services), enforcement (ensuring neither party reneges), ideological attitudes and perceptions (each party's value set shaping interpretation), and market size (affecting partiality or impartiality). *Source: North (1990), Institutions, Institutional Change and Economic Performance, Cambridge University Press; Wikipedia, "Transaction cost," https://en.wikipedia.org/wiki/Transaction_cost (tertiary, for context).*

**[fact]** North's key contribution to economic history: institutional quality (not physical resource endowment) is the primary determinant of economic development outcomes. High-transaction-cost environments (weak property rights, unpredictable enforcement) produce poor outcomes regardless of physical resources. *Source: North (1990), Institutions, Institutional Change and Economic Performance, Cambridge University Press; `2026-03-02-transaction-costs.md` KF3; Wikipedia, "Douglass North," https://en.wikipedia.org/wiki/Douglass_North (tertiary, for context).*
...
**[fact]** Coase's boundary condition is the efficiency fitness function: a firm is fit (and should continue to exist in its current form) if and only if internal coordination cost < market contracting cost for its core activities. *Source: Coase (1937), "The Nature of the Firm," Economica 4(16): 386–405; `2026-03-02-transaction-costs.md` KF1.*
...
| Williamson's three transaction dimensions: asset specificity, uncertainty, frequency | Williamson (1985) via `2026-03-02-transaction-costs.md` KF2; Wikipedia "Oliver E. Williamson," https://en.wikipedia.org/wiki/Oliver_E._Williamson | High | Core TCE framework; Nobel-validated |
...
| Informal institutions reduce transaction costs more cheaply than formal contracts | North (1990) via `2026-03-02-transaction-costs.md` KF3; Wikipedia "Douglass North," https://en.wikipedia.org/wiki/Douglass_North | High | Nobel-validated; path dependence is more contested |
...
| API boundaries reduce all three Dahlman cost categories | Derived from Dahlman's taxonomy (Wikipedia "Transaction cost," https://en.wikipedia.org/wiki/Transaction_cost) applied to APIs | Medium | Cross-domain inference; no direct empirical study cited |
...
| Williamson's three transaction dimensions: asset specificity, uncertainty, frequency | Williamson (1985) via `2026-03-02-transaction-costs.md` KF2; Wikipedia "Oliver E. Williamson," https://en.wikipedia.org/wiki/Oliver_E._Williamson | High | Core TCE framework; Nobel (2009) validated |
...
| Informal institutions reduce transaction costs more cheaply than formal contracts | North (1990) via `2026-03-02-transaction-costs.md` KF3; Wikipedia "Douglass North," https://en.wikipedia.org/wiki/Douglass_North | High | Nobel (1993) validated; path dependence claim is more contested |
...
| API boundaries reduce all three Dahlman cost categories simultaneously | Derived from Dahlman's taxonomy (Wikipedia "Transaction cost," https://en.wikipedia.org/wiki/Transaction_cost) applied to API design | Medium | Cross-domain inference; no direct empirical study cited |
...
[inference] The Coase → Williamson → North lineage produces testable governance predictions. Williamson's TCE framework was explicitly designed to yield falsifiable hypotheses about make-vs-buy choices across transaction dimensions — a scientific status claim supported by empirical validation across manufacturing, franchise, and service industries over four decades.

[inference] TCE and RBV do not compete for the same explanatory territory. A software capability cheap to contract out under current TCE analysis — low asset specificity, available as a commodity service — can still warrant internalisation if developing it internally builds a VRIN resource that is hard to replicate once commoditised. Defaulting to TCE efficiency signals alone in that case produces the wrong boundary choice.
