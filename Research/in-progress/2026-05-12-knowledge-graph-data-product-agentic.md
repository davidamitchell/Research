...
- Question: determine what it means to operate a Knowledge Graph as a domain-owned data product inside a data mesh, and define the ownership, contract, discoverability, interoperability, and runtime-governance implications when software agents depend on it.
