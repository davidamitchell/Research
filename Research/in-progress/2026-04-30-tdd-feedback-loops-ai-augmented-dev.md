...
- [fact; source: https://github.com/mattpocock/skills; https://github.com/mattpocock/skills/blob/main/skills/engineering/tdd/SKILL.md] Matt Pocock's public TDD skill requires a failing test before implementation, one test at a time, minimal code to pass, and refactoring only after green, and it explicitly warns that writing all tests first and then all code causes teams to outrun their headlights.
...
- [fact; source: https://dblp.org/rec/conf/icse/Imai22; https://arxiv.org/abs/2208.04416] A source-correction check showed that the seeded arXiv identifier 2208.04416 points to an unrelated route-planning paper, while the intended Imai study is the Association for Computing Machinery (ACM) ICSE Companion paper at DOI 10.1145/3510454.3522684.

#### Feedback loops and model self-correction

- [fact; source: https://arxiv.org/abs/2303.11366] Reflexion reports that external feedback plus reflective memory raised pass@1 on HumanEval from 80% for the cited GPT-4 baseline to 91%, which is direct evidence that feedback-rich loops improve code generation over one-shot attempts.
...
Enforcing a failing-test-first loop with fast external feedback changes AI coding from a bulk-generation problem into a bounded search problem, and the available evidence supports better stability and easier self-correction than "write large chunks then test" workflows. [inference; source: https://github.com/mattpocock/skills/blob/main/skills/engineering/tdd/SKILL.md; https://arxiv.org/abs/2303.11366; https://arxiv.org/abs/2304.05128; https://par.nsf.gov/biblio/10366304-expectation-vs-experience-evaluating-usability-code-generation-tools-powered-large-language-models]
...
The best-supported minimum viable feedback loop is small vertical slices with executable tests and fast static or runtime feedback, while browser tools are best treated as a plausible front-end extension rather than a settled empirical result. [inference; source: https://github.com/mattpocock/skills/blob/main/skills/engineering/tdd/SKILL.md; https://www.jamesshore.com/v2/books/aoad2/development; https://link.springer.com/article/10.1007/s10664-013-9289-1; https://arxiv.org/abs/2304.05128]

**Key findings:**

1. **Matt Pocock's TDD skill and James Shore's TDD guidance both require a failing test before implementation, one vertical slice at a time, and explicitly reject bulk test-writing because it causes developers and agents to outrun their verification horizon.** ([fact]; medium confidence; source: https://github.com/mattpocock/skills/blob/main/skills/engineering/tdd/SKILL.md; https://www.jamesshore.com/v2/books/aoad2/development)
2. **Controlled Copilot studies show that Artificial Intelligence (AI) coding tools can deliver real speed and local quality gains, but those gains are still measured through external tests and review rubrics rather than through delayed verification as a proven safe default workflow.** ([fact]; high confidence; source: https://arxiv.org/abs/2302.06590; https://github.blog/news-insights/research/does-github-copilot-improve-code-quality-heres-what-the-data-says/; https://arxiv.org/abs/2206.15331)
...
4. **Execution-feedback papers such as Reflexion and Self-Debugging show that explicit test or runtime signals materially improve model self-correction over one-shot generation, which is the clearest empirical support for the feedback-loop mechanism TDD exploits.** ([fact]; high confidence; source: https://arxiv.org/abs/2303.11366; https://arxiv.org/abs/2304.05128; https://arxiv.org/abs/2303.17651)
5. **Static typing provides early maintainability and error-localization benefits, but it mainly catches interface and type mistakes and does not remove the need for executable tests that catch semantic errors after code compiles.** ([fact]; medium confidence; source: https://link.springer.com/article/10.1007/s10664-013-9289-1)
...
|---|---|---|---|
| [fact] TDD guidance for AI coding centers on failing tests first and vertical slices. | https://github.com/mattpocock/skills/blob/main/skills/engineering/tdd/SKILL.md ; https://www.jamesshore.com/v2/books/aoad2/development | medium | Direct practitioner and agile sources |
| [fact] AI coding tools can improve bounded-task speed and local quality under external evaluation. | https://arxiv.org/abs/2302.06590 ; https://github.blog/news-insights/research/does-github-copilot-improve-code-quality-heres-what-the-data-says/ ; https://arxiv.org/abs/2206.15331 | high | Strong local-task evidence |
...
- [fact; source: https://arxiv.org/abs/2302.06590; https://par.nsf.gov/biblio/10366304-expectation-vs-experience-evaluating-usability-code-generation-tools-powered-large-language-models; https://arxiv.org/abs/2206.15331] No accessible randomized field study in this session directly compared a failing-test-first AI workflow with a "write large chunks then test" workflow across maintained projects.
- [fact; source: https://github.com/mattpocock/skills; https://www.aihero.dev/] The Matt Pocock evidence is first-party practitioner guidance, so it is useful for mechanics and rationale but weaker than an independent controlled trial for measured payback.
