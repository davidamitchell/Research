...
1. **Matt Pocock's TDD skill and James Shore's TDD guidance both require a failing test before implementation, one small end-to-end increment, sometimes called a vertical slice, at a time, and explicitly reject bulk test-writing because it causes developers and agents to outrun their verification horizon.** ([fact]; medium confidence; source: https://github.com/mattpocock/skills/blob/main/skills/engineering/tdd/SKILL.md; https://www.jamesshore.com/v2/books/aoad2/development)
