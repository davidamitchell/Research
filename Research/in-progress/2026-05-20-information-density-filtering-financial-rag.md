...
- [x] [Leskovec et al. (2020) Mining of Massive Datasets, Chapter 3: Finding Similar Items](http://infolab.stanford.edu/~ullman/mmds/ch3n.pdf) - canonical definitions of MinHash, Jaccard similarity, and Locality Sensitive Hashing.
- [x] [Federal Reserve Board (2011) Supervisory Guidance on Model Risk Management, Supervisory Letter (SR) 11-7 attachment](https://www.federalreserve.gov/boarddocs/srletters/2011/sr1107a1.pdf) - validation, documentation, change control, and data-quality expectations for model inputs.
...
- [x] [Mitchell (2026) Context Compression and RAG Techniques for Organisational Knowledge](https://davidamitchell.github.io/Research/research/2026-03-15-context-compression-rag-enterprise-knowledge.html) - prior completed item on selective context surfacing and compression choices.
...
- [Mitchell (2026) Context Compression and RAG Techniques for Organisational Knowledge](https://davidamitchell.github.io/Research/research/2026-03-15-context-compression-rag-enterprise-knowledge.html)
...
- [fact; source: https://www.federalreserve.gov/boarddocs/srletters/2011/sr1107a1.pdf; https://www.bis.org/publ/bcbs239.pdf] The Federal Reserve Board Supervisory Letter (SR) 11-7 attachment and Basel Committee on Banking Supervision (BCBS) 239 are primary regulatory sources for data quality, validation, documentation, automation, and audit-control expectations.
...
- [fact; source: https://docs.nvidia.com/nemo-framework/user-guide/24.07/datacuration/gpudeduplication.html; http://infolab.stanford.edu/~ullman/mmds/ch3n.pdf] NVIDIA NeMo deduplication guidance is primary product documentation with procedural detail, including unique document identifiers, exact-hash removal, MinHash candidate generation, an approximate signature method for candidate duplicates, Jaccard similarity confirmation, meaning overlap scoring between token sets, and connected-component clustering, meaning grouping matched records into duplicate families.
...
- [fact; source: https://docs.nvidia.com/nemo-framework/user-guide/24.07/datacuration/gpudeduplication.html; http://infolab.stanford.edu/~ullman/mmds/ch3n.pdf] NVIDIA NeMo fuzzy deduplication uses MinHash signatures, a compact approximation of set similarity, and Locality Sensitive Hashing (LSH), a bucket-based method for approximate nearest-neighbor search, to generate candidate duplicate buckets, then computes Jaccard similarity, the overlap ratio between token sets, and connected components to identify near-duplicate groups.
