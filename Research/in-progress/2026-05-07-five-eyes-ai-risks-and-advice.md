...
- Common risk categories, for example model misuse, prompt injection, meaning malicious instructions hidden in model inputs, supply-chain risk, data protection, and critical infrastructure impact
...
- [fact] It also recommends well-designed architecture and hardened configurations, including boundary protections, zero-trust architecture, meaning architecture that assumes breach and requires explicit verification of access, hardened containers or virtual machines, network monitoring, allow-list firewalls, encryption at rest, and protection of model weights and keys in restricted storage or a hardware security module. [source: https://www.ncsc.govt.nz/assets/guidance/Documents/csi-deploying-ai-systems-securely.pdf]
