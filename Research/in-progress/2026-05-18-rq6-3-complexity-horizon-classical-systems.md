...
5. **Dekker's drift framework explains why this barrier feels like opacity rather than ordinary component debugging, because many locally reasonable actions can propagate through relationships and feedback loops until the eventual failure state is visible only after reconstruction.** ([inference]; medium confidence; source: https://www.routledge.com/Drift-into-Failure/Dekker/p/book/9781409422211; https://sre.google/sre-book/addressing-cascading-failures/)
...
| [inference] Drift into failure is relation-level and cumulative, not reducible to one broken component. | https://www.routledge.com/Drift-into-Failure/Dekker/p/book/9781409422211 ; https://sre.google/sre-book/addressing-cascading-failures/ | medium | relationship and feedback |
...
- The most important rival explanation is that better tooling or more staffing could fully restore transparency. [assumption; source: https://sre.google/sre-book/monitoring-distributed-systems/]
...
- [fact] The strongest direct evidence for operator cognition limits comes from Google's Site Reliability Engineering practice rather than from a dedicated benchmark that measures the precise service-count or dependency-depth threshold where mental models fail. [source: https://sre.google/sre-book/monitoring-distributed-systems/]
