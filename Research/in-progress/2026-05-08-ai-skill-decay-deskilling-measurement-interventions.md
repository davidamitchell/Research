...
1. **Sub-question 1 - Degree and mechanisms of skill decay:** What is the strongest empirical evidence for AI-induced skill decay in knowledge work and software engineering? Are there longitudinal studies, controlled experiments, or credible proxy metrics such as fallback performance, error-detection rates, or competency-audit scores?

2. **Sub-question 2 - Differential impact by seniority:** How does the "AI for speed" paradigm affect junior practitioners differently from senior ones? What do cognitive apprenticeship, the learning model in which novices observe expert reasoning, practice with scaffolding, and then assume progressively independent responsibility, and analogous automation transitions in aviation and medicine say about differential decay?

3. **Sub-question 3 - Effective interventions:** What deliberate practice protocols, periodic unaided drills, mandatory challenge thresholds, meaning workflows that require a human preliminary judgment before seeing or accepting AI advice, hybrid apprenticeship models, or skill-audit designs have been empirically tested for preserving human competence in AI-assisted environments? What is the evidence for each?

## Sources

Starting points:

- [x] [Bainbridge (1983) Ironies of Automation](https://doi.org/10.1016/0005-1098(83)90046-8) - foundational automation argument; the DOI redirected to an access-controlled ScienceDirect page in this session
- [x] [Parasuraman and Riley (1997) Humans and Automation: Use, Misuse, Disuse, Abuse](https://doi.org/10.1177/001872089703900402) - foundational misuse taxonomy; the DOI returned 403 in this session, so downstream claims rely on accessible later reviews when quoted
- [x] [Carr (2014) The Glass Cage: Automation and Us](https://www.amazon.com/Glass-Cage-Automation-Nicholas-Carr/dp/0393240762) - contextual book-length treatment; not used for core factual support
- [x] [Cabitza et al. (2017) Unintended Consequences of Machine Learning in Medicine](https://jamanetwork.com/journals/jama/fullarticle/2645749) - official article page was access-restricted in this session; downstream claims rely on accessible summaries when quoted
- [x] [Peng et al. (2023) The Impact of AI on Developer Productivity](https://arxiv.org/abs/2302.06590)
...
- [x] [Schubert et al. (2023) Strategies to reduce automation bias in AI-based personnel preselection](https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2023.1118723/full)
- [x] [Casner et al. (2014) The Retention of Manual Flying Skills in the Automated Cockpit](https://www.faasafety.gov/files/events/SO/SO15/2025/SO15138466/the_retention_of_manual_flying_skills_in_the_automated_cockpit-NASA.pdf)
...
- [x] [Zhu et al. (2026) Augmenting Clinical Decision-Making with an Interactive and Interpretable AI Copilot](https://arxiv.org/abs/2602.00726)
- [x] [Williams et al. (2026) Flight rules for clinical AI: lessons from aviation for human-AI collaboration](https://www.nature.com/articles/s41746-026-02410-1)
- [x] [Mitchell (2026) What capability and control design is needed to mitigate incentive misalignment, shadow AI, rail bypass, and skill decay at enterprise scale?](https://davidamitchell.github.io/Research/research/2026-05-02-incentive-misalignment-shadow-ai-skill-decay-controls.html)
- [x] [Mitchell (2026) What is the evidence for human oversight as an effective quality gate in AI-assisted software development?](https://davidamitchell.github.io/Research/research/2026-05-01-human-oversight-ai-software-development.html)
...
- [assumption; source: https://www.thelancet.com/journals/langas/article/PIIS2468-1253(25)00133-5/fulltext] Failed primary-source search record: query `"Budzyn endoscopist deskilling risk after exposure to artificial intelligence in colonoscopy"` identified the official Lancet Gastroenterology and Hepatology landing page, but direct full-text retrieval was blocked in this session, so the downstream claim uses an accessible Nature Digital Medicine perspective that explicitly summarizes the study.
- [assumption; source: https://doi.org/10.1177/001872089703900402] Failed primary-source search record: query `"Parasuraman Riley 1997 humans and automation use misuse disuse abuse pdf"` did not locate an accessible full text in this session, so the item keeps Parasuraman and Riley as a checked seed but anchors factual downstream claims to accessible reviews instead.
...
#### B. Direct AI-era evidence on skill decay and hindered skill formation
...
#### C. Mechanisms and first-failing capability surfaces

- [fact; source: https://pmc.ncbi.nlm.nih.gov/articles/PMC3240751/] Goddard et al.'s systematic review of automation bias across 74 studies finds that workload, task complexity, time constraint, trust, confidence, and experience all mediate over-reliance on automated support.
...
#### D. Junior versus senior differential effects
...
#### E. Productivity evidence does not resolve the competence question
...
#### G. Measurable proxies organisations can track now
...
8. **Organisations that want both speed and durable human capability should pair bounded AI acceleration with skill audits such as fallback drills, seeded-error reviews, and periodic unaided assessments, while reserving apprenticeship tasks for progressive independence rather than full delegation.** ([inference]; medium confidence; source: https://arxiv.org/html/2601.20245v1; https://www.aft.org/ae/winter1991/collins_brown_holum; https://davidamitchell.github.io/Research/research/2026-05-02-incentive-misalignment-shadow-ai-skill-decay-controls.html)

**Evidence map:**

| Claim | Source | Confidence | Notes |
|---|---|---|---|
| [inference] Heavy AI reliance can reduce later unaided competence in both software learning and clinical field performance. | https://arxiv.org/html/2601.20245v1; https://www.nature.com/articles/s41746-026-02410-1 | medium | Direct evidence exists, but still sparse. |
| [inference] Verification, debugging, anomaly detection, and fallback reasoning decay before every low-level execution skill does. | https://pmc.ncbi.nlm.nih.gov/articles/PMC3240751/; https://www.faasafety.gov/files/events/SO/SO15/2025/SO15138466/the_retention_of_manual_flying_skills_in_the_automated_cockpit-NASA.pdf; https://www.nature.com/articles/s41746-026-02410-1 | medium | Cross-domain mechanism alignment. |
| [inference] Productivity studies do not settle deskilling on their own because they measure assisted speed rather than retained unaided competence. | https://arxiv.org/abs/2302.06590; https://arxiv.org/html/2601.20245v1 | high | Inference from study scope boundaries. |
| [inference] Juniors face larger never-skilling risk because AI can replace the guided struggle needed for apprenticeship. | https://www.aft.org/ae/winter1991/collins_brown_holum; https://arxiv.org/abs/2602.00726; https://arxiv.org/html/2601.20245v1 | medium | Strong mechanism; limited long-run panel evidence. |
| [inference] Seniors retain stronger challenge capacity but can still lose fallback competence under routine automation. | https://www.faasafety.gov/files/events/SO/SO15/2025/SO15138466/the_retention_of_manual_flying_skills_in_the_automated_cockpit-NASA.pdf; https://www.nature.com/articles/s41746-026-02410-1 | medium | Analogical but specific. |
| [inference] Automation bias under workload, trust, and compressed evidence presentation is a central mechanism behind observed over-reliance. | https://pmc.ncbi.nlm.nih.gov/articles/PMC3240751/; https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2023.1118723/full | medium | Strong review plus experiment. |
| [inference] Error briefings, evidence-rich views, challenge-before-accept steps, and AI-off drills are the strongest current intervention bundle. | https://pmc.ncbi.nlm.nih.gov/articles/PMC3240751/; https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2023.1118723/full; https://www.faasafety.gov/files/events/SO/SO15/2025/SO15138466/the_retention_of_manual_flying_skills_in_the_automated_cockpit-NASA.pdf | medium | Bundle synthesized from several domains. |
| [inference] Skill audits and bounded delegation are the most defensible enterprise operating response today. | https://arxiv.org/html/2601.20245v1; https://www.aft.org/ae/winter1991/collins_brown_holum; https://davidamitchell.github.io/Research/research/2026-05-02-incentive-misalignment-shadow-ai-skill-decay-controls.html | medium | Practical operating synthesis. |
...
- Links:
  ...
  - https://www.nature.com/articles/s41746-026-02410-1
