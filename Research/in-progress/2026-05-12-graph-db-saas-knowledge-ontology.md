...
- [fact] metaphactory is marketed as an enterprise knowledge-graph platform built on RDF, OWL, Simple Knowledge Organization System (SKOS), Shapes Constraint Language (SHACL), SPARQL, and Representational State Transfer (REST) APIs, with human-in-the-loop modeling, semantic application building, and explainable Artificial Intelligence (AI) positioning. [source: https://www.metaphacts.com/product]
