...
- [fact; source: https://arxiv.org/abs/2310.10996] ClarifyGPT reports that clarifying questions increased GPT-4 first-attempt benchmark correctness on MBPP-sanitized from 70.96% to 80.80%.
