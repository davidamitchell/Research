...
- [inference] MCP extends classic service-discovery patterns from endpoint location into structured discovery of context-bearing and action-bearing primitives that an agent can immediately incorporate into its deliberation loop.[source: https://modelcontextprotocol.io/docs/learn/architecture; https://modelcontextprotocol.io/introduction]
...
- [fact] HybGRAG reports that hybrid question answering over semi-structured knowledge bases benefits from combining textual and relational retrieval, using a retriever bank and critic module to improve Hit@1 on benchmark tasks.[source: https://aclanthology.org/2025.acl-long.43/]
...
- [inference] For agent runtime use, graph-only retrieval is strongest where the question is schema-driven or relation-heavy, vector-only retrieval is strongest where the ontology is thin but textual evidence is rich, and hybrid retrieval is strongest when the agent needs both semantic similarity and explicit relational constraints.[source: https://arxiv.org/abs/2408.04948; https://aclanthology.org/2025.acl-long.43/; https://davidamitchell.github.io/Research/research/2026-03-03-knowledge-representation-agent-context.html]
...
- [fact] The standards evidence is strongest on repeated discovery primitives, namely registries, descriptors, probes, scopes, and advertisements.[source: https://datatracker.ietf.org/doc/html/rfc2608; https://datatracker.ietf.org/doc/html/rfc6763; https://docs.oasis-open.org/ws-dd/discovery/1.1/wsdd-discovery-1.1-spec.html]
- [fact] The protocol evidence is strongest on MCP's concrete `tools`, `resources`, `prompts`, and registry metadata surfaces.[source: https://modelcontextprotocol.io/docs/learn/architecture; https://modelcontextprotocol.io/registry/about]
- [fact] The retrieval evidence is strongest on the value of graph-aware or hybrid retrieval relative to text-only baselines on tasks that require relation-aware or corpus-level synthesis.[source: https://arxiv.org/abs/2404.16130; https://arxiv.org/abs/2408.04948; https://aclanthology.org/2025.acl-long.43/]
...
- [inference] Dynamic Resource Discovery is a cross-system architecture pattern in which agents discover capability-bearing resources at runtime through registries, descriptors, advertisements, and late binding, while different protocols describe that structure through different labels.[source: https://datatracker.ietf.org/doc/html/rfc2608; https://datatracker.ietf.org/doc/html/rfc6763; https://docs.oasis-open.org/ws-dd/discovery/1.1/wsdd-discovery-1.1-spec.html; https://modelcontextprotocol.io/docs/learn/architecture]
- [inference] In agent systems, MCP is the clearest current instantiation of this pattern because it supports both server discovery through registry metadata and primitive discovery through dynamic listing of tools, resources, and prompts.[source: https://modelcontextprotocol.io/registry/about; https://modelcontextprotocol.io/docs/learn/architecture]
...
- [inference] Ontological stores make the pattern more precise and auditable because RDF, OWL, and SPARQL provide typed graph structure for relation-aware retrieval, and the strongest current evidence favors hybrid graph-plus-vector retrieval when runtime questions mix textual and relational evidence.[source: https://www.w3.org/TR/rdf11-concepts/; https://www.w3.org/TR/owl2-overview/; https://www.w3.org/TR/sparql11-query/; https://arxiv.org/abs/2408.04948; https://aclanthology.org/2025.acl-long.43/]

**Key findings:**

1. [inference] DRD is best modeled as an architectural family that recurs across service-discovery systems, because SLP, DNS-SD, WS-Discovery, and MCP all implement discoverable metadata plus late binding while describing that family through different protocol labels.[source: https://datatracker.ietf.org/doc/html/rfc2608; https://datatracker.ietf.org/doc/html/rfc6763; https://docs.oasis-open.org/ws-dd/discovery/1.1/wsdd-discovery-1.1-spec.html; https://modelcontextprotocol.io/docs/learn/architecture]
2. [fact] The core DRD primitives are registry or locator, machine-readable capability descriptor, lookup or advertisement mechanism, and a binding path from discovery to use, and those primitives are directly visible in both classic discovery standards and the MCP architecture.[source: https://datatracker.ietf.org/doc/html/rfc2608; https://datatracker.ietf.org/doc/html/rfc6763; https://docs.oasis-open.org/ws-dd/discovery/1.1/wsdd-discovery-1.1-spec.html; https://modelcontextprotocol.io/docs/learn/architecture; https://modelcontextprotocol.io/registry/about]
3. [inference] MCP is the clearest current agent-native DRD implementation because it supports pre-connection discovery of servers through the MCP Registry and post-connection discovery of tools, resources, and prompts through dynamic list methods.[source: https://modelcontextprotocol.io/registry/about; https://modelcontextprotocol.io/docs/learn/architecture]
...
5. [fact] RDF, OWL, and SPARQL make discovered resources semantically actionable by exposing typed entities, relations, and query paths, which enables relation-aware retrieval rather than purely lexical matching over static documentation.[source: https://www.w3.org/TR/rdf11-concepts/; https://www.w3.org/TR/owl2-overview/; https://www.w3.org/TR/sparql11-query/]
6. [inference] The strongest currently published retrieval pattern for ontology-backed agent context layers is hybrid graph-plus-vector retrieval, because graph-only and vector-only approaches each lose signal on questions that combine relational structure with text-rich evidence.[source: https://arxiv.org/abs/2404.16130; https://arxiv.org/abs/2408.04948; https://aclanthology.org/2025.acl-long.43/]
...
| [fact] DRD repeatedly uses registries, descriptors, lookup or advertisement, and late binding. | https://datatracker.ietf.org/doc/html/rfc2608; https://datatracker.ietf.org/doc/html/rfc6763; https://docs.oasis-open.org/ws-dd/discovery/1.1/wsdd-discovery-1.1-spec.html; https://modelcontextprotocol.io/docs/learn/architecture; https://modelcontextprotocol.io/registry/about | high | Directly documented primitives |
| [inference] MCP is the clearest current agent-native DRD implementation. | https://modelcontextprotocol.io/registry/about; https://modelcontextprotocol.io/docs/learn/architecture | medium | Strong on MCP, comparative step inferred |
...
| [fact] RDF, OWL, and SPARQL provide the semantic query substrate for ontology-backed retrieval. | https://www.w3.org/TR/rdf11-concepts/; https://www.w3.org/TR/owl2-overview/; https://www.w3.org/TR/sparql11-query/ | high | Standards-backed |
| [inference] Hybrid graph-plus-vector retrieval is the strongest current retrieval pattern for mixed relational and textual questions. | https://arxiv.org/abs/2404.16130; https://arxiv.org/abs/2408.04948; https://aclanthology.org/2025.acl-long.43/ | medium | Multiple papers, mixed domains |
| [inference] The right architecture is hybrid: preload a small control surface, discover the larger evidence surface on demand. | https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents; https://davidamitchell.github.io/Research/research/2026-03-18-api-context-hubs-rag-mcp.html; https://arxiv.org/abs/2302.00093 | medium | Design synthesis |
...
Dynamic Resource Discovery is best understood as a recurring architecture pattern in which an agent discovers capability-bearing resources through registries, descriptors, advertisements, and late binding at runtime, while different protocols describe that structure through different labels.[inference; source: https://datatracker.ietf.org/doc/html/rfc2608; https://datatracker.ietf.org/doc/html/rfc6763; https://docs.oasis-open.org/ws-dd/discovery/1.1/wsdd-discovery-1.1-spec.html; https://modelcontextprotocol.io/docs/learn/architecture]

In current agent systems, the clearest concrete implementation of that pattern is MCP, because it supports discovery both before connection through registry metadata and after connection through dynamic listing of tools, resources, and prompts.[inference; source: https://modelcontextprotocol.io/registry/about; https://modelcontextprotocol.io/docs/learn/architecture]
...
For ontology-backed agent context layers, the strongest design pattern is a hybrid stack that combines discovery metadata, typed graph retrieval, vector retrieval, and context compaction into one routed pipeline.[inference; source: https://www.w3.org/TR/rdf11-concepts/; https://www.w3.org/TR/sparql11-query/; https://arxiv.org/abs/2408.04948; https://aclanthology.org/2025.acl-long.43]

### Key Findings

1. **Dynamic Resource Discovery is best modeled as an architectural family that recurs across service-discovery systems, because SLP, DNS-SD, WS-Discovery, and MCP all implement discoverable metadata plus late binding while describing that family through different protocol labels.** ([inference]; medium confidence; source: https://datatracker.ietf.org/doc/html/rfc2608; https://datatracker.ietf.org/doc/html/rfc6763; https://docs.oasis-open.org/ws-dd/discovery/1.1/wsdd-discovery-1.1-spec.html; https://modelcontextprotocol.io/docs/learn/architecture)
2. **The core DRD primitives are registry or locator, machine-readable capability descriptor, lookup or advertisement mechanism, and a binding path from discovery to use, and those primitives appear directly in both classic network discovery standards and the MCP architecture.** ([fact]; high confidence; source: https://datatracker.ietf.org/doc/html/rfc2608; https://datatracker.ietf.org/doc/html/rfc6763; https://docs.oasis-open.org/ws-dd/discovery/1.1/wsdd-discovery-1.1-spec.html; https://modelcontextprotocol.io/docs/learn/architecture; https://modelcontextprotocol.io/registry/about)
3. **MCP is the clearest current agent-native implementation of DRD because it combines pre-connection discovery of servers through registry metadata with post-connection discovery of tools, resources, and prompts through dynamic list methods exposed by the protocol.** ([inference]; medium confidence; source: https://modelcontextprotocol.io/registry/about; https://modelcontextprotocol.io/docs/learn/architecture)
...
5. **RDF, OWL, and SPARQL make discovered resources semantically actionable by exposing typed entities, relations, and query paths, which lets an agent retrieve relation-aware context from an ontology through schema-aware queries and graph traversal.** ([fact]; high confidence; source: https://www.w3.org/TR/rdf11-concepts/; https://www.w3.org/TR/owl2-overview/; https://www.w3.org/TR/sparql11-query)
6. **The strongest currently published retrieval pattern for ontology-backed agent context layers is hybrid graph-plus-vector retrieval, because graph-only and vector-only approaches each lose signal on questions that combine relational structure with text-rich evidence.** ([inference]; medium confidence; source: https://arxiv.org/abs/2404.16130; https://arxiv.org/abs/2408.04948; https://aclanthology.org/2025.acl-long.43)
...
| [inference] DRD is a recurring architectural family described through different protocol labels. | https://datatracker.ietf.org/doc/html/rfc2608; https://datatracker.ietf.org/doc/html/rfc6763; https://docs.oasis-open.org/ws-dd/discovery/1.1/wsdd-discovery-1.1-spec.html; https://modelcontextprotocol.io/docs/learn/architecture | medium | Cross-standard synthesis |
| [fact] DRD repeatedly uses registries, descriptors, lookup or advertisement, and late binding. | https://datatracker.ietf.org/doc/html/rfc2608; https://datatracker.ietf.org/doc/html/rfc6763; https://docs.oasis-open.org/ws-dd/discovery/1.1/wsdd-discovery-1.1-spec.html; https://modelcontextprotocol.io/docs/learn/architecture; https://modelcontextprotocol.io/registry/about | high | Directly documented primitives |
| [inference] MCP is the clearest current agent-native DRD implementation. | https://modelcontextprotocol.io/registry/about; https://modelcontextprotocol.io/docs/learn/architecture | medium | Comparative step inferred |
...
| [fact] RDF, OWL, and SPARQL provide the semantic substrate for ontology-backed retrieval. | https://www.w3.org/TR/rdf11-concepts/; https://www.w3.org/TR/owl2-overview/; https://www.w3.org/TR/sparql11-query | high | Standards-backed |
| [inference] Hybrid graph-plus-vector retrieval is strongest for mixed relational and textual questions. | https://arxiv.org/abs/2404.16130; https://arxiv.org/abs/2408.04948; https://aclanthology.org/2025.acl-long.43 | medium | Multi-paper synthesis |
| [inference] The best architecture preloads a small control surface and discovers the larger evidence surface on demand. | https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents; https://davidamitchell.github.io/Research/research/2026-03-18-api-context-hubs-rag-mcp.html; https://arxiv.org/abs/2302.00093 | medium | Design synthesis |
...
Ontological stores strengthen the design because they let the retrieval layer reason over typed entities and relations, but the retrieval evidence suggests that a pure graph strategy is still weaker than a hybrid graph-plus-vector strategy on mixed questions.[inference; source: https://www.w3.org/TR/owl2-overview/; https://arxiv.org/abs/2408.04948; https://aclanthology.org/2025.acl-long.43]
