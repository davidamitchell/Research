...
- [fact; source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-22-enterprise-ai-platform-operating-models.md; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-22-enterprise-ai-capability-model.md] Prior completed repository work already established two adjacent points that matter here: enterprises benefit from a shared AI control plane, and use-case intake should distinguish reusable enterprise capabilities from genuinely net-new capability needs.
...
- [inference; source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-22-enterprise-ai-platform-operating-models.md; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-22-enterprise-ai-capability-model.md; https://learn.microsoft.com/en-us/power-platform/guidance/coe/overview; https://docs.github.com/en/copilot/concepts/policies] The mature operating pattern is a hybrid model: one central team owns common policies and control planes, while route-specific builders stay close to the business users or engineers they serve.
...
- [inference; source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-22-enterprise-ai-platform-operating-models.md; https://learn.microsoft.com/en-us/power-platform/admin/wp-data-loss-prevention; https://docs.github.com/en/copilot/concepts/policies] A central platform team should own the shared control plane, approved tools, and escalation rubric, while domain teams build within the route assigned by intake.
...
2. [fact; source: https://learn.microsoft.com/en-us/power-platform/guidance/coe/overview; https://learn.microsoft.com/en-us/power-platform/admin/managed-environment-overview; https://learn.microsoft.com/en-us/power-platform/admin/wp-data-loss-prevention] **High confidence:** The business-led low-code lane works best for approved-platform workflows where central administrators can enforce managed environments, connector guardrails, maker accountability, and rapid escalation of noncompliant apps.
3. [fact; source: https://learn.microsoft.com/azure/cloud-adoption-framework/scenarios/ai/govern; https://docs.cloud.google.com/architecture/framework/perspectives/ai-ml/operational-excellence?hl=en; https://docs.aws.amazon.com/wellarchitected/latest/machine-learning-lens/machine-learning-lens.html; https://learn.microsoft.com/en-us/security/ai-red-team/ai-risk-assessment] **High confidence:** The pro-code custom lane is required when a use case depends on custom engineering, sensitive or regulated data, deep system integration, or operational controls that must span the full model and software lifecycle.
4. [fact; source: https://docs.github.com/en/copilot/concepts/policies; https://docs.github.com/copilot/managing-copilot/managing-copilot-for-your-enterprise/managing-policies-and-features-for-copilot-in-your-enterprise; https://docs.github.com/en/copilot/responsible-use-of-github-copilot-features/responsible-use-of-github-copilot-code-completion] **High confidence:** Developer productivity AI should be routed as an internal tooling lane with enterprise policy controls, privacy decisions, and mandatory human review rather than as unattended business automation.
5. [inference; source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-22-enterprise-ai-platform-operating-models.md; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-22-enterprise-ai-capability-model.md; https://learn.microsoft.com/en-us/power-platform/guidance/coe/overview] **Medium confidence:** The central platform team should own the shared control plane and approved capabilities, while business or engineering teams should own route-specific implementation after the intake decision is made.
...
| [fact] Low-code business-led work is safe when managed environments, connector guardrails, and maker accountability are in place. | https://learn.microsoft.com/en-us/power-platform/guidance/coe/overview<br>https://learn.microsoft.com/en-us/power-platform/admin/managed-environment-overview<br>https://learn.microsoft.com/en-us/power-platform/admin/wp-data-loss-prevention | high | Central low-code controls are explicit and productized. |
| [fact] Pro-code custom systems need lifecycle controls across design, deployment, monitoring, and incident response. | https://learn.microsoft.com/azure/cloud-adoption-framework/scenarios/ai/govern<br>https://docs.cloud.google.com/architecture/framework/perspectives/ai-ml/operational-excellence?hl=en<br>https://docs.aws.amazon.com/wellarchitected/latest/machine-learning-lens/machine-learning-lens.html<br>https://learn.microsoft.com/en-us/security/ai-red-team/ai-risk-assessment | high | Evidence spans Microsoft, Google Cloud, and AWS guidance. |
| [fact] Developer productivity tools are centrally governable through enterprise feature, privacy, and model policies plus human review requirements. | https://docs.github.com/en/copilot/concepts/policies<br>https://docs.github.com/copilot/managing-copilot/managing-copilot-for-your-enterprise/managing-policies-and-features-for-copilot-in-your-enterprise<br>https://docs.github.com/en/copilot/responsible-use-of-github-copilot-features/responsible-use-of-github-copilot-code-completion | high | Internal-tooling route has distinct control levers. |
| [inference] The central platform team should own the shared control plane and approved capabilities. | https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-22-enterprise-ai-platform-operating-models.md<br>https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-22-enterprise-ai-capability-model.md<br>https://learn.microsoft.com/en-us/power-platform/guidance/coe/overview | medium | Prior repository work and CoE guidance point to central ownership plus federated delivery. |
...
- [inference; source: https://learn.microsoft.com/en-us/power-platform/guidance/coe/overview; https://docs.github.com/en/copilot/concepts/policies] The low-code and developer productivity lanes are best understood as controlled enablement patterns rather than reduced-risk-by-default categories, which is why the routing rubric must still evaluate criticality and escalation triggers before assigning them.

**Risks, gaps, uncertainties:**

- [fact; source: https://learn.microsoft.com/en-us/power-platform/guidance/coe/overview; https://docs.github.com/en/copilot/concepts/policies] Public vendor guidance is strong on available control levers but thinner on published enterprise thresholds, so specific scoring cutoffs for route assignment remain an implementation choice for each enterprise.
- [fact; source: https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai] The European Commission's AI Act guidance is precise on high-risk obligations, but many business use cases outside the listed high-risk categories still require enterprise judgment rather than automatic legal classification.
...
[inference; source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-04-22-enterprise-ai-platform-operating-models.md; https://learn.microsoft.com/en-us/power-platform/admin/wp-data-loss-prevention; https://docs.github.com/en/copilot/concepts/policies] A central platform team should own the shared control plane, approved tools, and escalation rubric, while domain teams build inside the lane assigned by intake.
...
[inference; source: https://learn.microsoft.com/en-us/security/ai-red-team/ai-risk-assessment; https://learn.microsoft.com/en-us/power-platform/admin/wp-data-loss-prevention; https://docs.github.com/en/copilot/responsible-use-of-github-copilot-features/responsible-use-of-github-copilot-code-completion] The trade-off is therefore not centralization versus decentralization in the abstract, but where the organization can safely rely on platform guardrails and where it must require fuller engineering and review disciplines.

### Risks, Gaps, and Uncertainties

[fact; source: https://learn.microsoft.com/en-us/power-platform/guidance/coe/overview; https://docs.github.com/en/copilot/concepts/policies] Public platform documentation explains available governance levers clearly, but it rarely publishes numeric scoring thresholds for route assignment, so each enterprise still needs to calibrate its own cutoff values.
[fact; source: https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai] The AI Act clearly identifies prohibited and high-risk categories, but many useful enterprise cases still fall outside those named buckets and must be judged through internal risk governance rather than automatic legal classification.
