...
1. Define contract theory and summarize its main problem classes, for example principal-agent settings under information asymmetry.
...
- Scope: economic contract theory, canonical principal-agent formulation, current usage of statistical contract, and statistical adequacy criteria for empirical or incentive-aware contract models.
...
- Prior completed-item sweep: no completed repository item directly answers contract theory or statistical contract terminology; the closest adjacent items concern invariance under shift and the limits of observational criteria, so they are treated as thematic context rather than direct evidence.

### §1 Question Decomposition

1. Core definition
   1.1 What problem does contract theory solve in economics?
   1.2 Which recurring settings anchor the field, for example moral hazard, adverse selection, multitasking, and incomplete contracts?
...
- Access note: seeded Princeton Press textbook URL -> 404 this session; public sources used for terminology and formulation.
- Access note: seeded stable-link URL -> 403 this session; Holmstrom abstract taken from the Research Papers in Economics (RePEc) bibliographic record, and canonical exposition taken from Nobel and MIT notes.
...
- [fact] Classical contract theory and modern statistical-contract work agree that incentives cannot be separated from the information structure governing what is observed and rewarded. [source: https://ideas.repec.org/a/rje/bellje/v10y1979ispringp74-91.html; https://www.nobelprize.org/prizes/economic-sciences/2016/popular-information/; https://arxiv.org/abs/2205.06812]
...
- [fact] No consulted source contradicts the core principal-agent formulation with participation and incentive-compatibility constraints, although sources differ in whether they emphasize pay-for-performance, multitasking, or incomplete-contract extensions. [source: https://economics.mit.edu/sites/default/files/inline-files/Lecture%206%20and%207%20-%20Moral%20Hazard%20and%20Applicaitons.pdf; https://www.nobelprize.org/prizes/economic-sciences/2016/popular-information/]
- [fact] The main ambiguity is terminological rather than substantive: classical open-access sources define contract theory broadly, while the exact phrase "statistical contract" is concentrated in newer work on incentive-aware statistical protocols. [source: https://www.nobelprize.org/prizes/economic-sciences/2016/popular-information/; https://arxiv.org/abs/2205.06812]
...
- [fact] Technical lens: the model must specify which variables are latent, which are observed, what generates outcome noise, and how the contract maps observations into transfers or decision rights. [source: https://economics.mit.edu/sites/default/files/inline-files/Lecture%206%20and%207%20-%20Moral%20Hazard%20and%20Applicaitons.pdf; https://web.stanford.edu/group/fwolak/cgi-bin/sites/default/files/files/Structural%20Econometric%20Modeling_Rationales%20and%20Examples%20From%20Industrial%20Organization_Reiss,%20Wolak.pdf]
- [fact] Economic lens: the adequacy of a contract is tied to the agent's outside option, risk exposure, and adaptation incentives, alongside whether the econometrician can estimate coefficients. [source: https://www.nobelprize.org/prizes/economic-sciences/2016/popular-information/; https://economics.mit.edu/sites/default/files/inline-files/Lecture%206%20and%207%20-%20Moral%20Hazard%20and%20Applicaitons.pdf; https://arxiv.org/abs/2205.06812]
...
- [fact] Behavioral lens: once evidentiary thresholds become known, strategic agents can change entry or effort decisions to exploit them, so testing rules become part of the incentive environment rather than neutral measurement devices. [source: https://arxiv.org/abs/2205.06812]
...
Contract theory is an incentive-design framework for transactions with conflicting interests, hidden information, or incomplete observability, not a doctrine about legal drafting alone. [fact; source: https://www.nobelprize.org/prizes/economic-sciences/2016/popular-information/; https://books.core-econ.org/the-economy/microeconomics/10-market-successes-failures-08-principal-agent-relationships.html; https://ideas.repec.org/a/rje/bellje/v10y1979ispringp74-91.html]

A canonical contract-theory model specifies a principal, an agent, an outcome technology with uncertainty, payoff or utility functions, an information structure, a feasible contract space, and participation plus incentive-compatibility constraints. [fact; source: https://economics.mit.edu/sites/default/files/inline-files/Lecture%206%20and%207%20-%20Moral%20Hazard%20and%20Applicaitons.pdf; https://www.nobelprize.org/prizes/economic-sciences/2016/popular-information/]

In the accessible recent literature, a statistical contract is a contract or protocol whose payoffs depend on statistical evidence and whose design must anticipate strategic adaptation to the evidence rule itself. [fact; source: https://arxiv.org/abs/2205.06812]
...
3. **The accessible literature uses "statistical contract" mainly for incentive-aware evidence protocols, especially in recent principal-agent hypothesis-testing work, rather than as a blanket synonym for any empirical contract model.** ([fact]; medium confidence; source: https://arxiv.org/abs/2205.06812; https://www.nobelprize.org/prizes/economic-sciences/2016/popular-information/; https://ideas.repec.org/a/rje/bellje/v10y1979ispringp74-91.html)
...
7. **For statistical contracts in the narrow evidence-linked sense, inferential error rates must be evaluated together with strategic response, because a statistically valid threshold can still create socially bad incentives if approval payoffs make weak candidates profitable to submit.** ([fact]; medium confidence; source: https://arxiv.org/abs/2205.06812)
...
| [fact] Statistical contract is used mainly for evidence-linked incentive protocols in recent work. | https://arxiv.org/abs/2205.06812 ; https://www.nobelprize.org/prizes/economic-sciences/2016/popular-information/ ; https://ideas.repec.org/a/rje/bellje/v10y1979ispringp74-91.html | medium | Term-usage boundary |
...
| [fact] Statistical contracts must be tested for incentive robustness against strategic adaptation to evidence thresholds. | https://arxiv.org/abs/2205.06812 | medium | Extra criterion |
