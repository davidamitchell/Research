...
- [fact] DORA's productivity and stability findings are not contradictory to the software-gap-closure thesis, because the report explicitly shows that local productivity gains do not remove the need for process redesign and control fundamentals. Source: https://dora.dev/research/2024/dora-report/; https://cloud.google.com/resources/content/dora-roi-of-ai-assisted-software-development.
...
That evidence makes the central trade-off clear: recurring agent operation looks cheap if the analyst compares only token cost to developer salary, but it looks expensive once the recurring human review, governance, and failure-recovery loop is priced in. [inference; source: https://dora.dev/research/2024/ai-preview/; https://docs.github.com/en/copilot/how-tos/copilot-on-github/use-copilot-agents/kick-off-a-task; https://docs.github.com/en/copilot/how-tos/copilot-on-github/use-copilot-agents/copilot-code-review; https://doi.org/10.6028/NIST.AI.100-1]
