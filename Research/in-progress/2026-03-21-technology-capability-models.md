...
**[fact]** TOGAF is the closest cross-industry backbone because its reference-model family supplies implementation-agnostic platform and application or data structure, but it remains a coarse reference model rather than a modern finished capability library or maturity framework. Sources: `https://www.opengroup.org/togaf`; `https://www.opengroup.org/architecture/0210can/togaf8/doc-review/togaf8cr/c/p3/iii-rm/concepts.htm`.

**[fact]** IT-CMF supplies the maturity mechanism and prior repository work shows that CSDM supplies the operational traceability layers, so the most defensible combination is TOGAF-style backbone plus IT-CMF plus CSDM, with sector and quality overlays added only where needed. Sources: `https://ivi.ie/it-capability-maturity-framework/`; `https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-03-08-servicenow-csdm-data-modelling.md`; `https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-03-08-servicenow-platform-strategy.md`.
