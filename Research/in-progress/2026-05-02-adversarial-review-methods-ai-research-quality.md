...
- [inference; source: https://arxiv.org/abs/2212.08073; https://arxiv.org/abs/2303.17651; https://aclanthology.org/2024.findings-acl.212/] The shared design pattern across the strongest prompt-compatible methods is not generic reflection but staged critique with explicit intermediate outputs that can be inspected and revised.
...
- [inference; source: https://arxiv.org/abs/2402.14207; https://pmc.ncbi.nlm.nih.gov/articles/PMC12748294/; https://arxiv.org/abs/1805.00899] For research-quality review, the strongest adversary is not a generic contrarian voice but a role with a specific perspective, a claim target, and a shared objective of improving the final artifact.
...
- [inference; source: https://aclanthology.org/2024.findings-acl.212/; https://arxiv.org/abs/2402.14207; https://arxiv.org/abs/2406.01297] The strongest prompt-only design for this repository is a structured objection-and-verification gate that combines independent challenge generation with source-based checking before final approval.
...
- [inference; source: https://arxiv.org/abs/2212.08073; https://aclanthology.org/2024.findings-acl.212/; https://arxiv.org/abs/2402.14207] The best minimum-viable design is therefore a hybrid of Constitutional AI style critique, Chain-of-Verification style independent checking, and STORM style perspective-specific questioning, translated into a single-agent prompt block.

### §6 Synthesis

**Executive summary:**

- The most effective prompt-only adversarial review pattern for AI-generated research findings is a structured objection-and-verification gate, not an open-ended "play devil's advocate" instruction. [inference; source: https://aclanthology.org/2024.findings-acl.212/; https://arxiv.org/abs/2406.01297; https://openreview.net/forum?id=7K1kXowjK1]
...
1. **Structured self-critique methods improve output quality mainly when they force the model to externalise critique artifacts before revision, rather than asking for vague reflection after the draft is already written.** ([fact]; high confidence; source: https://arxiv.org/abs/2212.08073; https://arxiv.org/abs/2303.17651; https://aclanthology.org/2024.findings-acl.212/)
2. **Prompt-only adversarial review should borrow Chain-of-Verification's separation between objection planning and objection checking, because independent verification steps reduce the chance that the draft and the critique share the same unsupported assumption.** ([inference]; high confidence; source: https://aclanthology.org/2024.findings-acl.212/; https://arxiv.org/abs/2406.01297; https://openreview.net/forum?id=7K1kXowjK1)
...
|---|---|---|---|
| [fact] Structured self-critique works best when critique is externalised before revision. | https://arxiv.org/abs/2212.08073; https://arxiv.org/abs/2303.17651; https://aclanthology.org/2024.findings-acl.212/ | high | Shared staged pattern |
| [inference] Independent objection checking is the most important portable element for this workflow. | https://aclanthology.org/2024.findings-acl.212/; https://arxiv.org/abs/2406.01297; https://openreview.net/forum?id=7K1kXowjK1 | high | Counters shared blind spots |
...
| [inference] A substantive objection must identify a target claim, a rival interpretation, and a resolution test. | https://aclanthology.org/2024.findings-acl.212/; https://pmc.ncbi.nlm.nih.gov/articles/PMC12748294/; https://www.cambridge.org/core/books/uses-of-argument/26CF801BC12004587B66778297D5567C | medium | Argument-structure heuristic |
...
- A structured objection-and-verification gate is the strongest prompt-only adversarial review method for catching shallow reasoning in AI-generated research findings before commit. [inference; source: https://aclanthology.org/2024.findings-acl.212/; https://arxiv.org/abs/2406.01297; https://openreview.net/forum?id=7K1kXowjK1]
