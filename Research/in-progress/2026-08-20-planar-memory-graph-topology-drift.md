...
- Amazon Web Services (AWS)-specific ontology pipelines, which are covered by separate items in this cluster
...
The closest prior work distinguishes a Terminological Box (TBox), a predefined ontology or schema, from an Assertion Box (ABox), instance-level facts emerging from data, when comparing schema-guided against schema-free graph construction; that comparison is the direct precedent for this item's bounded-versus-unbounded extraction question. Domain boundaries in a separate prior item are shown to emerge from semantic graph density crossing a community-detection threshold, using the same Girvan-Newman modularity result cited in §2 and §6 below, which directly informs this item's modularity-based structural-stability proxy.
...
- [Domain Emergence in Semantic Networks, Cognition, and Organizational Structure](https://davidamitchell.github.io/Research/research/2026-05-27-semantic-domain-emergence-enterprise-ontology.html)
...
- [x] [TBox-driven vs ABox-emergent ontology approaches in GraphRAG systems](https://davidamitchell.github.io/Research/research/2026-07-20-tbox-abox-graphrag.html): closest prior repository item on schema-guided versus emergent graph construction
- [x] [Knowledge Representation for Agent Context](https://davidamitchell.github.io/Research/research/2026-03-03-knowledge-representation-agent-context.html): prior repository item on graph-based context representations, cited for the multi-hop task-proxy justification in §3
- [x] [Domain Emergence in Semantic Networks, Cognition, and Organizational Structure](https://davidamitchell.github.io/Research/research/2026-05-27-semantic-domain-emergence-enterprise-ontology.html): prior repository item on threshold effects in semantic graph structure
- [x] [Evaluation frameworks for agentic memory quality, relevance, and retrieval accuracy](https://davidamitchell.github.io/Research/research/2026-07-20-agent-memory-evaluation-framework.html): prior repository item on how to measure graph-memory failure
...
- [x] [Zhang & Soh Extract, Define, Canonicalize: An LLM-based Framework for Knowledge Graph Construction (2024)](https://arxiv.org/abs/2404.03868): arXiv preprint and ACL Anthology paper identifying inconsistent, fragmented entity/relation labelling as a core problem in schema-free extraction and proposing a post-hoc canonicalization step to resolve it
- [x] [Toward Robust GraphRAG: Mitigating Retrieval Drift and Hallucination from Imperfect Knowledge Graphs (2026)](https://arxiv.org/abs/2603.14828): arXiv preprint on spurious-noise and incomplete-information issue modes in LLM-constructed knowledge graphs, proposing the Constraint-based and Sufficiency-guided Retrieval-Augmented Generation (CS-RAG) method
...
- [x] [Albert, Jeong & Barabási Error and Attack Tolerance of Complex Networks (Nature, 2000)](https://doi.org/10.1038/35019019): primary source for percolation-threshold and giant-component network-robustness framing used only as an orientation concept in §5
...
Bounded schemas constrain predicate type, not predicate-instance truthfulness against source text. An in-vocabulary hallucination passes through a fixed schema unaffected. [inference; source: https://arxiv.org/abs/2603.14828] No source measures a single numeric noise threshold for topology collapse in any graph-memory system, planar or otherwise. [assumption] Two proxy-metric families exist in the evidence base instead: a structural-stability family built on modularity and community-detection quality, and a task-outcome family built on multi-hop path-query accuracy and community-report factual distortion. [inference; source: https://www.pnas.org/doi/10.1073/pnas.0601602103; https://arxiv.org/abs/2603.14828] No located study calibrates one family against the other in a single experiment. [fact; source: https://davidamitchell.github.io/Research/research/2026-08-20-graphrag-macro-level-hallucination.html] A layered knowledge-representation architecture recommended for large agent corpora places a knowledge graph specifically at the layer responsible for multi-hop relationship queries, which corroborates using multi-hop path-query accuracy, rather than single-hop retrieval accuracy, as the task-outcome proxy for topology drift in this item. [inference; source: https://davidamitchell.github.io/Research/research/2026-03-03-knowledge-representation-agent-context.html] Every system in the evidence base that demonstrably remains usable under noise does so through an active repair loop operating after extraction, not through schema rigidity alone. [inference; source: https://arxiv.org/abs/2603.14828; https://arxiv.org/abs/2407.10793; https://aclanthology.org/2026.acl-long.2222/]
...
Historical lens: percolation threshold, the point at which a graph's largest connected component stops scaling with graph size as edges are randomly removed, is a network-science result established for random-failure and targeted-attack robustness in complex networks and predates agent-memory systems; it is offered here only as an orientation concept for why network-robustness researchers reach for a single critical-threshold framing, and it has not been directly applied to LLM-constructed knowledge graphs in any source located during this investigation. [assumption; source: https://doi.org/10.1038/35019019]
