...
3. **Tool use and persistent memory make adversarial corruption more dangerous than a single wrong answer because they let one locally plausible mistake change external state and shape future sessions.** ([fact]; high confidence; source: https://www.microsoft.com/en-us/msrc/blog/2025/07/how-microsoft-defends-against-indirect-prompt-injection-attacks; https://unit42.paloaltonetworks.com/indirect-prompt-injection-poisons-ai-longterm-memory/; https://arxiv.org/abs/2302.12173)
...
| [fact] Tool use and persistent memory convert local semantic corruption into external-state change and cross-session persistence. | https://www.microsoft.com/en-us/msrc/blog/2025/07/how-microsoft-defends-against-indirect-prompt-injection-attacks; https://unit42.paloaltonetworks.com/indirect-prompt-injection-poisons-ai-longterm-memory/; https://arxiv.org/abs/2302.12173 | high | Memory and action surface |
