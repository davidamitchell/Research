...
[inference; source: https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://www.nist.gov/itl/ai-risk-management-framework; https://www.iso.org/standard/81230.html] The useful output is therefore a dependency model that ties use-case ambition to governance, data, platform, evaluation, and operating-model readiness, not a generic maturity ladder.
...
- [inference; source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-03-21-technology-capability-models.md; https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://www.nist.gov/itl/ai-risk-management-framework; https://www.iso.org/standard/81230.html] The strongest enterprise AI answer follows the same pattern: keep the capability taxonomy stable, and treat use-case triage as an assessment overlay that decides whether a use case can ride shared enterprise rails.
...
- [inference; source: https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://www.nist.gov/itl/ai-risk-management-framework; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-03-19-layered-org-llm-architecture.md] The **enabling** capability layer should contain reusable retrieval and context assembly, access and policy enforcement, orchestration and routing, human-in-the-loop approval patterns, and experimentation infrastructure for adapters or prompt strategies.
- [inference; source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-03-19-layered-org-llm-architecture.md; https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://doi.org/10.6028/NIST.AI.100-1] The **differentiating** capability layer should contain domain ontologies and knowledge graphs, task-specific adapters or fine-tunes, specialised critic and verifier stacks, and AI-native workflow redesign in places where the business deliberately wants advantage rather than mere parity.
...
- [inference; source: https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://www.faros.ai/blog/translating-ai-powered-developer-velocity-into-business-outcomes; https://doi.org/10.6028/NIST.AI.100-1] The model is best understood as a dependency map rather than a maturity ladder because the decision problem is not "how mature are we overall?" but "which shared prerequisites must already exist before this specific use case can safely reuse them?"
...
- [inference; source: https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://doi.org/10.6028/NIST.AI.100-1; https://www.iso.org/standard/81230.html] The best enterprise AI capability model for reuse-versus-build decisions is a dependency map with three layers: foundational shared capabilities, enabling reusable capabilities, and differentiating use-case-specific capabilities.
...
1. [inference; source: https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://doi.org/10.6028/NIST.AI.100-1; https://www.iso.org/standard/81230.html] **High confidence:** The strongest enterprise AI capability model is not a generic maturity ladder but a dependency map that separates foundational shared rails from higher-order enabling and differentiating capabilities.
2. [fact; source: https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report] **High confidence:** DORA's public evidence says AI amplifies existing system quality, which means policy, internal context, platform quality, and safety nets are prerequisites for reuse rather than optional optimisation work.
3. [fact; source: https://github.blog/news-insights/research/research-quantifying-github-copilots-impact-on-developer-productivity-and-happiness/; https://www.faros.ai/blog/translating-ai-powered-developer-velocity-into-business-outcomes; https://www.gitclear.com/coding_on_copilot_data_shows_ais_downward_pressure_on_code_quality] **High confidence:** Individual developer productivity gains do not prove organisational readiness, because faster generation can coexist with higher churn, larger queues, and flat company-level outcomes.
4. [fact; source: https://doi.org/10.6028/NIST.AI.100-1; https://www.iso.org/standard/81230.html] **High confidence:** Governance capability is inherently reusable at enterprise level, because both NIST AI RMF and ISO/IEC 42001 require organisation-wide intake, mapping, measurement, management, and lifecycle control structures.
5. [fact; source: https://hai.stanford.edu/assets/files/hai_ai_index_report_2025.pdf; https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai] **High confidence:** External pressure to deploy AI is already high, but scaling pressure now exceeds governance and operating-model maturity, so enterprises need shared rails more than more pilots.
...
|---|---|---|---|
| [inference] The right model is a dependency map, not a generic maturity ladder. | https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://doi.org/10.6028/NIST.AI.100-1; https://www.iso.org/standard/81230.html | high | DORA explains why system prerequisites matter, and NIST plus ISO define those reusable prerequisites. |
| [fact] DORA shows that AI value depends on internal policy, context, platforms, and safety nets. | https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report | high | The blog states the amplifier thesis and the named capability guidance directly. |
| [fact] Individual productivity gains do not prove organisational readiness. | https://github.blog/news-insights/research/research-quantifying-github-copilots-impact-on-developer-productivity-and-happiness/; https://www.faros.ai/blog/translating-ai-powered-developer-velocity-into-business-outcomes; https://www.gitclear.com/coding_on_copilot_data_shows_ais_downward_pressure_on_code_quality | high | GitHub shows local gains; Faros and GitClear show the downstream limit and quality risk. |
| [fact] Governance capability is reusable at enterprise level. | https://doi.org/10.6028/NIST.AI.100-1; https://www.iso.org/standard/81230.html | high | Both frameworks define organisation-wide governance and lifecycle controls. |
| [fact] Adoption pressure is high while scaling maturity is uneven. | https://hai.stanford.edu/assets/files/hai_ai_index_report_2025.pdf; https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai | high | AI Index gives the strongest current macro numbers, and McKinsey describes the pilot-heavy operating reality. |
...
- [inference; source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-03-19-layered-org-llm-architecture.md; https://doi.org/10.6028/NIST.AI.100-1] **Differentiating - domain-specific optimisation:** ontologies, adapters, critic stacks, and specialised benchmarks should be added only after foundations are proven and a specific use case clearly needs them.
...
[inference; source: https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://doi.org/10.6028/NIST.AI.100-1; https://www.iso.org/standard/81230.html] The best enterprise AI capability model for use-case maturity decisions is a three-layer dependency map in which shared foundational capabilities are assessed before any use case is allowed to claim reuse.
...
1. [inference; source: https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://doi.org/10.6028/NIST.AI.100-1; https://www.iso.org/standard/81230.html] **High confidence:** The most useful enterprise AI capability model is a dependency map that separates foundational shared rails from enabling and differentiating layers, because the decision problem is whether a use case can safely ride existing enterprise capability rather than whether the enterprise is "mature" in a generic sense.
2. [fact; source: https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report] **High confidence:** DORA's 2025 research shows that AI amplifies existing system quality, so clear AI policies, internal context, high-quality internal platforms, user-centric workflow design, and safety nets are prerequisites for reliable reuse across a portfolio of use cases.
3. [fact; source: https://github.blog/news-insights/research/research-quantifying-github-copilots-impact-on-developer-productivity-and-happiness/; https://www.faros.ai/blog/translating-ai-powered-developer-velocity-into-business-outcomes; https://www.gitclear.com/coding_on_copilot_data_shows_ais_downward_pressure_on_code_quality] **High confidence:** Individual AI productivity gains cannot be treated as evidence of enterprise readiness, because faster task completion can coexist with higher churn, larger review queues, and flat company-level outcomes when downstream controls remain weak.
4. [fact; source: https://doi.org/10.6028/NIST.AI.100-1; https://www.iso.org/standard/81230.html] **High confidence:** Governance capability belongs in the foundational layer because both NIST AI RMF and ISO/IEC 42001 require organisation-wide intake, mapping, measurement, management, and lifecycle controls that are reusable across multiple AI use cases.
5. [fact; source: https://hai.stanford.edu/assets/files/hai_ai_index_report_2025.pdf; https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai] **High confidence:** Enterprise pressure to deploy AI is already intense, but scaling maturity remains uneven, which means the scarce asset is now the operating model around AI rather than simple access to models or pilot opportunities.
...
| Claim | Source | Confidence | Notes |
|---|---|---|---|
| [inference] The right enterprise AI model is a dependency map rather than a generic maturity ladder. | https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report; https://doi.org/10.6028/NIST.AI.100-1; https://www.iso.org/standard/81230.html | high | DORA explains the amplifier dynamic, and NIST plus ISO define the reusable control rails. |
| [fact] DORA says reusable AI value depends on policy, internal context, platforms, user-centricity, and safety nets. | https://cloud.google.com/blog/products/ai-machine-learning/announcing-the-2025-dora-report | high | This is stated directly in DORA's published guidance. |
| [fact] Local productivity gains do not prove organisational readiness. | https://github.blog/news-insights/research/research-quantifying-github-copilots-impact-on-developer-productivity-and-happiness/; https://www.faros.ai/blog/translating-ai-powered-developer-velocity-into-business-outcomes; https://www.gitclear.com/coding_on_copilot_data_shows_ais_downward_pressure_on_code_quality | high | GitHub shows local gains; Faros and GitClear show system-level bottlenecks and quality drag. |
| [fact] Governance capability is reusable at enterprise level. | https://doi.org/10.6028/NIST.AI.100-1; https://www.iso.org/standard/81230.html | high | Both frameworks define organisation-wide lifecycle control requirements. |
| [fact] Deployment pressure is high while scaling maturity is still uneven. | https://hai.stanford.edu/assets/files/hai_ai_index_report_2025.pdf; https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai | high | AI Index supplies macro numbers and McKinsey describes pilot-heavy reality. |
...
[inference; source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-03-21-technology-capability-models.md] I resolved the model-shape question by reusing the prior repository conclusion that durable enterprise maps separate stable taxonomy from assessment overlays, because that keeps the AI capability map stable while allowing use-case-specific triage.
