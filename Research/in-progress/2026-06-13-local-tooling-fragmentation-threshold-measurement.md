...
[fact; source: https://www.techfinitive.com/features/how-to-keep-shadow-it-costs-under-control/; https://www.valencesecurity.com/resources/blogs/gartner-saas-applications-outside-of-it] Gartner estimates that shadow IT accounts for 30 to 40 percent of total IT spend in large enterprises, and projects that by 2027, 75 percent of employees will acquire or modify technology outside IT department visibility, up from 41 percent in 2022. These figures are widely cited in practitioner sources that attribute them to Gartner research, and the direction is consistent with the broader fragmentation trajectory documented in the academic literature.
...
contradiction_scan: no internal contradictions found
  Note 1: Gartner figures (30-40% shadow spend, 75% by 2027) are widely cited
    but attributed to Gartner via secondary sources; downgraded to [fact] with
    secondary-source URL, not direct Gartner report URL; confidence appropriately
    medium for any claim relying on these figures.
...
**Regulatory lens:** In regulated industries, locally owned tools that touch regulated data or processes create compliance exposure that does not scale linearly with tool count. [inference; source: https://aisel.aisnet.org/ijispm/vol7/iss1/3/] Each such tool is a potential audit finding, and regulators in banking, healthcare, and financial services have increasingly scrutinised model risk and data governance frameworks that depend on undocumented or non-standard tooling. The compliance exposure multiplier is highest where tools feed outputs into decisions that are subject to regulatory review.

**Economic lens:** The Gartner shadow spend estimate (30 to 40 percent of IT budget in large enterprises) suggests the aggregate cost is already economically material before any crossover calculation is applied. [inference; source: https://www.techfinitive.com/features/how-to-keep-shadow-it-costs-under-control/] The relevant economic question is not whether fragmentation has a cost but how large the benefit must be to justify that cost. At 30 to 40 percent of IT budget, the burden of proof shifts to demonstrating ongoing benefit rather than assuming it.

**Historical lens:** The Kopper et al. (2020) governance-transition literature observes that shadow IT has existed as a phenomenon since at least the 1980s, when business units first deployed personal computers and spreadsheets without IT department oversight. [inference; source: https://link.springer.com/article/10.1007/s10257-020-00472-6] The current AI-tooling wave is structurally identical to three prior waves (personal computing, internet-era web applications, and SaaS adoption), each of which followed the same pattern: rapid local adoption, hidden cost accumulation, governance intervention after a material failure. The leading indicators described in this item are historically consistent across all four waves.

**Behavioural lens:** Adam Smith's desire-path framework, as synthesised in the prior repository item on organisational design (2026-03-15-adam-smith-org-design-desire-paths-ai), explains why local tooling persists even after the crossover: the individual who built the tool experiences its benefit directly while the costs are distributed across the organisation and remain invisible to them. [inference; source: https://davidamitchell.github.io/Research/research/2026-03-15-adam-smith-org-design-desire-paths-ai.html] This asymmetry means that the crossover is not self-correcting through individual behaviour; organisational governance must supply the correction signal.

### §6 Synthesis

**Executive summary:**

Aggregate local-tooling costs exceed customization benefits when three structural multipliers reach a combined threshold: tool footprint per team exceeds the organisation's administrative absorption capacity, shared dependency density creates coordination overhead that compounds with each additional tool, and staff turnover exposes the knowledge-concentration risk embedded in undocumented locally owned tooling. The crossover is not a universal numeric trigger but a function of these interacting variables that can be detected early through five proxy metrics that most organisations already collect: support ticket volume growth per tool, new-hire time-to-productivity relative to team complexity, shadow-spend growth rate relative to headcount, incident attribution to non-standard tooling, and downstream queue growth rate relative to upstream delivery rate growth. No universal numeric threshold is established by the evidence; rather, the crossover is signalled when the rate of hidden-cost accumulation in these proxies exceeds the rate at which direct productivity benefits are being measured and attributed.

**Key findings:**

1. Local tooling creates four categories of benefit (agility, fit-for-purpose, reduced central-IT dependency, innovation velocity) and five categories of cost (maintenance burden, integration friction, key-person concentration, security and compliance exposure, duplicate spend) that are not captured symmetrically in most organisations' measurement systems.
2. The costs most likely to remain hidden until material scale are informal peer support time, new-hire onboarding friction, key-person concentration risk, and integration rework cost, because all four are absorbed into undifferentiated overhead rather than attributed to the originating tool.
3. Shadow IT research identifies that governance maturity (documented ownership, exit procedures, security review) reduces the coordination cost of a locally owned tool more than any capability feature of the tool itself.
4. Three structural multipliers accelerate the crossover from net-positive to net-negative: team scale (each additional team adds its own tool estate), shared dependency density (tools that feed downstream processes impose their complexity on all consumers), and staff turnover (bus factor declines with each undocumented key-person departure).
5. Faros AI telemetry across 22,000 developers shows the crossover in real-time: individual task completion rose 33.7% while PR review time rose 441% and production incidents per PR rose 242.7%, a pattern consistent with local tooling gains flooding shared constraint infrastructure.
6. DORA 2025 identifies seven capabilities required for local productivity gains to translate into organisational performance gains; all seven are concerned with reducing the coupling and queue-flooding dynamics that cause the crossover.
7. Five leading indicators are detectable with data most knowledge-work organisations already collect before the crossover has been formally reached: support-ticket volume growth per tool, new-hire time-to-productivity, shadow-spend growth, integration failure frequency, and downstream queue growth relative to upstream delivery growth.
8. The governance-transition literature supports a sixth leading indicator specific to knowledge concentration: bus factor distribution across the locally owned tool estate, trackable via a tool-by-knowledge-holder matrix.
9. No peer-reviewed study provides a universal numeric crossover threshold; the evidence consistently identifies the crossover as context-dependent on the three structural multipliers rather than on a fixed tool count or team size.
10. The decision frame that integrates these findings has two practical limits: it requires attribution discipline (tagging support, onboarding, and incident data to tool category and ownership type) that most organisations currently lack, and organisations below a minimum scale threshold may find the governance-attribution investment exceeds the fragmentation cost it reveals.
...
| [fact] Gartner: shadow IT is 30-40% of IT spend in large enterprises; 75% of employees using tools outside IT visibility by 2027 | https://www.techfinitive.com/features/how-to-keep-shadow-it-costs-under-control/; https://www.valencesecurity.com/resources/blogs/gartner-saas-applications-outside-of-it | medium | Secondary sources citing Gartner; no direct Gartner report URL available |
...
The evidence resolves around a single structural finding: local tooling fragmentation costs are hidden not because they are small but because the measurement and attribution systems in most organisations are not designed to reveal them. [inference; source: https://aisel.aisnet.org/ijispm/vol7/iss1/3/; https://link.springer.com/article/10.1007/s10257-020-00472-6]

The Faros AI data provides the most direct empirical test of the crossover in a live setting. [inference; source: https://www.faros.ai/blog/key-takeaways-from-the-dora-report-2025] The 441% rise in PR review time against a 33.7% rise in task completion is the operational signature of the crossover: local tooling gains have been converted from delivered output into queue depth at the shared constraint. This is the predictable outcome when TOC subordination is absent: non-constraint resources accelerate, flooding the constraint with more work than it can process. [inference; source: https://fortelabs.com/blog/theory-of-constraints-102-local-optima/; https://www.faros.ai/blog/key-takeaways-from-the-dora-report-2025]

The dominant rival explanation is that the Faros data reflects a transition period in which review processes have not yet caught up with the new throughput level. This is possible, and DORA 2025 frames it this way, arguing that organisations with strong platform engineering do eventually capture the local gains as system-level performance. [inference; source: https://dora.dev/research/2025/dora-report/] The rival explanation does not refute the crossover claim; it relocates it in time. The transition-period argument means the crossover is temporary if organisations invest in shared constraint capacity; it does not mean the crossover does not occur.

The governance-transition literature's finding that documentation and ownership maturity reduces coordination cost is particularly actionable because it implies that the crossover can be deferred or reversed without requiring tool consolidation. [inference; source: https://link.springer.com/article/10.1007/s10257-020-00472-6] An organisation that documents ownership, defines exit procedures, and maintains a current tool inventory does not eliminate fragmentation cost but it makes that cost visible, attributable, and manageable, which is the precondition for any consolidation or governance decision. The measurement frame proposed in D1 above depends on this documentation layer existing. [inference; source: https://aisel.aisnet.org/ijispm/vol7/iss1/3/; https://link.springer.com/article/10.1007/s10257-020-00472-6]
...
Aggregate local-tooling costs exceed customization benefits when three structural multipliers reach a combined threshold: tool footprint per team exceeds the organisation's administrative absorption capacity, shared dependency density creates coordination overhead that compounds with each additional tool, and staff turnover exposes the knowledge concentration risk embedded in undocumented locally owned tooling. [inference; source: https://aisel.aisnet.org/ijispm/vol7/iss1/3/; https://link.springer.com/article/10.1007/s10257-020-00472-6] The crossover is not a universal numeric trigger but a function of these interacting variables, detectable early through five proxy metrics that most organisations already collect: support ticket volume growth per tool, new-hire time-to-productivity relative to team complexity, shadow-spend growth rate, incident attribution to non-standard tooling, and downstream queue growth rate relative to upstream delivery rate growth. [inference; source: https://aisel.aisnet.org/ijispm/vol7/iss1/3/; https://www.faros.ai/blog/key-takeaways-from-the-dora-report-2025] Faros AI telemetry across 22,000 developers documents the crossover signature in real-time: individual task completion rose 33.7% while PR review time rose 441% and production incidents per PR rose 242.7%, confirming that local tooling gains can flood shared constraint infrastructure without requiring a formal threshold calculation to detect the problem. [inference; source: https://www.faros.ai/blog/key-takeaways-from-the-dora-report-2025] The governance-transition literature adds that documentation and ownership maturity reduces fragmentation cost more than any capability feature of the tool itself, making governance investment the most actionable first response when leading indicators begin to rise. [inference; source: https://link.springer.com/article/10.1007/s10257-020-00472-6]

### Key Findings

1. **Local tooling creates four categories of benefit and five categories of cost that are not captured symmetrically, and the costs most likely to remain hidden until material scale are informal peer support time, onboarding friction, key-person concentration, and integration rework cost because all four are absorbed into undifferentiated overhead rather than attributed to the originating tool.** ([inference]; medium confidence; source: https://aisel.aisnet.org/ijispm/vol7/iss1/3/; https://link.springer.com/article/10.1007/s10257-020-00472-6)

2. **Shadow IT accounts for an estimated 30 to 40 percent of total IT spend in large enterprises according to Gartner research, and is projected to reach 75 percent of employees creating or modifying technology outside IT visibility by 2027, suggesting the aggregate cost is already economically material before any crossover calculation is applied.** ([fact]; medium confidence; source: https://www.techfinitive.com/features/how-to-keep-shadow-it-costs-under-control/; https://www.valencesecurity.com/resources/blogs/gartner-saas-applications-outside-of-it)
...
4. **Faros AI telemetry across 22,000 developers in AI-assisted delivery teams measured individual task completion rising 33.7% while PR review time rose 441% and production incidents per PR rose 242.7%, a pattern consistent with local tooling gains flooding shared review infrastructure without corresponding capacity increases.** ([inference]; medium confidence; source: https://www.faros.ai/blog/key-takeaways-from-the-dora-report-2025)
...
7. **A sixth leading indicator specific to knowledge concentration is bus factor distribution across the locally owned tool estate, measurable via a tool-by-knowledge-holder matrix and tracking the number of tools with a bus factor of 1 or 2 as a portfolio-level concentration index over time.** ([inference]; medium confidence; source: https://link.springer.com/article/10.1007/s10257-020-00472-6)

8. **Governance maturity (documented ownership, exit procedures, security review) reduces the coordination cost of a locally owned tool more than any capability feature of the tool itself, because ownership maturity determines whether the tool can be rapidly decommissioned or transitioned when the key person leaves.** ([inference]; medium confidence; source: https://link.springer.com/article/10.1007/s10257-020-00472-6)

9. **DORA 2024 found that 76 percent of high-performance delivery organisations have dedicated platform engineering teams, and that internal developer platforms correlating with user-centred design produce 8 percent higher individual productivity and 10 percent higher team performance, while poorly designed platforms reduce stability.** ([fact]; medium confidence; source: https://dora.dev/research/2024/dora-report/; https://platformengineering.com/features/dora-2025-ai-wont-save-you-without-a-solid-platform/)
...
| [fact] Shadow IT estimated at 30-40% of IT spend; 75% of employees using outside-IT tools by 2027 | https://www.techfinitive.com/features/how-to-keep-shadow-it-costs-under-control/; https://www.valencesecurity.com/resources/blogs/gartner-saas-applications-outside-of-it | medium | Secondary citations of Gartner research |
...
| [inference] Faros data: individual +33.7%, PR review +441%, incidents/PR +242.7%; crossover signature | https://www.faros.ai/blog/key-takeaways-from-the-dora-report-2025 | medium | Single commercial vendor; 22,000 developers |
...
- **The Faros AI telemetry represents a plausible real-world test of the crossover in action.** The organisational conditions (individual productivity rising while shared infrastructure is not scaled) are the theoretical crossover conditions described in both the shadow IT literature and the TOC framework. The population over-represents GitHub-hosted software delivery teams. [assumption; source: https://www.faros.ai/blog/key-takeaways-from-the-dora-report-2025]
...
The Faros AI data provides the most direct empirical test of the crossover in a live setting. [inference; source: https://www.faros.ai/blog/key-takeaways-from-the-dora-report-2025] The 441% rise in PR review time against a 33.7% rise in task completion is the operational signature of the crossover: local tooling gains have been converted from delivered output into queue depth at the shared constraint, consistent with the TOC mechanism documented in the prior repository item on local-global optima. [inference; source: https://www.faros.ai/blog/key-takeaways-from-the-dora-report-2025; https://davidamitchell.github.io/Research/research/2026-06-13-local-global-optima-knowledge-work-throughput.html]

The dominant rival explanation is that the Faros data reflects a transition period in which review processes have not yet adapted to the new throughput level, and that with investment in shared constraint capacity, organisations can eventually capture the local gains as system-level performance. [inference; source: https://dora.dev/research/2025/dora-report/] This rival is consistent with TOC's fourth step (elevate the constraint) and with DORA 2025's finding that organisations with strong platform engineering do convert AI gains into system-level improvement. [inference; source: https://dora.dev/research/2025/dora-report/] The rival does not eliminate the crossover claim; it relocates it in time: the crossover is temporary if and only if organisations actively invest in shared constraint capacity, which is itself the governance intervention the measurement frame exists to trigger. [inference; source: https://aisel.aisnet.org/ijispm/vol7/iss1/3/; https://dora.dev/research/2025/dora-report/]

The governance-transition literature's finding that documentation and ownership maturity reduces coordination cost is the most actionable implication. [inference; source: https://link.springer.com/article/10.1007/s10257-020-00472-6] An organisation that documents ownership, defines exit procedures, and maintains a current tool inventory does not eliminate fragmentation cost but it makes that cost visible, attributable, and manageable, which is the precondition for any consolidation or shared-constraint-capacity decision. [inference; source: https://aisel.aisnet.org/ijispm/vol7/iss1/3/; https://link.springer.com/article/10.1007/s10257-020-00472-6]
