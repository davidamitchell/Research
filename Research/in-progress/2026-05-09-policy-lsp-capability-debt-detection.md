...
- [DEFINITION NEEDED] [assumption; source: https://microsoft.github.io/language-server-protocol/; https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html] This item uses "Policy-LSP" only as repository shorthand for an LSP-style policy-diagnostic surface that emits machine-readable conformance findings during development or delivery.
- [DEFINITION NEEDED] [inference; source: https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-agentic-ai-risk-synthesis.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html; https://cloud.google.com/resources/content/2025-dora-ai-capabilities-model-report] This item uses "capability debt" only as repository shorthand for a persistent mismatch between workflow requirements and the workforce, tooling, and control coverage available to satisfy them.
...
- [inference; source: https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-agentic-ai-risk-synthesis.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html; https://cloud.google.com/resources/content/2025-dora-ai-capabilities-model-report] The most defensible interpretation is therefore that the repository shorthand "capability debt" names a detection outcome produced when required capability patterns and observed capability coverage remain misaligned over time.
...
1. **The evidence supports treating the repository label "Policy-LSP" as an LSP-style policy diagnostic surface over structured policy decisions, because no separately standardized external framework with its own authoritative specification was found.** ([inference]; medium confidence; source: https://microsoft.github.io/language-server-protocol/; https://microsoft.github.io/language-server-protocol/specifications/specification-current/; https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html)
