---
title: "Language Server Protocol (LSP)-style policy surface and workforce taxonomies for automatic capability-debt detection"
...
# Language Server Protocol (LSP)-style policy surface and workforce taxonomies for automatic capability-debt detection

## Research Question

How can workforce-capacity and skills-taxonomy structures integrate with a Policy-LSP framework, meaning a Language Server Protocol (LSP)-style policy diagnostic surface, to detect capability debt automatically in enterprise delivery pipelines? [assumption; source: https://microsoft.github.io/language-server-protocol/; https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html]

## Scope

**In scope:**
- Conceptual integration model between policy logic and workforce taxonomy structures
- Detection criteria for capability debt signals
...
Prior completed items in this repository already argue that systems-capability debt drives shadow tooling and that unmanaged workforce artifacts become a control and operational-risk surface when they carry business-critical decisions. [fact; source: https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-agentic-ai-risk-synthesis.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html; https://davidamitchell.github.io/Research/research/2026-05-09-basel-iso-nist-shadow-workforce-risk-classification.html]

The remaining gap is prospective detection: a repeatable way to join policy requirements, delivery-pipeline evidence, and workforce-taxonomy coverage so capability debt is surfaced before it matures into shadow-system or resilience failures. [inference; source: https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html; https://davidamitchell.github.io/Research/research/2026-03-21-technology-capability-models.html; https://davidamitchell.github.io/Research/research/2026-04-27-pdp-universal-policy-synchronisation-integrity.html]

## Approach

1. Define capability debt indicators relevant to workforce planning.
...
- [x] [Microsoft (n.d.) Language Server Protocol](https://microsoft.github.io/language-server-protocol/) - official overview of the protocol and its client-server model
- [x] [Microsoft (n.d.) Language Server Protocol Specification 3.17](https://microsoft.github.io/language-server-protocol/specifications/specification-current/) - authoritative specification for diagnostics and client-server notifications
- [x] [Open Policy Agent (n.d.) Documentation](https://www.openpolicyagent.org/docs/latest/) - primary source on structured policy inputs and outputs
- [x] [Open Policy Agent (n.d.) Decision Logs](https://www.openpolicyagent.org/docs/latest/management-decision-logs/) - primary source on decision identifiers, bundle revisions, and audit fields
- [x] [Amazon Web Services (n.d.) Verified Permissions terminology](https://docs.aws.amazon.com/verifiedpermissions/latest/userguide/terminology.html) - primary source on authorization requests, responses, entity data, and determining policies
- [x] [SFIA Foundation (2024) Skills Framework for the Information Age (SFIA) framework landing page](https://sfia-online.org/en/framework/sfia-8) - official description of SFIA 9 as the current framework and its role structure
- [x] [SFIA Foundation (2024) Skills Framework for the Information Age (SFIA) 9 skills A-Z](https://sfia-online.org/en/sfia-9/skills/all-skills-a-z) - official structured skill catalog with codes and descriptions
- [x] [National Institute of Standards and Technology (NIST) (2026) National Initiative for Cybersecurity Education (NICE) Framework Resource Center](https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center) - official overview of NICE workforce-planning uses
- [x] [National Institute of Standards and Technology (NIST) (2026) National Initiative for Cybersecurity Education (NICE) Framework FAQ](https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center/about/faq) - official description of Work Role Categories, Work Roles, Competency Areas, and Task, Knowledge, and Skill statements
- [x] [ISACA (n.d.) Control Objectives for Information and Related Technology (COBIT)](https://www.isaca.org/resources/cobit) - official overview of COBIT 2019 governance and management objectives
- [x] [Google Cloud (2025) DevOps Research and Assessment (DORA) Artificial Intelligence (AI) capabilities model report](https://cloud.google.com/resources/content/2025-dora-ai-capabilities-model-report) - primary source on foundational capabilities, platform teams, and AI as an amplifier
- [x] [National Institute of Standards and Technology (NIST) (2026) Artificial Intelligence Risk Management Framework (AI RMF) Playbook](https://www.nist.gov/itl/ai-risk-management-framework/nist-ai-rmf-playbook) - official guidance on Govern, Map, Measure, and Manage functions
- [x] [Mitchell (2026) Guiding Headless Agents via LSP-Like Mechanisms for Org Policy Conformance](https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html) - prior completed item defining the repository's Policy-LSP pattern
- [x] [Mitchell (2026) Technology Capability Models: Survey, Comparison, and Recommendation for Multi-Level IT Capability Mapping](https://davidamitchell.github.io/Research/research/2026-03-21-technology-capability-models.html) - prior completed item on capability-taxonomy layering
- [x] [Mitchell (2026) Systems capability debt, citizen development, and agentic Artificial Intelligence (AI) risk: is the causal chain and sequencing imperative a novel contribution?](https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-agentic-ai-risk-synthesis.html) - prior completed synthesis on capability-debt causation
- [x] [Mitchell (2026) Systems capability debt as the root cause of citizen development: empirical evidence and effective governance architectures](https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html) - prior completed empirical item on capability gaps and workaround estates
- [x] [Mitchell (2026) Basel Committee on Banking Supervision (BCBS), International Organization for Standardization (ISO), and National Institute of Standards and Technology (NIST): classifying shadow workforce-system risk](https://davidamitchell.github.io/Research/research/2026-05-09-basel-iso-nist-shadow-workforce-risk-classification.html) - prior completed classification of unmanaged workforce data risk
- [x] [Mitchell (2026) Universal policy synchronisation and integrity: ensuring the Policy Decision Point (PDP) evaluates governed assets against logically identical policy across all lifecycle phases](https://davidamitchell.github.io/Research/research/2026-04-27-pdp-universal-policy-synchronisation-integrity.html) - prior completed item on policy-surface consistency across lifecycle phases

## Related

- [Mitchell (2026) Guiding Headless Agents via LSP-Like Mechanisms for Org Policy Conformance](https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html)
- [Mitchell (2026) Technology Capability Models: Survey, Comparison, and Recommendation for Multi-Level IT Capability Mapping](https://davidamitchell.github.io/Research/research/2026-03-21-technology-capability-models.html)
- [Mitchell (2026) Systems capability debt as the root cause of citizen development: empirical evidence and effective governance architectures](https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html)
...
- Question: How can a Language Server Protocol (LSP)-style policy diagnostic surface combine with workforce taxonomies to detect capability debt automatically in enterprise delivery pipelines?
...
- [fact; source: https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html; https://davidamitchell.github.io/Research/research/2026-03-21-technology-capability-models.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-agentic-ai-risk-synthesis.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html; https://davidamitchell.github.io/Research/research/2026-05-09-basel-iso-nist-shadow-workforce-risk-classification.html] Prior completed-item review found adjacent repository work on LSP-like policy guidance, multi-level capability models, systems-capability debt, and shadow workforce-system risk, but no completed item joins those strands into an automated detection model.
- [assumption; source: https://microsoft.github.io/language-server-protocol/; https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html] This item treats "Policy-LSP" as repository shorthand for an LSP-style policy-diagnostic surface that emits machine-readable conformance findings during development or delivery, not as an externally standardized named framework.

### §1 Question Decomposition

```text
Q: How can workforce taxonomies integrate with an LSP-style policy surface to detect capability debt automatically?
...
├── Q3: What exactly is capability debt in this context?
...
- [assumption; source: https://microsoft.github.io/language-server-protocol/; https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html] Failed primary-source search record: query `"Policy-LSP"` and query `"Policy-LSP framework"` did not identify an external standard or vendor framework, so the term is handled as repository shorthand anchored to the official Language Server Protocol (LSP) specification and the prior completed repository item.
...
#### C. Capability debt definition and observable indicators

- [fact; source: https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-agentic-ai-risk-synthesis.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html] Prior completed repository work argues that systems-capability debt is the accumulated gap between operational need and what formal systems, processes, and controls can actually support, and that this gap drives workaround behavior such as citizen development and shadow tooling.
...
- [inference; source: https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-agentic-ai-risk-synthesis.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html; https://cloud.google.com/resources/content/2025-dora-ai-capabilities-model-report] In this item, capability debt is best treated as the persistent mismatch between the capability pattern a governed workflow requires and the capability pattern the workforce, tooling estate, and control environment can actually supply.
...
- [inference; source: https://www.isaca.org/resources/cobit; https://cloud.google.com/resources/content/2025-dora-ai-capabilities-model-report; https://www.nist.gov/itl/ai-risk-management-framework/nist-ai-rmf-playbook] A capability-debt detector should sit in a governance loop that separates ownership of taxonomy quality, policy quality, and workforce planning, because the detector only becomes trustworthy when its inputs are governed, measured, and remediated by named functions.
- [inference; source: https://microsoft.github.io/language-server-protocol/specifications/specification-current/; https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html; https://www.nist.gov/itl/ai-risk-management-framework/nist-ai-rmf-playbook] The development and delivery posture should default to soft diagnostics and escalation rather than unconditional hard blocking, because many capability-debt findings indicate structural planning gaps that need review and remediation rather than immediate automated denial of all work.
- [assumption; source: https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center/about/faq; https://sfia-online.org/en/sfia-9/skills/all-skills-a-z; https://www.nist.gov/itl/ai-risk-management-framework/nist-ai-rmf-playbook] Automated detection is only defensible if the workforce capability inventory is sufficiently current and governed; stale or manager-entered self-ratings would otherwise turn the detector into a noisy proxy for documentation quality rather than true capability debt.
...
- [inference; source: https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center/about/faq; https://sfia-online.org/en/sfia-9/skills/all-skills-a-z; https://www.openpolicyagent.org/docs/latest/management-decision-logs/] Capability debt becomes machine-detectable only after those building blocks are joined on shared identifiers or an explicit mapping layer, because isolated policy or workforce data cannot reveal persistent requirement-coverage mismatches by itself.
- [inference; source: https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-agentic-ai-risk-synthesis.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html; https://cloud.google.com/resources/content/2025-dora-ai-capabilities-model-report] The most defensible interpretation is therefore not that capability debt is a new taxonomy element, but that it is a detection outcome produced when required capability patterns and observed capability coverage remain misaligned over time.
...
1. **The evidence supports treating Policy-LSP as an LSP-style policy diagnostic surface over structured policy decisions, rather than as a separately standardized external framework with its own authoritative specification.** ([inference]; medium confidence; source: https://microsoft.github.io/language-server-protocol/; https://microsoft.github.io/language-server-protocol/specifications/specification-current/; https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html)
2. **The NICE Framework and SFIA provide complementary workforce-taxonomy structures because NICE decomposes work into roles, tasks, and Task, Knowledge, and Skill statements, while SFIA normalizes reusable skills, codes, and responsibility levels across role profiles.** ([fact]; high confidence; source: https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center; https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center/about/faq; https://sfia-online.org/en/framework/sfia-8; https://sfia-online.org/en/sfia-9/skills/all-skills-a-z)
3. **Modern policy engines already emit the structured request, response, revision, and audit fields needed for automated capability-debt detection, so the missing layer is data joining and diagnostic presentation, not a new policy-calculation primitive.** ([fact]; high confidence; source: https://www.openpolicyagent.org/docs/latest/; https://www.openpolicyagent.org/docs/latest/management-decision-logs/; https://docs.aws.amazon.com/verifiedpermissions/latest/userguide/terminology.html)
4. **Capability debt becomes prospectively detectable when policy-required capabilities and actual workforce coverage stay misaligned across repeated workflow executions, especially when the same missing-role, missing-skill, override, or exception patterns recur across time and teams.** ([inference]; medium confidence; source: https://www.openpolicyagent.org/docs/latest/management-decision-logs/; https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center/about/faq; https://sfia-online.org/en/sfia-9/skills/all-skills-a-z; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-agentic-ai-risk-synthesis.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html)
5. **The minimum viable detection model needs four versioned objects, governed workflow definitions, policy requirement objects, workforce capability records, and execution evidence, because comparing any one of those in isolation cannot distinguish structural debt from one-off operational noise.** ([inference]; medium confidence; source: https://www.openpolicyagent.org/docs/latest/; https://www.openpolicyagent.org/docs/latest/management-decision-logs/; https://docs.aws.amazon.com/verifiedpermissions/latest/userguide/terminology.html; https://davidamitchell.github.io/Research/research/2026-03-21-technology-capability-models.html; https://davidamitchell.github.io/Research/research/2026-04-27-pdp-universal-policy-synchronisation-integrity.html)
6. **Governance frameworks imply that capability-debt detection should primarily feed Govern, Map, Measure, and Manage loops, workforce planning, and platform investment decisions, because AI and automation amplify weak foundations instead of compensating for them.** ([inference]; medium confidence; source: https://www.isaca.org/resources/cobit; https://www.nist.gov/itl/ai-risk-management-framework/nist-ai-rmf-playbook; https://cloud.google.com/resources/content/2025-dora-ai-capabilities-model-report)
7. **This item extends prior repository work by turning systems-capability debt and shadow workforce-system risk from retrospective diagnosis into a prospective, machine-assisted detection pattern that can run inside delivery pipelines or policy review loops.** ([inference]; medium confidence; source: https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-agentic-ai-risk-synthesis.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html; https://davidamitchell.github.io/Research/research/2026-05-09-basel-iso-nist-shadow-workforce-risk-classification.html)

**Evidence map:**

| claim | source | confidence | notes |
|---|---|---|---|
| [inference] Policy-LSP is best treated as an LSP-style diagnostic surface, not an external standard. | https://microsoft.github.io/language-server-protocol/; https://microsoft.github.io/language-server-protocol/specifications/specification-current/; https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html | medium | term-resolution |
| [fact] NICE and SFIA provide complementary workforce-taxonomy structures. | https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center; https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center/about/faq; https://sfia-online.org/en/framework/sfia-8; https://sfia-online.org/en/sfia-9/skills/all-skills-a-z | high | role plus skill layering |
| [fact] Structured policy-engine outputs already expose the fields needed for detection. | https://www.openpolicyagent.org/docs/latest/; https://www.openpolicyagent.org/docs/latest/management-decision-logs/; https://docs.aws.amazon.com/verifiedpermissions/latest/userguide/terminology.html | high | policy primitives exist |
| [inference] Repeated requirement-coverage mismatches make capability debt prospectively detectable. | https://www.openpolicyagent.org/docs/latest/management-decision-logs/; https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center/about/faq; https://sfia-online.org/en/sfia-9/skills/all-skills-a-z; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-agentic-ai-risk-synthesis.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html | medium | detection logic |
...
| [inference] The item converts prior debt and shadow-system findings into a prospective detection pattern. | https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-agentic-ai-risk-synthesis.html; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html; https://davidamitchell.github.io/Research/research/2026-05-09-basel-iso-nist-shadow-workforce-risk-classification.html | medium | cross-item extension |

**Assumptions:**

- [assumption; source: https://microsoft.github.io/language-server-protocol/; https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html] "Policy-LSP" is treated as a repository-specific name for an LSP-style policy surface because no external standard using that exact term was located.
...
The most decision-useful detection signals are the repeated ones, not single denials, because structural debt is about persistent mismatch between required and available capability rather than isolated momentary shortage. [inference; source: https://www.openpolicyagent.org/docs/latest/management-decision-logs/; https://davidamitchell.github.io/Research/research/2026-04-26-systems-capability-debt-citizen-development-empirical-evidence.html]

A competing explanation is that repeated findings could reflect stale inventories or temporary workload spikes rather than structural debt, so the detector should only escalate when the same mismatch persists across time windows, revisions, or multiple workflows. [inference; source: https://www.openpolicyagent.org/docs/latest/management-decision-logs/; https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center/about/faq; https://sfia-online.org/en/sfia-9/skills/all-skills-a-z]
...
- [assumption; source: https://microsoft.github.io/language-server-protocol/; https://davidamitchell.github.io/Research/research/2026-03-01-agent-lsp-policy-enforcement.html] The exact term "Policy-LSP" is repository-specific rather than externally standardized, so implementation details remain inferential even though the component parts are well supported.
...
- What threshold of repeated missing-capability diagnostics best separates structural capability debt from seasonal load spikes or project-specific staffing gaps?
...
- What evaluation design would prove that early capability-debt diagnostics reduce shadow-system growth or exception volume in practice?
...
- Type: knowledge
- Description: A conceptual detection model that joins LSP-style policy diagnostics, structured policy-engine outputs, and workforce taxonomies to surface capability debt in enterprise delivery pipelines. [inference; source: https://microsoft.github.io/language-server-protocol/specifications/specification-current/; https://www.openpolicyagent.org/docs/latest/management-decision-logs/; https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center/about/faq; https://sfia-online.org/en/sfia-9/skills/all-skills-a-z]
- Links:
  - https://microsoft.github.io/language-server-protocol/specifications/specification-current/
  - https://www.openpolicyagent.org/docs/latest/management-decision-logs/
  - https://www.nist.gov/itl/applied-cybersecurity/nice/nice-framework-resource-center/about/faq
