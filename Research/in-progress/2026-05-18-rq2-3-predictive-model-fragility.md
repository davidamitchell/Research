...
- [inference] The formal distinction is therefore not merely accuracy versus inaccuracy, but perturbation-resilient mechanism versus observational adequacy without any guarantee that the same relation survives nearby worlds. [source: http://www.scholarpedia.org/article/Structural_stability; https://arxiv.org/abs/1907.02893; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-2-duhem-quine-underdetermination.md]
...
8. [inference] This item therefore extends Research Questions 2.1 and 2.2 by showing that causal blindness and underdetermination have a dynamical consequence, namely qualitative fragility under perturbation when no invariant mechanism has been learned. [source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-1-erm-causal-blindness.md; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-2-duhem-quine-underdetermination.md; http://www.scholarpedia.org/article/Structural_stability]
...
The formal distinction is therefore not merely accuracy versus inaccuracy, but perturbation-resilient mechanism versus observational adequacy without any guarantee that the same relation survives nearby worlds. [inference; source: http://www.scholarpedia.org/article/Structural_stability; https://arxiv.org/abs/1907.02893; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-2-duhem-quine-underdetermination.md]

### Key Findings

1. **Structural stability is a property of the governing dynamical system, not of one observed trajectory, because it asks whether nearby vector fields preserve the same qualitative orbit structure up to topological equivalence.** ([fact]; high confidence; source: http://www.scholarpedia.org/article/Structural_stability)
2. **The planar Andronov-Pontryagin criterion ties that stability to hyperbolic equilibria and periodic orbits together with the absence of saddle connections, which are exactly the conditions that block qualitative phase-portrait change under small perturbations.** ([fact]; high confidence; source: http://www.scholarpedia.org/article/Structural_stability)
3. **Purely predictive machine-learning pipelines are often underspecified, meaning they can produce multiple models with equally strong held-out performance that nevertheless diverge in deployment.** ([fact]; high confidence; source: https://www.jmlr.org/papers/v23/20-1335.html)
...
8. **This item therefore extends Research Questions 2.1 and 2.2 by showing that causal blindness and underdetermination have a dynamical consequence, namely qualitative fragility under perturbation when no invariant mechanism has been learned.** ([inference]; medium confidence; source: https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-1-erm-causal-blindness.md; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-18-rq2-2-duhem-quine-underdetermination.md; http://www.scholarpedia.org/article/Structural_stability)
