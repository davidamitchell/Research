...
3. **Hot reload is only reliable when extensions can teardown and rebuild state explicitly, and both Pi and JetBrains documentation warn that stale references, leaked resources, and old call frames can survive reload boundaries if the lifecycle is underspecified.** ([fact]; high confidence; source: https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/extensions.md; https://plugins.jetbrains.com/docs/intellij/dynamic-plugins.html)
...
6. **Pi currently represents the most expressive live-session model in the comparison set, because its extensions can override built-in tools, rewrite provider transport, intercept tool calls, customize compaction, and hot-reload from project directories.** ([fact]; high confidence; source: https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/extensions.md; https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/custom-provider.md; https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/compaction.md)
...
8. **VS Code is the strongest reference architecture for ecosystem-scale extension governance, because it pairs broad contribution surfaces with multiple extension hosts, lazy activation, browser-sandboxed web extensions, publication tooling, user-experience guidance, and sample repositories.** ([inference]; medium confidence; source: https://code.visualstudio.com/api; https://code.visualstudio.com/api/references/activation-events; https://code.visualstudio.com/api/advanced-topics/extension-host; https://code.visualstudio.com/api/extension-guides/web-extensions; https://code.visualstudio.com/api/working-with-extensions/publishing-extension; https://code.visualstudio.com/api/ux-guidelines/overview; https://github.com/microsoft/vscode-extension-samples)
...
| [fact] Reliable reload depends on teardown and state reconstruction. | https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/extensions.md; https://plugins.jetbrains.com/docs/intellij/dynamic-plugins.html | high | Direct lifecycle documentation |
...
| [fact] Pi offers the broadest live-session extension power in the comparison. | https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/extensions.md; https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/custom-provider.md; https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/compaction.md | high | Surface-comparison claim |
...
| [inference] VS Code is the strongest reference architecture for ecosystem-scale governance. | https://code.visualstudio.com/api; https://code.visualstudio.com/api/references/activation-events; https://code.visualstudio.com/api/advanced-topics/extension-host; https://code.visualstudio.com/api/extension-guides/web-extensions; https://code.visualstudio.com/api/working-with-extensions/publishing-extension; https://code.visualstudio.com/api/ux-guidelines/overview; https://github.com/microsoft/vscode-extension-samples | medium | Ecosystem-scale synthesis |
