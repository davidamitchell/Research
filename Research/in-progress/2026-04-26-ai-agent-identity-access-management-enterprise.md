...
- [x] [NIST SP 800-63-3 Digital Identity Guidelines landing page](https://pages.nist.gov/800-63-3/) - seeded source; confirms the suite and that SP 800-63-3 is now superseded by SP 800-63-4.
...
- [x] [RFC 8693, OAuth 2.0 Token Exchange](https://www.rfc-editor.org/rfc/rfc8693) - primary standard for delegation vs impersonation semantics and actor-aware token exchange.
...
2. **High confidence.** [fact; source: https://www.rfc-editor.org/rfc/rfc8693] User-initiated agent actions should prefer delegation semantics over impersonation, because delegation preserves both the original subject and the acting party while impersonation makes the acting party indistinguishable from the delegated subject inside the token context.
