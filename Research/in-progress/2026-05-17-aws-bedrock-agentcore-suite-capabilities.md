...
3. **Gateway plus Policy is the suite's main tool-governance surface, because AWS documents target translation, semantic tool discovery, interceptor-based authorization, and Cedar, a language for writing authorization policies, as the pre-execution policy layer at the agent-to-tool boundary.** ([fact]; medium confidence; source: https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/gateway.html; https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/gateway-fine-grained-access-control.html; https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/policy.html; https://docs.cedarpolicy.com/)
...
| [fact] Gateway plus Policy implements tool discovery, translation, and pre-execution authorization at the agent-to-tool boundary through Cedar, a language for writing authorization policies. | https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/gateway.html; https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/gateway-fine-grained-access-control.html; https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/policy.html; https://docs.cedarpolicy.com/ | Medium | Direct boundary-control evidence |
