...
- Gray-box delegation, meaning a human developer defines the contract, examples, tests, and type boundaries while delegating most implementation detail to an AI assistant
...
3. **Examine gray-box delegation** - Search for interface-first, type-first, test-first, and specification-first guidance for AI coding, and assess whether the pattern is directly evidenced or mainly inferential.
...
- **C. Gray-box delegation**
  ...
  - C2. Is gray-box delegation a named, evidenced pattern or mainly a synthesis from adjacent practices?
...
#### C. Interface-first and gray-box delegation evidence
...
- [inference; source: http://sunnyday.mit.edu/16.355/parnas-criteria.html; https://web.stanford.edu/~ouster/cgi-bin/cs190-winter18/lecture.php?topic=modularDesign; https://www.anthropic.com/engineering/claude-code-best-practices; https://arxiv.org/html/2511.09268v1] Artificial Intelligence (AI) coding agents are directionally more effective in codebases built from deep modules with explicit interfaces than in shallow, densely coupled codebases, but current evidence supports a qualitative improvement rather than a measured universal multiplier.
- [inference; source: https://www.totaltypescript.com/should-you-declare-return-types; https://www.anthropic.com/engineering/claude-code-best-practices; https://github.blog/ai-and-ml/github-copilot/how-to-build-reliable-ai-workflows-with-agentic-primitives-and-context-engineering/; https://davidamitchell.github.io/Research/research/2026-03-16-intent-driven-development.html] The best-supported delegation pattern is gray-box rather than black-box: humans define interfaces, types, tests, examples, and architectural rules, while the AI handles more of the implementation search inside that boundary.
- [inference; source: https://martinfowler.com/books/refactoring.html; https://codescene.com/blog/change-coupling-visualize-the-cost-of-change; https://codescene.com/blog/measure-code-health-of-your-codebase; https://www.atlassian.com/blog/development/how-to-effectively-utilise-ai-to-enhance-large-scale-refactoring] A ball-of-mud codebase can be rescued incrementally, but the credible path is hotspot-first and batch-validated rather than a one-shot rewrite.
- [inference; source: https://www.atlassian.com/blog/development/how-to-effectively-utilise-ai-to-enhance-large-scale-refactoring; https://davidamitchell.github.io/Research/research/2026-04-30-ai-code-entropy-quality-metrics.html] The effort-versus-benefit ratio is therefore highly uneven: modest architectural work on high-churn boundaries can produce outsized gains, while whole-repository rescue becomes progressively more expensive as hidden coupling, duplication, and code-health decline accumulate.

**Key findings:**

1. [fact; source: https://arxiv.org/html/2511.09268v1; https://www.anthropic.com/engineering/claude-code-best-practices] No accessible study found in this session directly benchmarks AI performance on otherwise comparable deep-module and shallow-module codebases, so any claim about exact magnitude must be treated as unquantified.
...
7. [fact; source: https://martinfowler.com/books/refactoring.html; https://codescene.com/blog/change-coupling-visualize-the-cost-of-change; https://codescene.com/blog/measure-code-health-of-your-codebase; https://www.atlassian.com/blog/development/how-to-effectively-utilise-ai-to-enhance-large-scale-refactoring] Ball-of-mud rescue is feasible through iterative refactoring, hotspot prioritization, persistent context, and small validated batches, and current evidence does not support blind whole-repository rewrites as the default strategy.
8. [inference; source: https://www.atlassian.com/blog/development/how-to-effectively-utilise-ai-to-enhance-large-scale-refactoring; https://davidamitchell.github.io/Research/research/2026-04-30-ai-code-entropy-quality-metrics.html; https://codescene.com/blog/measure-code-health-of-your-codebase] The payoff from rescue is front-loaded on active hotspots and interface seams, while the cost rises nonlinearly with hidden coupling and declining code health, so no single effort-benefit ratio is portable across codebases.

**Evidence map:**

| Claim | Source | Confidence | Notes |
|---|---|---|---|
| [fact] No direct deep-vs-shallow AI benchmark was found in the accessible literature search. | https://arxiv.org/html/2511.09268v1; https://www.anthropic.com/engineering/claude-code-best-practices | high | Search gap, explicit |
...
| [fact] Architecture and context rules are prominent in agent configuration practice. | https://arxiv.org/html/2511.09268v1; https://github.blog/ai-and-ml/github-copilot/how-to-build-reliable-ai-workflows-with-agentic-primitives-and-context-engineering/ | medium | Public config ecosystem |
...
| [inference] Gray-box delegation is the best-supported delegation pattern. | https://www.totaltypescript.com/should-you-declare-return-types; https://www.anthropic.com/engineering/claude-code-best-practices; https://github.blog/ai-and-ml/github-copilot/how-to-build-reliable-ai-workflows-with-agentic-primitives-and-context-engineering/; https://davidamitchell.github.io/Research/research/2026-03-16-intent-driven-development.html | medium | Convergent, not direct trial |
...
| [fact] Iterative, hotspot-first rescue is evidenced; blind one-shot rewrite is not. | https://martinfowler.com/books/refactoring.html; https://codescene.com/blog/change-coupling-visualize-the-cost-of-change; https://codescene.com/blog/measure-code-health-of-your-codebase; https://www.atlassian.com/blog/development/how-to-effectively-utilise-ai-to-enhance-large-scale-refactoring | medium | Classic plus modern case |
| [inference] Rescue ROI concentrates on high-churn hotspots and interface seams. | https://www.atlassian.com/blog/development/how-to-effectively-utilise-ai-to-enhance-large-scale-refactoring; https://davidamitchell.github.io/Research/research/2026-04-30-ai-code-entropy-quality-metrics.html; https://codescene.com/blog/measure-code-health-of-your-codebase | medium | No universal ratio |
...
- [fact; source: https://arxiv.org/html/2511.09268v1] No direct controlled study was found that compares otherwise similar deep-module and shallow-module codebases under the same AI task.
- [fact; source: https://www.totaltypescript.com/cursor-rules-for-better-ai-development; https://www.totaltypescript.com/should-you-declare-return-types] The strongest public evidence for gray-box delegation is practitioner guidance rather than controlled experimentation.
...
- [fact; source: https://www.totaltypescript.com/should-you-declare-return-types; https://github.blog/ai-and-ml/github-copilot/how-to-build-reliable-ai-workflows-with-agentic-primitives-and-context-engineering/; https://www.anthropic.com/engineering/claude-code-best-practices] The gray-box delegation section has been kept at medium confidence because the pattern is supported by convergent guidance rather than by a direct comparative experiment.
...
Artificial Intelligence (AI) coding agents are more reliable in codebases organized around deep modules with explicit interfaces than in shallow, densely coupled codebases, but the current evidence supports a directional improvement rather than a measured universal multiplier. [inference; source: http://sunnyday.mit.edu/16.355/parnas-criteria.html; https://web.stanford.edu/~ouster/cgi-bin/cs190-winter18/lecture.php?topic=modularDesign; https://www.anthropic.com/engineering/claude-code-best-practices; https://arxiv.org/html/2511.09268v1]

The best-supported delegation pattern is gray-box rather than black-box: humans define interfaces, types, tests, examples, and architectural rules, while the AI handles more of the implementation search inside that boundary. [inference; source: https://www.totaltypescript.com/should-you-declare-return-types; https://www.anthropic.com/engineering/claude-code-best-practices; https://github.blog/ai-and-ml/github-copilot/how-to-build-reliable-ai-workflows-with-agentic-primitives-and-context-engineering/; https://davidamitchell.github.io/Research/research/2026-03-16-intent-driven-development.html]
...
The effort-versus-benefit ratio is therefore highly uneven: modest architectural work on high-churn boundaries can produce outsized gains, while whole-repository rescue becomes progressively more expensive as hidden coupling, duplication, and code-health decline accumulate. [inference; source: https://www.atlassian.com/blog/development/how-to-effectively-utilise-ai-to-enhance-large-scale-refactoring; https://davidamitchell.github.io/Research/research/2026-04-30-ai-code-entropy-quality-metrics.html; https://codescene.com/blog/measure-code-health-of-your-codebase]

### Key Findings

1. **No accessible study found in this session directly benchmarks AI performance on otherwise comparable deep-module and shallow-module codebases, so any claim about exact magnitude must be treated as unquantified rather than reported as a settled multiplier.** ([fact]; high confidence; source: https://arxiv.org/html/2511.09268v1; https://www.anthropic.com/engineering/claude-code-best-practices)
...
5. **Gray-box delegation is the most defensible workflow pattern because it preserves human ownership of contracts and verification while exploiting AI speed in local implementation search, even though the exact term is better supported as a synthesis than as a named experimental method.** ([inference]; medium confidence; source: https://www.totaltypescript.com/should-you-declare-return-types; https://www.anthropic.com/engineering/claude-code-best-practices; https://github.blog/ai-and-ml/github-copilot/how-to-build-reliable-ai-workflows-with-agentic-primitives-and-context-engineering/; https://davidamitchell.github.io/Research/research/2026-03-16-intent-driven-development.html)
...
7. **Ball-of-mud rescue is feasible through iterative refactoring, hotspot prioritization, persistent context, and small validated batches, and current evidence does not support blind whole-repository rewrites as the default strategy for AI-generated messes.** ([fact]; medium confidence; source: https://martinfowler.com/books/refactoring.html; https://codescene.com/blog/change-coupling-visualize-the-cost-of-change; https://codescene.com/blog/measure-code-health-of-your-codebase; https://www.atlassian.com/blog/development/how-to-effectively-utilise-ai-to-enhance-large-scale-refactoring)
8. **The payoff from rescue is front-loaded on active hotspots and interface seams, while the cost rises nonlinearly with hidden coupling and declining code health, so no single effort-benefit ratio is portable across codebases.** ([inference]; medium confidence; source: https://www.atlassian.com/blog/development/how-to-effectively-utilise-ai-to-enhance-large-scale-refactoring; https://davidamitchell.github.io/Research/research/2026-04-30-ai-code-entropy-quality-metrics.html; https://codescene.com/blog/measure-code-health-of-your-codebase)

### Evidence Map

| Claim | Source | Confidence | Notes |
|---|---|---|---|
| [fact] No direct deep-versus-shallow AI benchmark was found in the accessible literature search. | https://arxiv.org/html/2511.09268v1; https://www.anthropic.com/engineering/claude-code-best-practices | high | Search gap only |
| [inference] Deep modules should reduce AI context burden per change. | http://sunnyday.mit.edu/16.355/parnas-criteria.html; https://web.stanford.edu/~ouster/cgi-bin/cs190-winter18/lecture.php?topic=modularDesign; https://www.anthropic.com/engineering/claude-code-best-practices | medium | Theory plus agent guidance |
| [fact] Architecture and context rules are prominent in agent configuration practice. | https://arxiv.org/html/2511.09268v1; https://github.blog/ai-and-ml/github-copilot/how-to-build-reliable-ai-workflows-with-agentic-primitives-and-context-engineering/ | medium | Config ecosystem |
...
| [fact] Iterative, hotspot-first rescue is evidenced; blind one-shot rewrite is not. | https://martinfowler.com/books/refactoring.html; https://codescene.com/blog/change-coupling-visualize-the-cost-of-change; https://codescene.com/blog/measure-code-health-of-your-codebase; https://www.atlassian.com/blog/development/how-to-effectively-utilise-ai-to-enhance-large-scale-refactoring | medium | Classic plus modern case |
| [inference] Rescue return on investment concentrates on high-churn hotspots and interface seams. | https://www.atlassian.com/blog/development/how-to-effectively-utilise-ai-to-enhance-large-scale-refactoring; https://davidamitchell.github.io/Research/research/2026-04-30-ai-code-entropy-quality-metrics.html; https://codescene.com/blog/measure-code-health-of-your-codebase | medium | No universal ratio |
...
The public AI-era evidence is stronger on design and workflow convergence than on causal measurement, which is why this item can recommend deep modules and gray-box delegation directionally without pretending the uplift is already numerically pinned down. [inference; source: https://arxiv.org/html/2511.09268v1; https://www.totaltypescript.com/should-you-declare-return-types; https://github.blog/ai-and-ml/github-copilot/how-to-build-reliable-ai-workflows-with-agentic-primitives-and-context-engineering/]

Bounded-task quality gains and reduced scrutiny can coexist, which explains why teams can feel faster locally while still accumulating architectural debt globally. [inference; source: https://github.blog/news-insights/research/does-github-copilot-improve-code-quality-heres-what-the-data-says/; https://arxiv.org/abs/2206.15331; https://arxiv.org/abs/2506.04785]
...
- No direct controlled study was found that compares otherwise similar deep-module and shallow-module codebases under the same AI task. [fact; source: https://arxiv.org/html/2511.09268v1]
- The strongest public evidence for gray-box delegation is practitioner guidance rather than controlled experimentation. [fact; source: https://www.totaltypescript.com/cursor-rules-for-better-ai-development; https://www.totaltypescript.com/should-you-declare-return-types]
...
- Type: knowledge
- Description: A research note concluding that deep modules and gray-box delegation are directionally beneficial for AI coding, while architectural rescue is feasible only through iterative hotspot-first refactoring rather than one-shot rewrites.
- Links:
