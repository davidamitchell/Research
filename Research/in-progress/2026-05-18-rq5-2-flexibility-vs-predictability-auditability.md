...
| [fact] Statistical model checking is approximate and is not well suited to unresolved nondeterminism in MDPs. | https://www.prismmodelchecker.org/manual/RunningPRISM/StatisticalModelChecking | medium | single-source limitation |
