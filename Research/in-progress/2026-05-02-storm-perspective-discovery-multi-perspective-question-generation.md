...
5. **The ablation results show that removing perspective conditioning roughly halves the number of unique references collected and lowers entity-level outline recall, while removing simulated conversation hurts performance even more, so the conversation loop appears to contribute more than persona seeding to overall question quality.** ([fact]; medium confidence; source: https://aclanthology.org/2024.naacl-long.347/)
...
| [fact] Ablations show perspective discovery matters, but conversation matters more, especially for unique references and entity recall. | https://aclanthology.org/2024.naacl-long.347/ | medium | Table 3 plus Table 5 |
