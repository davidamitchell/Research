...
- [assumption] Definition needed: in this item, "quality gate" means a control point that decides whether a software change can proceed, be reworked, or be rejected after review and verification. Justification: the retrieved sources study inspections, review quality, and governance controls, but they do not share one canonical definition for this exact phrase.
- [assumption] Definition needed: in this item, the "human bottleneck hypothesis" means the claim that scarce human review capacity, ownership, and remediation responsibility limit the safe throughput of AI-assisted software change. Justification: no retrieved source uses this exact phrase as a settled term, so the item defines it from the review-capacity and ownership evidence it synthesizes.
...
- [assumption] Workflow metadata: this item is being completed in full-synthesis mode, and the output target is a knowledge item with structured synthesis, evidence map, assumptions, analysis, risks, and open questions. Justification: this line records the required output structure for the item rather than an externally evidenced domain claim.
...
- [inference; source: https://www.research.ibm.com/journal/sj/153/ibmsj1503C.pdf; https://link.springer.com/article/10.1007/s10664-015-9381-9; https://www.anthropic.com/engineering/claude-code-best-practices; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-01-appropriate-task-selection-coding-agents.md] The most defensible policy direction is risk-tiered oversight: bounded low-blast-radius tasks can tolerate lighter gates, while critical or cross-cutting changes need stronger human ownership and deeper review.
...
7. [inference; source: https://www.research.ibm.com/journal/sj/153/ibmsj1503C.pdf; https://link.springer.com/article/10.1007/s10664-015-9381-9; https://www.anthropic.com/engineering/claude-code-best-practices] **Medium confidence:** For critical, low-reversibility, or cross-cutting changes, the evidence supports stronger human ownership, narrower change scopes, and deeper review than teams can justify for bounded low-risk work.
8. [inference; source: https://airc.nist.gov/AI_RMF_Knowledge_Base/AI_RMF/Core_And_Profiles/5-sec-core; https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-01-appropriate-task-selection-coding-agents.md] **Medium confidence:** A risk-tiered review model is more defensible than uniform review, because governance guidance and adjacent repository evidence both support allocating stronger human oversight to higher-risk changes.
...
| [inference] A risk-tiered review model is more defensible than uniform review. | https://airc.nist.gov/AI_RMF_Knowledge_Base/AI_RMF/Core_And_Profiles/5-sec-core; https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-01-appropriate-task-selection-coding-agents.md | medium | Governance guidance fits differentiated software oversight better than one-size-fits-all review. |
...
The strongest policy implication is risk-tiered review intensity: bounded low-risk work can tolerate lighter machine-backed gates, while higher-risk or cross-cutting changes need stronger human ownership and deeper review. [inference; source: https://airc.nist.gov/AI_RMF_Knowledge_Base/AI_RMF/Core_And_Profiles/5-sec-core; https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-01-appropriate-task-selection-coding-agents.md]
...
8. **A risk-tiered review model is more defensible than uniform review, because governance guidance and adjacent repository evidence both support allocating stronger human oversight to higher-risk changes.** ([inference]; medium confidence; source: https://airc.nist.gov/AI_RMF_Knowledge_Base/AI_RMF/Core_And_Profiles/5-sec-core; https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai; https://github.com/davidamitchell/Research/blob/main/Research/completed/2026-05-01-appropriate-task-selection-coding-agents.md)
