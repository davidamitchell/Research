...
- [ ] GitHub Octoverse: developer productivity impact of AI coding tools (2023, 2024)
- [ ] Google AI impact on engineering productivity (internal reports surfaced in press)
- [ ] McKinsey "Developer Velocity" report (AI-assisted coding outcomes)
- [ ] Proxify, MomoView, Kamiwaza — cited in Jevons Paradox research as early indicators
- [ ] SWE-bench evaluations: autonomous coding agent performance data
