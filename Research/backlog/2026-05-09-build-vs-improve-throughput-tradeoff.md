...
priority: medium
blocks: []
tags: [workflow, organisational-theory, software-engineering, measurement, throughput]
started: ~
completed: ~
output: []
...
The issue asks for theory describing the tradeoff between shipping more within current system constraints versus spending some capacity to increase system throughput and quality, and explicitly asks for models from multiple sciences/industries plus the relationship to Pareto distribution. This question informs portfolio and operating-model decisions: when teams should keep delivering features versus pause to reduce bottlenecks, reduce defect concentration, and improve the system's effective capacity.
...
- [ ] [Goldratt (1984) The Goal](https://www.routledge.com/The-Goal-A-Process-of-Ongoing-Improvement/Goldratt-Cox/p/book/9781138384020) — foundational Theory of Constraints framing for bottlenecks and system throughput
- [ ] [Little (1961) A Proof for the Queueing Formula L = λW](https://doi.org/10.1287/opre.9.3.383) — foundational queueing result that links work-in-system, arrival rate, and lead time
- [ ] [Reinertsen (2009) The Principles of Product Development Flow](https://www.celeritaspublishing.com/book/the-principles-of-product-development-flow/) — economic and flow-based decision model for development systems
- [ ] [Forsgren et al. (2018) Accelerate](https://itrevolution.com/product/accelerate/) — industry evidence linking delivery capability, stability, and organisational performance
- [ ] [Organisation for Economic Co-operation and Development (OECD) Pareto Distribution](https://stats.oecd.org/glossary/detail.asp?ID=3157) — concise definition of Pareto distribution for inequality/concentration framing
- [ ] [Wikipedia Pareto Principle](https://en.wikipedia.org/wiki/Pareto_principle) — practical overview of 80/20 concentration patterns for hypothesis generation
