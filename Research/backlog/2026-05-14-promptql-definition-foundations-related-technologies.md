...
- Current research activity in closely related areas such as Natural Language Interface (NLI) systems for data access, text-to-SQL pipelines, and Large Language Model (LLM)-assisted query planning
